...
JOBS = (
    AnimationJob(
        name="air_dodge",
        source=Path("renders/moss_remaining_animation_gaps/air_dodge_4c_2r.png"),
        frames=6,
        fps=18,
    ...
    AnimationJob(
        ...
        source=Path(
            "renders/moss_remaining_animation_gaps/railgun_reload_failure_4c_2r.png"
        ),
        frames=6,
        fps=14,
    ...
    AnimationJob(
        name="railgun_charge",
        source=Path("renders/moss_remaining_animation_gaps/railgun_charge_4c_2r.png"),
        frames=6,
        fps=12,
...
def sheet_definition() -> dict[str, Any]:
    return {
        ...
        "source": {
            ...
            "sourceDirectory": (
                "docs/sprite-production/chronicle-images-2026-07-23"
            ),
            "normalizedRenderDirectory": "renders/moss_remaining_animation_gaps",
            "note": (
