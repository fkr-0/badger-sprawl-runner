...
export function solveDistanceConstraints(bodies, constraints, dt, iterations = 1) {
    if (!Number.isFinite(dt) || dt < 0)
        throw new Error(`Invalid constraint dt: ${dt}`);
    if (!Number.isInteger(iterations) || iterations <= 0)
        throw new Error(`Invalid constraint iterations: ${iterations}`);
...
//# sourceMappingURL=physicsConstraints.js.map