...
# Enemy Feedback Guard

Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/feedback_guard.png` using manifest animation order.
