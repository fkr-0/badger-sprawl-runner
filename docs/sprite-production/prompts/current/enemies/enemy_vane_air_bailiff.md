...
sheet_id: enemy_vane_air_bailiff
...
# Enemy Vane Air Bailiff

Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/vane_air_bailiff.png` using manifest animation order.
