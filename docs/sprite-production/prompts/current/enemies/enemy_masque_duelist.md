...
# Enemy Masque Duelist

Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/masque_duelist.png` using manifest animation order.
