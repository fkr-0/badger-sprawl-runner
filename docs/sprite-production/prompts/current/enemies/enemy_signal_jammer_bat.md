...
sheet_id: enemy_signal_jammer_bat
...
# Enemy Signal Jammer Bat

Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/signal_jammer_bat.png` using manifest animation order.
