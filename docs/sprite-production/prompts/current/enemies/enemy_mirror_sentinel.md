...
sheet_id: enemy_mirror_sentinel
...
# Enemy Mirror Sentinel

Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/mirror_sentinel.png` using manifest animation order.
