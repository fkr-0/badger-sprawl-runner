...
sheet_id: enemy_contract_servitor
...
# Enemy Contract Servitor

Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/contract_servitor.png` using manifest animation order.
