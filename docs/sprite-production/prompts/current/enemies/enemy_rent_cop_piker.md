...
# Enemy Rent Cop Piker

Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/rent_cop_piker.png` using manifest animation order.
