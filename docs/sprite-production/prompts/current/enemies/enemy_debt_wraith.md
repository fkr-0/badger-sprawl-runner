...
Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/debt_wraith.png` using manifest animation order.
