...
Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/error_mite.png` using manifest animation order.
