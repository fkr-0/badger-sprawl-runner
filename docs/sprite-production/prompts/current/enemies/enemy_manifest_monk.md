...
Production role: `enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/manifest_monk.png` using manifest animation order.
