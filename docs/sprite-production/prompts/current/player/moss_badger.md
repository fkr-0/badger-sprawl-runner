...
status: authored_source_template
target_atlas: assets/sprites/moss_badger_v2.png
frame_size:
- 48
- 48
atlas_size:
...
Production role: `manifest sheet`. Render the jobs below separately, then assemble them into `assets/sprites/moss_badger_v2.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `moss_badger__idle`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__jump_up`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__melee_claws`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__melee_katana`
...
Asset identity: Moss, an anthropomorphic badger courier: black-white badger facial mask, patched dark courier coat, cargo trousers, sturdy boots, claw wraps, compact tail, chrome wetware whiskers, small pirate-radio antenna details, determined dry expression.
Core Moss palette family: charcoal, off-white fur, deep violet, electric cyan and controlled hot-red accents.
Animation: melee_katana.
Frame count: 7. Leave the final 1 cell(s) fully transparent.
Frame order:
1. clear anticipation
2. energy or body acceleration
3. active action begins
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__shoot_railgun`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__rocket_boost`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__victory`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__pickup_react`
...
Asset identity: Moss, an anthropomorphic badger courier: black-white badger facial mask, patched dark courier coat, cargo trousers, sturdy boots, claw wraps, compact tail, chrome wetware whiskers, small pirate-radio antenna details, determined dry expression.
Core Moss palette family: charcoal, off-white fur, deep violet, electric cyan and controlled hot-red accents.
Animation: pickup_react.
Frame count: 3.
Frame order:
1. notice pickup
2. quick delighted/alert reaction
3. return to ready
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__interact`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `moss_badger__death_or_down`
