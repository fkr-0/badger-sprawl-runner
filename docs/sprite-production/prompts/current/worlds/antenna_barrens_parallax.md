...
sheet_id: antenna_barrens_parallax
...
# Antenna Barrens Parallax

Production role: `parallax`. Render the jobs below separately, then assemble them into `assets/sprites/worlds/antenna_barrens_parallax.png` using manifest animation order.
