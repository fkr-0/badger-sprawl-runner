...
sheet_id: orbital_lift_parallax
...
# Orbital Lift Parallax

Production role: `parallax`. Render the jobs below separately, then assemble them into `assets/sprites/worlds/orbital_lift_parallax.png` using manifest animation order.
