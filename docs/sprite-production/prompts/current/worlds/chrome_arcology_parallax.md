...
sheet_id: chrome_arcology_parallax
...
# Chrome Arcology Parallax

Production role: `parallax`. Render the jobs below separately, then assemble them into `assets/sprites/worlds/chrome_arcology_parallax.png` using manifest animation order.
