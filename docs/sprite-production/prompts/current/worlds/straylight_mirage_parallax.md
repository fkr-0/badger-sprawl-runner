...
sheet_id: straylight_mirage_parallax
...
# Straylight Mirage Parallax

Production role: `parallax`. Render the jobs below separately, then assemble them into `assets/sprites/worlds/straylight_mirage_parallax.png` using manifest animation order.
