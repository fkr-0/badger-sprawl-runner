...
sheet_id: asteroid_redoubt_parallax
...
# Asteroid Redoubt Parallax

Production role: `parallax`. Render the jobs below separately, then assemble them into `assets/sprites/worlds/asteroid_redoubt_parallax.png` using manifest animation order.
