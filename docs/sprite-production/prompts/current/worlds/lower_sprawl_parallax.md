...
sheet_id: lower_sprawl_parallax
...
# Lower Sprawl Parallax

Production role: `parallax`. Render the jobs below separately, then assemble them into `assets/sprites/worlds/lower_sprawl_parallax.png` using manifest animation order.
