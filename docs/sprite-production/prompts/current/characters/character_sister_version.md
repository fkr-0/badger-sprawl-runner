...
sheet_id: character_sister_version
...
# Character Sister Version

Production role: `companion`. Render the jobs below separately, then assemble them into `assets/sprites/characters/sister_version.png` using manifest animation order.
