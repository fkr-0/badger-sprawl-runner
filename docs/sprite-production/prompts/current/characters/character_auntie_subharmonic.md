...
sheet_id: character_auntie_subharmonic
...
# Character Auntie Subharmonic

Production role: `companion`. Render the jobs below separately, then assemble them into `assets/sprites/characters/auntie_subharmonic.png` using manifest animation order.
