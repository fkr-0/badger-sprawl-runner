...
sheet_id: character_dj_calculus
...
# Character Dj Calculus

Production role: `companion`. Render the jobs below separately, then assemble them into `assets/sprites/characters/dj_calculus.png` using manifest animation order.
