...
sheet_id: character_foreman_pell
...
# Character Foreman Pell

Production role: `companion`. Render the jobs below separately, then assemble them into `assets/sprites/characters/foreman_pell.png` using manifest animation order.
