...
sheet_id: character_cobalt_carmine
...
# Character Cobalt Carmine

Production role: `npc`. Render the jobs below separately, then assemble them into `assets/sprites/characters/cobalt_carmine.png` using manifest animation order.
