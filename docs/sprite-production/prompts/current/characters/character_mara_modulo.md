...
sheet_id: character_mara_modulo
...
# Character Mara Modulo

Production role: `npc`. Render the jobs below separately, then assemble them into `assets/sprites/characters/mara_modulo.png` using manifest animation order.
