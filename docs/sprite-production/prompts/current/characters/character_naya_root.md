...
Production role: `companion`. Render the jobs below separately, then assemble them into `assets/sprites/characters/naya_root.png` using manifest animation order.
