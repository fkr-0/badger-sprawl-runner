...
sheet_id: character_king_feedback
...
# Character King Feedback

Production role: `npc_boss_context`. Render the jobs below separately, then assemble them into `assets/sprites/characters/king_feedback.png` using manifest animation order.
