...
Production role: `npc`. Render the jobs below separately, then assemble them into `assets/sprites/characters/juno_jar.png` using manifest animation order.
