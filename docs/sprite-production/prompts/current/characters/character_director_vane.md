...
sheet_id: character_director_vane
...
# Character Director Vane

Production role: `npc`. Render the jobs below separately, then assemble them into `assets/sprites/characters/director_vane.png` using manifest animation order.
