...
sheet_id: character_reflection_judge
...
# Character Reflection Judge

Production role: `npc_boss_context`. Render the jobs below separately, then assemble them into `assets/sprites/characters/reflection_judge.png` using manifest animation order.
