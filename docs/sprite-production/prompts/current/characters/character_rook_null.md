...
Production role: `companion`. Render the jobs below separately, then assemble them into `assets/sprites/characters/rook_null.png` using manifest animation order.
