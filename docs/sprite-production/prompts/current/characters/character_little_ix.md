...
Production role: `npc`. Render the jobs below separately, then assemble them into `assets/sprites/characters/little_ix.png` using manifest animation order.
