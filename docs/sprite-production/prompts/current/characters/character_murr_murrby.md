...
sheet_id: character_murr_murrby
...
# Character Murr Murrby

Production role: `merchant`. Render the jobs below separately, then assemble them into `assets/sprites/characters/murr_murrby.png` using manifest animation order.
