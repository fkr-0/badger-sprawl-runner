...
sheet_id: character_elevator_angel
...
# Character Elevator Angel

Production role: `npc_boss_context`. Render the jobs below separately, then assemble them into `assets/sprites/characters/elevator_angel.png` using manifest animation order.
