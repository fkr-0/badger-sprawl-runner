...
sheet_id: character_madame_vitrine
...
# Character Madame Vitrine

Production role: `npc_boss_context`. Render the jobs below separately, then assemble them into `assets/sprites/characters/madame_vitrine.png` using manifest animation order.
