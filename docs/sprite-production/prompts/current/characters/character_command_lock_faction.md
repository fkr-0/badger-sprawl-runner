...
sheet_id: character_command_lock_faction
...
# Character Command Lock Faction

Production role: `npc`. Render the jobs below separately, then assemble them into `assets/sprites/characters/command_lock_faction.png` using manifest animation order.
