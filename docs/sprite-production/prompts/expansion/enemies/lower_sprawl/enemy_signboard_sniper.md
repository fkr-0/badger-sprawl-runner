...
sheet_id: enemy_signboard_sniper
status: planned_full_scope
target_atlas: assets/sprites/enemies/signboard_sniper.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Signboard Sniper


> Planned full-scope roster asset. World: **Lower Sprawl**. Class: **turret**.  
> Movement: roof camper behind a neon sign. Attack: slow telegraphed aimed shot. Counter/readability requirement: drop the sign, rocket route, rail countershot.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/signboard_sniper.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_signboard_sniper__idle`
...
Asset identity: Signboard Sniper; class turret; roof camper behind a neon sign; attacks with slow telegraphed aimed shot; intended counter is drop the sign, rocket route, rail countershot.
...
```
## Render job `enemy_signboard_sniper__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_signboard_sniper__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_signboard_sniper__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_signboard_sniper__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_signboard_sniper__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_signboard_sniper__death`
