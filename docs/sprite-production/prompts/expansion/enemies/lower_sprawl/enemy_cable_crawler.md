...
sheet_id: enemy_cable_crawler
status: planned_full_scope
target_atlas: assets/sprites/enemies/cable_crawler.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Lower Sprawl**. Class: **ceiling jumper**.  
> Movement: long-limbed crawler using overhead cable nests. Attack: drops live wire loops. Counter/readability requirement: hook claw, pistol, hacked gutter.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/cable_crawler.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_cable_crawler__idle`
...
Asset identity: Cable Crawler; class ceiling jumper; long-limbed crawler using overhead cable nests; attacks with drops live wire loops; intended counter is hook claw, pistol, hacked gutter.
...
```
## Render job `enemy_cable_crawler__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_cable_crawler__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_cable_crawler__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_cable_crawler__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_cable_crawler__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_cable_crawler__death`
