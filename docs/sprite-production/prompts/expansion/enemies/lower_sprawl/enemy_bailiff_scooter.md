...
sheet_id: enemy_bailiff_scooter
status: planned_full_scope
target_atlas: assets/sprites/enemies/bailiff_scooter.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Bailiff Scooter


> Planned full-scope roster asset. World: **Lower Sprawl**. Class: **jumper/rusher**.  
> Movement: armored scooter crossing gaps at speed. Attack: straight ram and baton swipe. Counter/readability requirement: jump, traffic-light hack, rear rail shot.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/bailiff_scooter.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_bailiff_scooter__idle`
...
Asset identity: Bailiff Scooter; class jumper/rusher; armored scooter crossing gaps at speed; attacks with straight ram and baton swipe; intended counter is jump, traffic-light hack, rear rail shot.
...
```
## Render job `enemy_bailiff_scooter__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_bailiff_scooter__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_bailiff_scooter__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_bailiff_scooter__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_bailiff_scooter__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_bailiff_scooter__death`
