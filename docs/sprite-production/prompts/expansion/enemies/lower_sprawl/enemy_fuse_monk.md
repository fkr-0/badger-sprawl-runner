...
sheet_id: enemy_fuse_monk
status: planned_full_scope
target_atlas: assets/sprites/enemies/fuse_monk.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Lower Sprawl**. Class: **shield/caster**.  
> Movement: slow robed utility worker guarding wet wires. Attack: electrified staff and grounding seal. Counter/readability requirement: parry, wet-gutter lightning, syntax interrupt.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/fuse_monk.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_fuse_monk__idle`
...
Asset identity: Fuse Monk; class shield/caster; slow robed utility worker guarding wet wires; attacks with electrified staff and grounding seal; intended counter is parry, wet-gutter lightning, syntax interrupt.
...
```
## Render job `enemy_fuse_monk__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_fuse_monk__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_fuse_monk__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_fuse_monk__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_fuse_monk__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_fuse_monk__death`
