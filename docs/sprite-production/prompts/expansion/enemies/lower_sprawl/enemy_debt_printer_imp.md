...
sheet_id: enemy_debt_printer_imp
status: planned_full_scope
target_atlas: assets/sprites/enemies/debt_printer_imp.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Debt Printer Imp


> Planned full-scope roster asset. World: **Lower Sprawl**. Class: **caster**.  
> Movement: cowardly printer creature hiding behind platforms. Attack: paper-warrant traps and receipt snares. Counter/readability requirement: rush, overload printer, cut paper stream.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/debt_printer_imp.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_debt_printer_imp__idle`
...
Asset identity: Debt Printer Imp; class caster; cowardly printer creature hiding behind platforms; attacks with paper-warrant traps and receipt snares; intended counter is rush, overload printer, cut paper stream.
...
```
## Render job `enemy_debt_printer_imp__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_printer_imp__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_printer_imp__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_printer_imp__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_printer_imp__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_printer_imp__death`
