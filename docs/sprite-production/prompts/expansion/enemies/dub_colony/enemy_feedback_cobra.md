...
sheet_id: enemy_feedback_cobra
status: planned_full_scope
target_atlas: assets/sprites/enemies/feedback_cobra.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Feedback Cobra


> Planned full-scope roster asset. World: **Dub Colony**. Class: **walker/caster**.  
> Movement: cable-bodied cobra moving in a sine wave. Attack: sonic spit and feedback coil. Counter/readability requirement: speaker overload, rail, rhythm dodge.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/feedback_cobra.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_feedback_cobra__idle`
...
Asset identity: Feedback Cobra; class walker/caster; cable-bodied cobra moving in a sine wave; attacks with sonic spit and feedback coil; intended counter is speaker overload, rail, rhythm dodge.
...
```
## Render job `enemy_feedback_cobra__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_feedback_cobra__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_feedback_cobra__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_feedback_cobra__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_feedback_cobra__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_feedback_cobra__death`
