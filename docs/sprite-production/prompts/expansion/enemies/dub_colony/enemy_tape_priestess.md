...
sheet_id: enemy_tape_priestess
status: planned_full_scope
target_atlas: assets/sprites/enemies/tape_priestess.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Tape Priestess


> Planned full-scope roster asset. World: **Dub Colony**. Class: **caster**.  
> Movement: robed archivist wrapped in magnetic tape. Attack: rewinds hazards and loops damage zones. Counter/readability requirement: cut reels, hack loop head.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/tape_priestess.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_tape_priestess__idle`
...
Asset identity: Tape Priestess; class caster; robed archivist wrapped in magnetic tape; attacks with rewinds hazards and loops damage zones; intended counter is cut reels, hack loop head.
...
```
## Render job `enemy_tape_priestess__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_tape_priestess__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_tape_priestess__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_tape_priestess__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_tape_priestess__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_tape_priestess__death`
