...
sheet_id: enemy_echo_drummer
status: planned_full_scope
target_atlas: assets/sprites/enemies/echo_drummer.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Dub Colony**. Class: **turret**.  
> Movement: stationary drummer machine with ring-shaped speakers. Attack: concentric rhythm shockwaves. Counter/readability requirement: downbeat guard and speaker hack.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/echo_drummer.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_echo_drummer__idle`
...
Asset identity: Echo Drummer; class turret; stationary drummer machine with ring-shaped speakers; attacks with concentric rhythm shockwaves; intended counter is downbeat guard and speaker hack.
...
```
## Render job `enemy_echo_drummer__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_echo_drummer__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_echo_drummer__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_echo_drummer__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_echo_drummer__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_echo_drummer__death`
