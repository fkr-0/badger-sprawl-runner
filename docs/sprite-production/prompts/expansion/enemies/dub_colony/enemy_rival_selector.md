...
sheet_id: enemy_rival_selector
status: planned_full_scope
target_atlas: assets/sprites/enemies/rival_selector.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Rival Selector


> Planned full-scope roster asset. World: **Dub Colony**. Class: **sub-boss/caster**.  
> Movement: platform DJ controlling hostile speaker stacks. Attack: summons beat hazards. Counter/readability requirement: hack speakers and win rhythm exchange.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/rival_selector.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_rival_selector__idle`
...
Asset identity: Rival Selector; class sub-boss/caster; platform DJ controlling hostile speaker stacks; attacks with summons beat hazards; intended counter is hack speakers and win rhythm exchange.
...
```
## Render job `enemy_rival_selector__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rival_selector__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rival_selector__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rival_selector__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rival_selector__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rival_selector__death`
