...
sheet_id: enemy_maintenance_choir
status: planned_full_scope
target_atlas: assets/sprites/enemies/maintenance_choir.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Maintenance Choir


> Planned full-scope roster asset. World: **Orbital Lift**. Class: **swarm/caster**.  
> Movement: repair drones singing around a lead unit. Attack: repairs hazards and armor. Counter/readability requirement: interrupt lead singer.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/maintenance_choir.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_maintenance_choir__idle`
...
Asset identity: Maintenance Choir; class swarm/caster; repair drones singing around a lead unit; attacks with repairs hazards and armor; intended counter is interrupt lead singer.
...
```
## Render job `enemy_maintenance_choir__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_maintenance_choir__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_maintenance_choir__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_maintenance_choir__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_maintenance_choir__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_maintenance_choir__death`
