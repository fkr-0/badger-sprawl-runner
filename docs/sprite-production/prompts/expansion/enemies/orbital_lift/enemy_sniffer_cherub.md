...
sheet_id: enemy_sniffer_cherub
status: planned_full_scope
target_atlas: assets/sprites/enemies/sniffer_cherub.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Sniffer Cherub


> Planned full-scope roster asset. World: **Orbital Lift**. Class: **flyer**.  
> Movement: small customs drone with sensor nose and cable wings. Attack: alarm sniff and marking beam. Counter/readability requirement: signal jammer blinds.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/sniffer_cherub.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_sniffer_cherub__idle`
...
Asset identity: Sniffer Cherub; class flyer; small customs drone with sensor nose and cable wings; attacks with alarm sniff and marking beam; intended counter is signal jammer blinds.
...
```
## Render job `enemy_sniffer_cherub__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_sniffer_cherub__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_sniffer_cherub__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_sniffer_cherub__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_sniffer_cherub__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_sniffer_cherub__death`
