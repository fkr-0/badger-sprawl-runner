...
sheet_id: enemy_stamp_golem
status: planned_full_scope
target_atlas: assets/sprites/enemies/stamp_golem.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Orbital Lift**. Class: **heavy**.  
> Movement: cargo-stamp machine walking on piston legs. Attack: bureaucratic slam and seal shockwave. Counter/readability requirement: scanner hack marks weak point.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/stamp_golem.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_stamp_golem__idle`
...
Asset identity: Stamp Golem; class heavy; cargo-stamp machine walking on piston legs; attacks with bureaucratic slam and seal shockwave; intended counter is scanner hack marks weak point.
...
```
## Render job `enemy_stamp_golem__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_stamp_golem__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_stamp_golem__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_stamp_golem__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_stamp_golem__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_stamp_golem__death`
