...
sheet_id: enemy_debt_paladin
status: planned_full_scope
target_atlas: assets/sprites/enemies/debt_paladin.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Orbital Lift**. Class: **shield/heavy**.  
> Movement: armored guard carrying prisoner-manifest shield. Attack: oath strike and shield wall. Counter/readability requirement: dialogue flag, rear attack, scanner proof.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/debt_paladin.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_debt_paladin__idle`
...
Asset identity: Debt Paladin; class shield/heavy; armored guard carrying prisoner-manifest shield; attacks with oath strike and shield wall; intended counter is dialogue flag, rear attack, scanner proof.
...
```
## Render job `enemy_debt_paladin__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_paladin__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_paladin__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_paladin__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_paladin__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_debt_paladin__death`
