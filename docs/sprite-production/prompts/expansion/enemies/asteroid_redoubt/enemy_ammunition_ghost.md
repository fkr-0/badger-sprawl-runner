...
sheet_id: enemy_ammunition_ghost
status: planned_full_scope
target_atlas: assets/sprites/enemies/ammunition_ghost.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Ammunition Ghost


> Planned full-scope roster asset. World: **Asteroid Redoubt**. Class: **flyer**.  
> Movement: spectral foundry worker haunting shell casings. Attack: explosive pass and shell possession. Counter/readability requirement: nonlethal bass banish.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/ammunition_ghost.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_ammunition_ghost__idle`
...
Asset identity: Ammunition Ghost; class flyer; spectral foundry worker haunting shell casings; attacks with explosive pass and shell possession; intended counter is nonlethal bass banish.
...
```
## Render job `enemy_ammunition_ghost__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_ammunition_ghost__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_ammunition_ghost__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_ammunition_ghost__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_ammunition_ghost__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_ammunition_ghost__death`
