...
sheet_id: enemy_traitor_mask
status: planned_full_scope
target_atlas: assets/sprites/enemies/traitor_mask.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Asteroid Redoubt**. Class: **assassin/caster**.  
> Movement: friendly-looking mask projection over a hidden attacker. Attack: backstab and false prompt. Counter/readability requirement: trust flags reveal outline.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/traitor_mask.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_traitor_mask__idle`
...
Asset identity: Traitor Mask; class assassin/caster; friendly-looking mask projection over a hidden attacker; attacks with backstab and false prompt; intended counter is trust flags reveal outline.
...
```
## Render job `enemy_traitor_mask__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_traitor_mask__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_traitor_mask__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_traitor_mask__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_traitor_mask__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_traitor_mask__death`
