...
sheet_id: enemy_angel_fragment
status: planned_full_scope
target_atlas: assets/sprites/enemies/angel_fragment.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Angel Fragment


> Planned full-scope roster asset. World: **Asteroid Redoubt**. Class: **caster**.  
> Movement: broken cable-halo obedience logic. Attack: schedule beams and cargo hooks. Counter/readability requirement: prove schedule contradiction.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/angel_fragment.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_angel_fragment__idle`
...
Asset identity: Angel Fragment; class caster; broken cable-halo obedience logic; attacks with schedule beams and cargo hooks; intended counter is prove schedule contradiction.
...
```
## Render job `enemy_angel_fragment__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_angel_fragment__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_angel_fragment__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_angel_fragment__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_angel_fragment__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_angel_fragment__death`
