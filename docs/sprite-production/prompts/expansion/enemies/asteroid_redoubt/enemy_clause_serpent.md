...
sheet_id: enemy_clause_serpent
status: planned_full_scope
target_atlas: assets/sprites/enemies/clause_serpent.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Clause Serpent


> Planned full-scope roster asset. World: **Asteroid Redoubt**. Class: **caster**.  
> Movement: long contract-code serpent around ledger platforms. Attack: binding bite and coil. Counter/readability requirement: rewrite clause breaks coil.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/clause_serpent.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_clause_serpent__idle`
...
Asset identity: Clause Serpent; class caster; long contract-code serpent around ledger platforms; attacks with binding bite and coil; intended counter is rewrite clause breaks coil.
...
```
## Render job `enemy_clause_serpent__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_clause_serpent__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_clause_serpent__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_clause_serpent__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_clause_serpent__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_clause_serpent__death`
