...
sheet_id: enemy_riot_drone_choir
status: planned_full_scope
target_atlas: assets/sprites/enemies/riot_drone_choir.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Riot Drone Choir


> Planned full-scope roster asset. World: **Asteroid Redoubt**. Class: **swarm/flyer**.  
> Movement: coordinated final-broadcast security drones. Attack: synchronized bolts and formation wall. Counter/readability requirement: companion chorus counter.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/riot_drone_choir.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_riot_drone_choir__idle`
...
Asset identity: Riot Drone Choir; class swarm/flyer; coordinated final-broadcast security drones; attacks with synchronized bolts and formation wall; intended counter is companion chorus counter.
...
```
## Render job `enemy_riot_drone_choir__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_riot_drone_choir__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_riot_drone_choir__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_riot_drone_choir__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_riot_drone_choir__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_riot_drone_choir__death`
