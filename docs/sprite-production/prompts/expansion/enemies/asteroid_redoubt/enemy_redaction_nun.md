...
sheet_id: enemy_redaction_nun
status: planned_full_scope
target_atlas: assets/sprites/enemies/redaction_nun.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Asteroid Redoubt**. Class: **shield**.  
> Movement: black-bar robed censor with broad deletion blade. Attack: deletes platforms with sweep. Counter/readability requirement: broadcast light restores.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/redaction_nun.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_redaction_nun__idle`
...
Asset identity: Redaction Nun; class shield; black-bar robed censor with broad deletion blade; attacks with deletes platforms with sweep; intended counter is broadcast light restores.
...
```
## Render job `enemy_redaction_nun__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_redaction_nun__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_redaction_nun__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_redaction_nun__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_redaction_nun__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_redaction_nun__death`
