...
sheet_id: enemy_dish_climber
status: planned_full_scope
target_atlas: assets/sprites/enemies/dish_climber.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Antenna Barrens**. Class: **vertical walker**.  
> Movement: climber gripping antenna masts with four tool arms. Attack: throws bolts from walls. Counter/readability requirement: rail knockdown and cable cut.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/dish_climber.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_dish_climber__idle`
...
Asset identity: Dish-Climber; class vertical walker; climber gripping antenna masts with four tool arms; attacks with throws bolts from walls; intended counter is rail knockdown and cable cut.
...
```
## Render job `enemy_dish_climber__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_dish_climber__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_dish_climber__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_dish_climber__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_dish_climber__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_dish_climber__death`
