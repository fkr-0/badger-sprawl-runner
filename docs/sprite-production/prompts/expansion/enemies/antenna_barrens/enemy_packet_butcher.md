...
sheet_id: enemy_packet_butcher
status: planned_full_scope
target_atlas: assets/sprites/enemies/packet_butcher.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Packet Butcher


> Planned full-scope roster asset. World: **Antenna Barrens**. Class: **heavy/caster**.  
> Movement: broad butcher carrying a pixel cleaver and data sacks. Attack: compile windup into packet cleave. Counter/readability requirement: interrupt compile.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/packet_butcher.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_packet_butcher__idle`
...
Asset identity: Packet Butcher; class heavy/caster; broad butcher carrying a pixel cleaver and data sacks; attacks with compile windup into packet cleave; intended counter is interrupt compile.
...
```
## Render job `enemy_packet_butcher__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_packet_butcher__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_packet_butcher__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_packet_butcher__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_packet_butcher__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_packet_butcher__death`
