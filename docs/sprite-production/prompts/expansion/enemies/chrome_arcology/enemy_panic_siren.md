...
sheet_id: enemy_panic_siren
status: planned_full_scope
target_atlas: assets/sprites/enemies/panic_siren.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Chrome Arcology**. Class: **runner/turret**.  
> Movement: small alarm machine fleeing across platforms. Attack: heat-raising pulse and drone call. Counter/readability requirement: signal jammer, route cut-off.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/panic_siren.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_panic_siren__idle`
...
Asset identity: Panic Siren; class runner/turret; small alarm machine fleeing across platforms; attacks with heat-raising pulse and drone call; intended counter is signal jammer, route cut-off.
...
```
## Render job `enemy_panic_siren__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_panic_siren__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_panic_siren__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_panic_siren__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_panic_siren__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_panic_siren__death`
