...
sheet_id: enemy_drone_wasp_queen
status: planned_full_scope
target_atlas: assets/sprites/enemies/drone_wasp_queen.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Drone Wasp Queen


> Planned full-scope roster asset. World: **Chrome Arcology**. Class: **flyer/sub-boss**.  
> Movement: luxury-garden wasp queen drone. Attack: spawns memo wasps and pollen lasers. Counter/readability requirement: railgun, terminal overload, water mist.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/drone_wasp_queen.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_drone_wasp_queen__idle`
...
Asset identity: Drone Wasp Queen; class flyer/sub-boss; luxury-garden wasp queen drone; attacks with spawns memo wasps and pollen lasers; intended counter is railgun, terminal overload, water mist.
...
```
## Render job `enemy_drone_wasp_queen__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_drone_wasp_queen__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_drone_wasp_queen__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_drone_wasp_queen__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_drone_wasp_queen__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_drone_wasp_queen__death`
