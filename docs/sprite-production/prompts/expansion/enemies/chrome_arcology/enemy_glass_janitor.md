...
sheet_id: enemy_glass_janitor
status: planned_full_scope
target_atlas: assets/sprites/enemies/glass_janitor.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Chrome Arcology**. Class: **walker/hazard**.  
> Movement: polished cleaning automaton with broad squeegee arms. Attack: sweeps player and leaves slippery floor. Counter/readability requirement: jump timing, overload cleaning tank.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/glass_janitor.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_glass_janitor__idle`
...
Asset identity: Glass Janitor; class walker/hazard; polished cleaning automaton with broad squeegee arms; attacks with sweeps player and leaves slippery floor; intended counter is jump timing, overload cleaning tank.
...
```
## Render job `enemy_glass_janitor__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_glass_janitor__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_glass_janitor__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_glass_janitor__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_glass_janitor__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_glass_janitor__death`
