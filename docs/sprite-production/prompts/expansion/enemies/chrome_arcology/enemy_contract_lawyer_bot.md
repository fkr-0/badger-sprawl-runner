...
sheet_id: enemy_contract_lawyer_bot
status: planned_full_scope
target_atlas: assets/sprites/enemies/contract_lawyer_bot.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Contract Lawyer Bot


> Planned full-scope roster asset. World: **Chrome Arcology**. Class: **caster**.  
> Movement: floating legal machine retreating behind contract ribbons. Attack: binding clause zones. Counter/readability requirement: syntax parry and close interrupt.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/contract_lawyer_bot.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_contract_lawyer_bot__idle`
...
Asset identity: Contract Lawyer Bot; class caster; floating legal machine retreating behind contract ribbons; attacks with binding clause zones; intended counter is syntax parry and close interrupt.
...
```
## Render job `enemy_contract_lawyer_bot__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_contract_lawyer_bot__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_contract_lawyer_bot__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_contract_lawyer_bot__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_contract_lawyer_bot__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_contract_lawyer_bot__death`
