...
sheet_id: enemy_invoice_leech
status: planned_full_scope
target_atlas: assets/sprites/enemies/invoice_leech.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Drainmarket**. Class: **swarm**.  
> Movement: paper-and-rubber medical billing parasite. Attack: attaches and drains healing charge. Counter/readability requirement: wide slash, EMP, mutual-aid terminal.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/invoice_leech.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_invoice_leech__idle`
...
Asset identity: Invoice Leech; class swarm; paper-and-rubber medical billing parasite; attacks with attaches and drains healing charge; intended counter is wide slash, EMP, mutual-aid terminal.
...
```
## Render job `enemy_invoice_leech__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_invoice_leech__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_invoice_leech__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_invoice_leech__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_invoice_leech__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_invoice_leech__death`
