...
sheet_id: enemy_triage_turret
status: planned_full_scope
target_atlas: assets/sprites/enemies/triage_turret.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Drainmarket**. Class: **turret**.  
> Movement: improvised clinic scanner on rolling IV legs. Attack: marks targets and launches sedative darts. Counter/readability requirement: spoof triage priority, railgun, cover.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/triage_turret.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_triage_turret__idle`
...
Asset identity: Triage Turret; class turret; improvised clinic scanner on rolling IV legs; attacks with marks targets and launches sedative darts; intended counter is spoof triage priority, railgun, cover.
...
```
## Render job `enemy_triage_turret__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_triage_turret__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_triage_turret__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_triage_turret__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_triage_turret__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_triage_turret__death`
