...
sheet_id: enemy_syringe_skater
status: planned_full_scope
target_atlas: assets/sprites/enemies/syringe_skater.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Syringe Skater


> Planned full-scope roster asset. World: **Drainmarket**. Class: **jumper**.  
> Movement: clinic courier skating on capped syringe rails. Attack: needle dash and tracking-dye splash. Counter/readability requirement: parry, grate trap, signal jammer.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/syringe_skater.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_syringe_skater__idle`
...
Asset identity: Syringe Skater; class jumper; clinic courier skating on capped syringe rails; attacks with needle dash and tracking-dye splash; intended counter is parry, grate trap, signal jammer.
...
```
## Render job `enemy_syringe_skater__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_syringe_skater__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_syringe_skater__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_syringe_skater__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_syringe_skater__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_syringe_skater__death`
