...
sheet_id: enemy_rubber_glove_wraith
status: planned_full_scope
target_atlas: assets/sprites/enemies/rubber_glove_wraith.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Rubber-Glove Wraith


> Planned full-scope roster asset. World: **Drainmarket**. Class: **caster**.  
> Movement: floating surgical glove spirit with red tracking dye. Attack: grabs and slows from midrange. Counter/readability requirement: cut tether, decode tag, electric grate.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/rubber_glove_wraith.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_rubber_glove_wraith__idle`
...
Asset identity: Rubber-Glove Wraith; class caster; floating surgical glove spirit with red tracking dye; attacks with grabs and slows from midrange; intended counter is cut tether, decode tag, electric grate.
...
```
## Render job `enemy_rubber_glove_wraith__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rubber_glove_wraith__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rubber_glove_wraith__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rubber_glove_wraith__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rubber_glove_wraith__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_rubber_glove_wraith__death`
