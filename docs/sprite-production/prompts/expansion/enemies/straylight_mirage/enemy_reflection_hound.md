...
sheet_id: enemy_reflection_hound
status: planned_full_scope
target_atlas: assets/sprites/enemies/reflection_hound.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Reflection Hound


> Planned full-scope roster asset. World: **Straylight Mirage**. Class: **jumper**.  
> Movement: sleek mirror animal matching player jumps. Attack: bite emerging from mirrored side. Counter/readability requirement: fake-out movement and shadow strike.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/reflection_hound.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_reflection_hound__idle`
...
Asset identity: Reflection Hound; class jumper; sleek mirror animal matching player jumps; attacks with bite emerging from mirrored side; intended counter is fake-out movement and shadow strike.
...
```
## Render job `enemy_reflection_hound__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_reflection_hound__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_reflection_hound__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_reflection_hound__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_reflection_hound__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_reflection_hound__death`
