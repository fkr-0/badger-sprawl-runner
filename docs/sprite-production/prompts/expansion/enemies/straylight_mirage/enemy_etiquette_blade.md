...
sheet_id: enemy_etiquette_blade
status: planned_full_scope
target_atlas: assets/sprites/enemies/etiquette_blade.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Etiquette Blade


> Planned full-scope roster asset. World: **Straylight Mirage**. Class: **shield**.  
> Movement: formal servant sword-machine that bows before attacking. Attack: countercut punishing spam. Counter/readability requirement: wait for bow, parry late.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/etiquette_blade.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_etiquette_blade__idle`
...
Asset identity: Etiquette Blade; class shield; formal servant sword-machine that bows before attacking; attacks with countercut punishing spam; intended counter is wait for bow, parry late.
...
```
## Render job `enemy_etiquette_blade__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_etiquette_blade__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_etiquette_blade__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_etiquette_blade__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_etiquette_blade__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_etiquette_blade__death`
