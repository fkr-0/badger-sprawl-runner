...
sheet_id: enemy_window_saint
status: planned_full_scope
target_atlas: assets/sprites/enemies/window_saint.png
frame_size:
- 48
- 48
atlas_size: null
...
> Planned full-scope roster asset. World: **Straylight Mirage**. Class: **caster**.  
> Movement: holographic saint framed by false windows. Attack: creates fake floors and glass sermons. Counter/readability requirement: railgun reveals real platform.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/window_saint.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_window_saint__idle`
...
Asset identity: Window Saint; class caster; holographic saint framed by false windows; attacks with creates fake floors and glass sermons; intended counter is railgun reveals real platform.
...
```
## Render job `enemy_window_saint__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_window_saint__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_window_saint__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_window_saint__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_window_saint__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_window_saint__death`
