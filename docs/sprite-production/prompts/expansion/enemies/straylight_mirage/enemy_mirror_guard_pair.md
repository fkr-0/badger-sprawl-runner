...
sheet_id: enemy_mirror_guard_pair
status: planned_full_scope
target_atlas: assets/sprites/enemies/mirror_guard_pair.png
frame_size:
- 48
- 48
atlas_size: null
...
# Enemy Mirror Guard Pair


> Planned full-scope roster asset. World: **Straylight Mirage**. Class: **sub-boss**.  
> Movement: paired guards sharing one reflected silhouette. Attack: pincer teleport and clone strike. Counter/readability requirement: hack mirror anchor and hit real shadow.

Production role: `planned_enemy`. Render the jobs below separately, then assemble them into `assets/sprites/enemies/mirror_guard_pair.png` using manifest animation order.

The approved reference board establishes style only. Preserve the Badger Sprawl Runner identity described in each prompt.

## Render job `enemy_mirror_guard_pair__idle`
...
Asset identity: Mirror Guard Pair; class sub-boss; paired guards sharing one reflected silhouette; attacks with pincer teleport and clone strike; intended counter is hack mirror anchor and hit real shadow.
...
```
## Render job `enemy_mirror_guard_pair__patrol_or_move`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_mirror_guard_pair__windup`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_mirror_guard_pair__attack`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_mirror_guard_pair__hurt`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_mirror_guard_pair__stun_or_parried`
...
Do not add logos, readable text, watermarks, scenery behind transparent sprites, duplicate limbs, cropped ears, cropped tails, inconsistent weapons, perspective changes, sub-pixel blur, semi-transparent matte fringes, or unrequested cast shadows outside the frame.
```
## Render job `enemy_mirror_guard_pair__death`
