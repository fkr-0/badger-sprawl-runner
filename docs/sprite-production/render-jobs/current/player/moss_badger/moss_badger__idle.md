...
job_id: moss_badger__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:moss_badger:idle
...
output_image: renders/moss_badger/idle_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/moss_badger/idle_4c_2r.png`
...
| Runtime intent | `current:moss_badger:idle` |
