...
job_id: moss_badger__pickup_react
animation_state: pickup_react
animation_class: presentation
runtime_clip: current:moss_badger:pickup_react
...
output_image: renders/moss_badger/pickup_react_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `moss_badger__pickup_react`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger/pickup_react_3c_1r.png`
...
| Runtime intent | `current:moss_badger:pickup_react` |
