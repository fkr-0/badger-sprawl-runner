...
job_id: moss_badger__jump_up
animation_state: jump_up
animation_class: locomotion
runtime_clip: current:moss_badger:jump_up
...
output_image: renders/moss_badger/jump_up_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `moss_badger__jump_up`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger/jump_up_3c_1r.png`
...
| Runtime intent | `current:moss_badger:jump_up` |
