...
job_id: moss_badger__parry
animation_state: parry
animation_class: combat
runtime_clip: current:moss_badger:parry
...
output_image: renders/moss_badger/parry_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- Output image: `renders/moss_badger/parry_4c_1r.png`
...
| Runtime intent | `current:moss_badger:parry` |
