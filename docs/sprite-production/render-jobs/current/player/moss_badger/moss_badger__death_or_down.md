...
job_id: moss_badger__death_or_down
animation_state: death_or_down
animation_class: sprite_animation
runtime_clip: current:moss_badger:death_or_down
...
output_image: renders/moss_badger/death_or_down_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_badger__death_or_down`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger/death_or_down_4c_2r.png`
...
| Runtime intent | `current:moss_badger:death_or_down` |
