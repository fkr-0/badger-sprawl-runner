...
job_id: moss_badger__rocket_boost
animation_state: rocket_boost
animation_class: locomotion
runtime_clip: current:moss_badger:rocket_boost
...
output_image: renders/moss_badger/rocket_boost_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_badger__rocket_boost`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger/rocket_boost_4c_2r.png`
...
| Runtime intent | `current:moss_badger:rocket_boost` |
