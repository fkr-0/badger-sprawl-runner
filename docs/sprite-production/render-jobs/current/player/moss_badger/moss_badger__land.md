...
job_id: moss_badger__land
animation_state: land
animation_class: locomotion
runtime_clip: current:moss_badger:land
...
output_image: renders/moss_badger/land_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
- Output image: `renders/moss_badger/land_2c_1r.png`
...
| Runtime intent | `current:moss_badger:land` |
