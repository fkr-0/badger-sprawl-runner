...
job_id: moss_badger__interact
animation_state: interact
animation_class: interaction
runtime_clip: current:moss_badger:interact
...
output_image: renders/moss_badger/interact_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_badger__interact`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger/interact_4c_1r.png`
...
| Runtime intent | `current:moss_badger:interact` |
