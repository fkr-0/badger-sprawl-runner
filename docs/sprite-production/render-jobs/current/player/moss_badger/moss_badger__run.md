...
job_id: moss_badger__run
animation_state: run
animation_class: locomotion
runtime_clip: current:moss_badger:run
...
output_image: renders/moss_badger/run_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/moss_badger/run_4c_2r.png`
...
| Runtime intent | `current:moss_badger:run` |
