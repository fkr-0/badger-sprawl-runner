...
job_id: moss_badger__victory
animation_state: victory
animation_class: presentation
runtime_clip: current:moss_badger:victory
...
output_image: renders/moss_badger/victory_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_badger__victory`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger/victory_4c_2r.png`
...
| Runtime intent | `current:moss_badger:victory` |
