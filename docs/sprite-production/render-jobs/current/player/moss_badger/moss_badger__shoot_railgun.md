...
job_id: moss_badger__shoot_railgun
animation_state: shoot_railgun
animation_class: combat
runtime_clip: current:moss_badger:shoot_railgun
...
output_image: renders/moss_badger/shoot_railgun_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `moss_badger__shoot_railgun`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger/shoot_railgun_4c_2r.png`
...
| Runtime intent | `current:moss_badger:shoot_railgun` |
