...
job_id: moss_badger__hack
animation_state: hack
animation_class: interaction
runtime_clip: current:moss_badger:hack
...
output_image: renders/moss_badger/hack_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- Output image: `renders/moss_badger/hack_4c_1r.png`
...
| Runtime intent | `current:moss_badger:hack` |
