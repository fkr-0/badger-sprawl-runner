...
job_id: moss_badger__hit
animation_state: hit
animation_class: sprite_animation
runtime_clip: current:moss_badger:hit
...
output_image: renders/moss_badger/hit_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
- Output image: `renders/moss_badger/hit_3c_1r.png`
...
| Runtime intent | `current:moss_badger:hit` |
