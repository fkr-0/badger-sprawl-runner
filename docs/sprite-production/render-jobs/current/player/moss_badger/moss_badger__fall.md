...
job_id: moss_badger__fall
animation_state: fall
animation_class: locomotion
runtime_clip: current:moss_badger:fall
...
output_image: renders/moss_badger/fall_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
- Output image: `renders/moss_badger/fall_3c_1r.png`
...
| Runtime intent | `current:moss_badger:fall` |
