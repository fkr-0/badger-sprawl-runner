...
job_id: moss_badger_production__fall
animation_state: fall
animation_class: locomotion
runtime_clip: current:moss_badger_production:fall
...
output_image: renders/moss_badger_production/fall_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `moss_badger_production__fall`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/fall_3c_1r.png`
...
| Runtime intent | `current:moss_badger_production:fall` |
...
Render job: moss_badger_production__fall
