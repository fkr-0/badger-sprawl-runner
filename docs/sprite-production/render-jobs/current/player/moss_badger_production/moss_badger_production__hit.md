...
job_id: moss_badger_production__hit
animation_state: hit
animation_class: sprite_animation
runtime_clip: current:moss_badger_production:hit
...
output_image: renders/moss_badger_production/hit_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `moss_badger_production__hit`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/hit_3c_1r.png`
...
| Runtime intent | `current:moss_badger_production:hit` |
...
Render job: moss_badger_production__hit
