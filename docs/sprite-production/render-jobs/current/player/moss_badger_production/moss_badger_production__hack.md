...
job_id: moss_badger_production__hack
animation_state: hack
animation_class: interaction
runtime_clip: current:moss_badger_production:hack
...
output_image: renders/moss_badger_production/hack_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_badger_production__hack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/hack_4c_1r.png`
...
| Scope | `current` |
| Category | `player` |
| Animation state | `hack` |
| Animation class | `interaction` |
| Runtime intent | `current:moss_badger_production:hack` |
...
Render job: moss_badger_production__hack
