...
job_id: moss_badger_production__shoot_railgun
animation_state: shoot_railgun
animation_class: combat
runtime_clip: current:moss_badger_production:shoot_railgun
...
output_image: renders/moss_badger_production/shoot_railgun_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `moss_badger_production__shoot_railgun`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/shoot_railgun_4c_2r.png`
...
| Scope | `current` |
| Category | `player` |
| Animation state | `shoot_railgun` |
| Animation class | `combat` |
| Runtime intent | `current:moss_badger_production:shoot_railgun` |
...
Render job: moss_badger_production__shoot_railgun
