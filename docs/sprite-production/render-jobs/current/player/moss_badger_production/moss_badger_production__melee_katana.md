...
scope: current
category: player
source_entry: moss_badger_production
job_id: moss_badger_production__melee_katana
animation_state: melee_katana
animation_class: combat
runtime_clip: current:moss_badger_production:melee_katana
source_class: current_manifest
atlas_family: assets/sprites/moss_badger_production.png
target_atlas: assets/sprites/moss_badger_production.png
output_image: renders/moss_badger_production/melee_katana_4c_2r.png
frames: 7
grid:
  columns: 4
  rows: 2
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/current/player/moss_badger_production.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `moss_badger_production__melee_katana`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/melee_katana_4c_2r.png`
...
| Scope | `current` |
| Category | `player` |
| Animation state | `melee_katana` |
| Animation class | `combat` |
| Runtime intent | `current:moss_badger_production:melee_katana` |
| Atlas family | `assets/sprites/moss_badger_production.png` |
...
Render job: moss_badger_production__melee_katana
