...
job_id: moss_badger_production__land
animation_state: land
animation_class: locomotion
runtime_clip: current:moss_badger_production:land
...
output_image: renders/moss_badger_production/land_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `moss_badger_production__land`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/land_2c_1r.png`
...
| Runtime intent | `current:moss_badger_production:land` |
...
Render job: moss_badger_production__land
