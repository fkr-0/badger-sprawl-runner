...
job_id: moss_badger_production__parry
animation_state: parry
animation_class: combat
runtime_clip: current:moss_badger_production:parry
...
output_image: renders/moss_badger_production/parry_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_badger_production__parry`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/parry_4c_1r.png`
...
| Scope | `current` |
| Category | `player` |
| Animation state | `parry` |
| Animation class | `combat` |
| Runtime intent | `current:moss_badger_production:parry` |
...
Render job: moss_badger_production__parry
