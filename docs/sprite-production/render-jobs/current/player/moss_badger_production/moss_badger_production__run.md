...
job_id: moss_badger_production__run
animation_state: run
animation_class: locomotion
runtime_clip: current:moss_badger_production:run
...
output_image: renders/moss_badger_production/run_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_badger_production__run`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/run_4c_2r.png`
...
| Runtime intent | `current:moss_badger_production:run` |
...
Render job: moss_badger_production__run
