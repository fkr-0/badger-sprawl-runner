...
job_id: moss_badger_production__melee_claws
animation_state: melee_claws
animation_class: combat
runtime_clip: current:moss_badger_production:melee_claws
...
output_image: renders/moss_badger_production/melee_claws_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `moss_badger_production__melee_claws`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/melee_claws_4c_2r.png`
...
| Scope | `current` |
| Category | `player` |
| Animation state | `melee_claws` |
| Animation class | `combat` |
| Runtime intent | `current:moss_badger_production:melee_claws` |
...
Render job: moss_badger_production__melee_claws
