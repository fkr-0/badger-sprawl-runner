...
job_id: moss_badger_production__rocket_boost
animation_state: rocket_boost
animation_class: locomotion
runtime_clip: current:moss_badger_production:rocket_boost
...
output_image: renders/moss_badger_production/rocket_boost_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_badger_production__rocket_boost`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/rocket_boost_4c_2r.png`
...
| Scope | `current` |
| Category | `player` |
| Animation state | `rocket_boost` |
| Animation class | `locomotion` |
| Runtime intent | `current:moss_badger_production:rocket_boost` |
...
Render job: moss_badger_production__rocket_boost
