...
job_id: moss_badger_production__skid
animation_state: skid
animation_class: sprite_animation
runtime_clip: current:moss_badger_production:skid
...
output_image: renders/moss_badger_production/skid_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `moss_badger_production__skid`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/skid_3c_1r.png`
...
| Scope | `current` |
| Category | `player` |
| Animation state | `skid` |
| Animation class | `sprite_animation` |
| Runtime intent | `current:moss_badger_production:skid` |
...
Render job: moss_badger_production__skid
