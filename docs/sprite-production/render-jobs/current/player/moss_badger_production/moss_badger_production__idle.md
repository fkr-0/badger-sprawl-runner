...
job_id: moss_badger_production__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:moss_badger_production:idle
...
output_image: renders/moss_badger_production/idle_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_badger_production__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_badger_production/idle_4c_2r.png`
...
| Runtime intent | `current:moss_badger_production:idle` |
...
Render job: moss_badger_production__idle
