...
job_id: vfx_combat__story_payload_reveal
animation_state: story_payload_reveal
animation_class: effect
runtime_clip: current:vfx_combat:story_payload_reveal
source_class: current_manifest
atlas_family: assets/sprites/vfx_combat.png
target_atlas: assets/sprites/vfx_combat.png
output_image: renders/vfx_combat/story_payload_reveal_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_combat__story_payload_reveal`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx_combat/story_payload_reveal_4c_2r.png`
...
| Scope | `current` |
| Category | `vfx` |
| Animation state | `story_payload_reveal` |
| Animation class | `effect` |
| Runtime intent | `current:vfx_combat:story_payload_reveal` |
...
Render job: vfx_combat__story_payload_reveal
...
Animation: story_payload_reveal.
Frame count: 8.
Frame order:
1. key pose
2. anticipation
