...
job_id: vfx_combat__landing_dust
animation_state: landing_dust
animation_class: effect
runtime_clip: current:vfx_combat:landing_dust
source_class: current_manifest
atlas_family: assets/sprites/vfx_combat.png
target_atlas: assets/sprites/vfx_combat.png
output_image: renders/vfx_combat/landing_dust_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `vfx_combat__landing_dust`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx_combat/landing_dust_4c_2r.png`
...
| Scope | `current` |
| Category | `vfx` |
| Animation state | `landing_dust` |
| Animation class | `effect` |
| Runtime intent | `current:vfx_combat:landing_dust` |
...
Render job: vfx_combat__landing_dust
