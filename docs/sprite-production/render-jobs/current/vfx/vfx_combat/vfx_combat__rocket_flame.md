...
job_id: vfx_combat__rocket_flame
animation_state: rocket_flame
animation_class: effect
runtime_clip: current:vfx_combat:rocket_flame
source_class: current_manifest
atlas_family: assets/sprites/vfx_combat.png
target_atlas: assets/sprites/vfx_combat.png
output_image: renders/vfx_combat/rocket_flame_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_combat__rocket_flame`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx_combat/rocket_flame_4c_2r.png`
...
| Scope | `current` |
| Category | `vfx` |
| Animation state | `rocket_flame` |
| Animation class | `effect` |
| Runtime intent | `current:vfx_combat:rocket_flame` |
...
Render job: vfx_combat__rocket_flame
