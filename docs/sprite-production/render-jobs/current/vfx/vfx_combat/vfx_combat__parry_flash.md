...
job_id: vfx_combat__parry_flash
animation_state: parry_flash
animation_class: effect
runtime_clip: current:vfx_combat:parry_flash
source_class: current_manifest
atlas_family: assets/sprites/vfx_combat.png
target_atlas: assets/sprites/vfx_combat.png
output_image: renders/vfx_combat/parry_flash_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `vfx_combat__parry_flash`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx_combat/parry_flash_3c_1r.png`
- Grid: 3 columns × 1 rows
- Cell size: 32×32 pixels
- Output size: 96×32 pixels
- Occupied frames: 3
...
| Scope | `current` |
| Category | `vfx` |
| Animation state | `parry_flash` |
| Animation class | `effect` |
| Runtime intent | `current:vfx_combat:parry_flash` |
...
Render job: vfx_combat__parry_flash
Grid: 3 columns by 1 rows
Cell size: 32x32 pixels
Output size: 96x32 pixels
