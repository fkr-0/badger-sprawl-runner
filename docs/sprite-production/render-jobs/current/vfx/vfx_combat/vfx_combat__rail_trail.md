...
job_id: vfx_combat__rail_trail
animation_state: rail_trail
animation_class: effect
runtime_clip: current:vfx_combat:rail_trail
source_class: current_manifest
atlas_family: assets/sprites/vfx_combat.png
target_atlas: assets/sprites/vfx_combat.png
output_image: renders/vfx_combat/rail_trail_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `vfx_combat__rail_trail`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx_combat/rail_trail_3c_1r.png`
...
| Scope | `current` |
| Category | `vfx` |
| Animation state | `rail_trail` |
| Animation class | `effect` |
| Runtime intent | `current:vfx_combat:rail_trail` |
...
Render job: vfx_combat__rail_trail
