...
job_id: vfx_combat__rail_muzzle
animation_state: rail_muzzle
animation_class: effect
runtime_clip: current:vfx_combat:rail_muzzle
source_class: current_manifest
atlas_family: assets/sprites/vfx_combat.png
target_atlas: assets/sprites/vfx_combat.png
output_image: renders/vfx_combat/rail_muzzle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `vfx_combat__rail_muzzle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx_combat/rail_muzzle_4c_1r.png`
...
| Scope | `current` |
| Category | `vfx` |
| Animation state | `rail_muzzle` |
| Animation class | `effect` |
| Runtime intent | `current:vfx_combat:rail_muzzle` |
...
Render job: vfx_combat__rail_muzzle
