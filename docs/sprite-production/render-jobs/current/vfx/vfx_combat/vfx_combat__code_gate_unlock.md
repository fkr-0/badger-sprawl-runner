...
job_id: vfx_combat__code_gate_unlock
animation_state: code_gate_unlock
animation_class: effect
runtime_clip: current:vfx_combat:code_gate_unlock
source_class: current_manifest
atlas_family: assets/sprites/vfx_combat.png
target_atlas: assets/sprites/vfx_combat.png
output_image: renders/vfx_combat/code_gate_unlock_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_combat__code_gate_unlock`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx_combat/code_gate_unlock_4c_2r.png`
...
| Scope | `current` |
| Category | `vfx` |
| Animation state | `code_gate_unlock` |
| Animation class | `effect` |
| Runtime intent | `current:vfx_combat:code_gate_unlock` |
...
Render job: vfx_combat__code_gate_unlock
