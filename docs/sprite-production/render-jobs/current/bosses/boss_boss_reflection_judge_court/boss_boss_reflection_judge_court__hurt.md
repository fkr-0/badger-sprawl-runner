...
job_id: boss_boss_reflection_judge_court__hurt
animation_state: hurt
animation_class: combat
runtime_clip: current:boss_boss_reflection_judge_court:hurt
...
output_image: renders/boss_boss_reflection_judge_court/hurt_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `boss_boss_reflection_judge_court__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_reflection_judge_court/hurt_3c_1r.png`
- Grid: 3 columns × 1 rows
- Cell size: 96×96 pixels
- Output size: 288×96 pixels
- Occupied frames: 3
...
| Runtime intent | `current:boss_boss_reflection_judge_court:hurt` |
