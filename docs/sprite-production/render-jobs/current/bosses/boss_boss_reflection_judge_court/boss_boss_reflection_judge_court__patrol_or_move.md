...
job_id: boss_boss_reflection_judge_court__patrol_or_move
animation_state: patrol_or_move
animation_class: locomotion
runtime_clip: current:boss_boss_reflection_judge_court:patrol_or_move
...
output_image: renders/boss_boss_reflection_judge_court/patrol_or_move_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `boss_boss_reflection_judge_court__patrol_or_move`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_reflection_judge_court/patrol_or_move_4c_2r.png`
...
| Runtime intent | `current:boss_boss_reflection_judge_court:patrol_or_move` |
