...
job_id: boss_boss_reflection_judge_court__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: current:boss_boss_reflection_judge_court:stun_or_parried
...
output_image: renders/boss_boss_reflection_judge_court/stun_or_parried_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `boss_boss_reflection_judge_court__stun_or_parried`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_reflection_judge_court/stun_or_parried_4c_1r.png`
...
| Runtime intent | `current:boss_boss_reflection_judge_court:stun_or_parried` |
