...
job_id: boss_boss_director_vane_skylock__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:boss_boss_director_vane_skylock:idle
...
output_image: renders/boss_boss_director_vane_skylock/idle_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `boss_boss_director_vane_skylock__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_director_vane_skylock/idle_4c_2r.png`
...
| Runtime intent | `current:boss_boss_director_vane_skylock:idle` |
