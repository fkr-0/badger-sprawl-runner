...
job_id: boss_boss_black_ice_fox_node__phase_intro
animation_state: phase_intro
animation_class: presentation
runtime_clip: current:boss_boss_black_ice_fox_node:phase_intro
...
output_image: renders/boss_boss_black_ice_fox_node/phase_intro_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `boss_boss_black_ice_fox_node__phase_intro`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_black_ice_fox_node/phase_intro_4c_2r.png`
...
| Runtime intent | `current:boss_boss_black_ice_fox_node:phase_intro` |
...
Render job: boss_boss_black_ice_fox_node__phase_intro
