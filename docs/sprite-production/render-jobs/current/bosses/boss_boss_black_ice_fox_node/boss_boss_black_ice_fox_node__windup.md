...
job_id: boss_boss_black_ice_fox_node__windup
animation_state: windup
animation_class: combat
runtime_clip: current:boss_boss_black_ice_fox_node:windup
...
output_image: renders/boss_boss_black_ice_fox_node/windup_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `boss_boss_black_ice_fox_node__windup`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_black_ice_fox_node/windup_4c_1r.png`
...
| Runtime intent | `current:boss_boss_black_ice_fox_node:windup` |
...
Render job: boss_boss_black_ice_fox_node__windup
