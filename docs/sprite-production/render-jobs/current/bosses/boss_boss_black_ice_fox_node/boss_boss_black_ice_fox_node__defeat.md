...
job_id: boss_boss_black_ice_fox_node__defeat
animation_state: defeat
animation_class: presentation
runtime_clip: current:boss_boss_black_ice_fox_node:defeat
...
output_image: renders/boss_boss_black_ice_fox_node/defeat_4c_3r.png
frames: 10
grid:
  columns: 4
  rows: 3
...
# `boss_boss_black_ice_fox_node__defeat`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_black_ice_fox_node/defeat_4c_3r.png`
...
| Runtime intent | `current:boss_boss_black_ice_fox_node:defeat` |
...
Render job: boss_boss_black_ice_fox_node__defeat
