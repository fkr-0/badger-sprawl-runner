...
job_id: boss_boss_black_ice_fox_node__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:boss_boss_black_ice_fox_node:death
...
output_image: renders/boss_boss_black_ice_fox_node/death_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `boss_boss_black_ice_fox_node__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_black_ice_fox_node/death_4c_2r.png`
...
| Runtime intent | `current:boss_boss_black_ice_fox_node:death` |
...
Render job: boss_boss_black_ice_fox_node__death
