...
job_id: boss_boss_king_feedback_ampthrone__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:boss_boss_king_feedback_ampthrone:death
...
output_image: renders/boss_boss_king_feedback_ampthrone/death_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `boss_boss_king_feedback_ampthrone__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_king_feedback_ampthrone/death_4c_2r.png`
...
| Runtime intent | `current:boss_boss_king_feedback_ampthrone:death` |
