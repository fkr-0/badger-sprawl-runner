...
job_id: boss_boss_king_feedback_ampthrone__attack
animation_state: attack
animation_class: combat
runtime_clip: current:boss_boss_king_feedback_ampthrone:attack
...
output_image: renders/boss_boss_king_feedback_ampthrone/attack_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `boss_boss_king_feedback_ampthrone__attack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_king_feedback_ampthrone/attack_4c_2r.png`
...
| Runtime intent | `current:boss_boss_king_feedback_ampthrone:attack` |
