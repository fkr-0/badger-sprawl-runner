...
job_id: boss_boss_king_feedback_ampthrone__hurt
animation_state: hurt
animation_class: combat
runtime_clip: current:boss_boss_king_feedback_ampthrone:hurt
...
output_image: renders/boss_boss_king_feedback_ampthrone/hurt_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `boss_boss_king_feedback_ampthrone__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_king_feedback_ampthrone/hurt_3c_1r.png`
...
| Runtime intent | `current:boss_boss_king_feedback_ampthrone:hurt` |
