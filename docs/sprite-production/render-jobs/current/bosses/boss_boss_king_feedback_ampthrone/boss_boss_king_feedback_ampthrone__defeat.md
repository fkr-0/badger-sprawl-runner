...
job_id: boss_boss_king_feedback_ampthrone__defeat
animation_state: defeat
animation_class: presentation
runtime_clip: current:boss_boss_king_feedback_ampthrone:defeat
...
output_image: renders/boss_boss_king_feedback_ampthrone/defeat_4c_3r.png
frames: 10
grid:
  columns: 4
  rows: 3
...
# `boss_boss_king_feedback_ampthrone__defeat`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_king_feedback_ampthrone/defeat_4c_3r.png`
...
| Runtime intent | `current:boss_boss_king_feedback_ampthrone:defeat` |
