...
job_id: boss_boss_madame_vitrine_glasscourt__signature_attack
animation_state: signature_attack
animation_class: combat
runtime_clip: current:boss_boss_madame_vitrine_glasscourt:signature_attack
...
output_image: renders/boss_boss_madame_vitrine_glasscourt/signature_attack_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `boss_boss_madame_vitrine_glasscourt__signature_attack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_madame_vitrine_glasscourt/signature_attack_4c_2r.png`
...
| Runtime intent | `current:boss_boss_madame_vitrine_glasscourt:signature_attack` |
