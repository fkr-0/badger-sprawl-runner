...
job_id: boss_boss_elevator_angel_counterweight__patrol_or_move
animation_state: patrol_or_move
animation_class: locomotion
runtime_clip: current:boss_boss_elevator_angel_counterweight:patrol_or_move
...
output_image: renders/boss_boss_elevator_angel_counterweight/patrol_or_move_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/boss_boss_elevator_angel_counterweight/patrol_or_move_4c_2r.png`
...
| Runtime intent | `current:boss_boss_elevator_angel_counterweight:patrol_or_move` |
