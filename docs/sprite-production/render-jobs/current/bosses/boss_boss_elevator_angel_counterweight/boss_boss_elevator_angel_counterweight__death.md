...
job_id: boss_boss_elevator_angel_counterweight__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:boss_boss_elevator_angel_counterweight:death
...
output_image: renders/boss_boss_elevator_angel_counterweight/death_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/boss_boss_elevator_angel_counterweight/death_4c_2r.png`
...
| Runtime intent | `current:boss_boss_elevator_angel_counterweight:death` |
