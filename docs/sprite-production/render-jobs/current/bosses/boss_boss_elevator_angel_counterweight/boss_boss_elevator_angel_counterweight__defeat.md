...
job_id: boss_boss_elevator_angel_counterweight__defeat
animation_state: defeat
animation_class: presentation
runtime_clip: current:boss_boss_elevator_angel_counterweight:defeat
...
output_image: renders/boss_boss_elevator_angel_counterweight/defeat_4c_3r.png
frames: 10
grid:
  columns: 4
  rows: 3
...
- Output image: `renders/boss_boss_elevator_angel_counterweight/defeat_4c_3r.png`
...
| Runtime intent | `current:boss_boss_elevator_angel_counterweight:defeat` |
