...
job_id: boss_boss_elevator_angel_counterweight__signature_attack
animation_state: signature_attack
animation_class: combat
runtime_clip: current:boss_boss_elevator_angel_counterweight:signature_attack
...
output_image: renders/boss_boss_elevator_angel_counterweight/signature_attack_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/boss_boss_elevator_angel_counterweight/signature_attack_4c_2r.png`
...
| Runtime intent | `current:boss_boss_elevator_angel_counterweight:signature_attack` |
