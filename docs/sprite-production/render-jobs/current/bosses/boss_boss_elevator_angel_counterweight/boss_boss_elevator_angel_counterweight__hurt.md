...
job_id: boss_boss_elevator_angel_counterweight__hurt
animation_state: hurt
animation_class: combat
runtime_clip: current:boss_boss_elevator_angel_counterweight:hurt
...
output_image: renders/boss_boss_elevator_angel_counterweight/hurt_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
- Output image: `renders/boss_boss_elevator_angel_counterweight/hurt_3c_1r.png`
...
| Runtime intent | `current:boss_boss_elevator_angel_counterweight:hurt` |
