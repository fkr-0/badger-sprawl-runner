...
job_id: enemy_masque_duelist__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:enemy_masque_duelist:death
...
output_image: renders/enemy_masque_duelist/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_masque_duelist__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_masque_duelist/death_4c_2r.png`
...
| Runtime intent | `current:enemy_masque_duelist:death` |
...
Render job: enemy_masque_duelist__death
