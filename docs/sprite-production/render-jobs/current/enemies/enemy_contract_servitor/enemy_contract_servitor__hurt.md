...
job_id: enemy_contract_servitor__hurt
animation_state: hurt
animation_class: combat
runtime_clip: current:enemy_contract_servitor:hurt
...
output_image: renders/enemy_contract_servitor/hurt_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `enemy_contract_servitor__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_contract_servitor/hurt_2c_1r.png`
...
| Runtime intent | `current:enemy_contract_servitor:hurt` |
...
Render job: enemy_contract_servitor__hurt
