...
job_id: enemy_contract_servitor__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:enemy_contract_servitor:death
...
output_image: renders/enemy_contract_servitor/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_contract_servitor__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_contract_servitor/death_4c_2r.png`
...
| Runtime intent | `current:enemy_contract_servitor:death` |
...
Render job: enemy_contract_servitor__death
