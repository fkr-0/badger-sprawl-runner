...
job_id: enemy_contract_servitor__attack
animation_state: attack
animation_class: combat
runtime_clip: current:enemy_contract_servitor:attack
...
output_image: renders/enemy_contract_servitor/attack_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `enemy_contract_servitor__attack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_contract_servitor/attack_4c_2r.png`
...
| Runtime intent | `current:enemy_contract_servitor:attack` |
...
Render job: enemy_contract_servitor__attack
