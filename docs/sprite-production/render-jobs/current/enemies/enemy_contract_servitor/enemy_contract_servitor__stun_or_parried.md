...
scope: current
category: enemies
source_entry: enemy_contract_servitor
job_id: enemy_contract_servitor__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: current:enemy_contract_servitor:stun_or_parried
source_class: current_manifest
atlas_family: assets/sprites/enemies/contract_servitor.png
target_atlas: assets/sprites/enemies/contract_servitor.png
output_image: renders/enemy_contract_servitor/stun_or_parried_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
source_prompt_file: docs/sprite-production/prompts/current/enemies/enemy_contract_servitor.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `enemy_contract_servitor__stun_or_parried`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_contract_servitor/stun_or_parried_3c_1r.png`
...
| Runtime intent | `current:enemy_contract_servitor:stun_or_parried` |
| Atlas family | `assets/sprites/enemies/contract_servitor.png` |
...
Render job: enemy_contract_servitor__stun_or_parried
