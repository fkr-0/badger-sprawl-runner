...
job_id: enemy_feedback_guard__attack
animation_state: attack
animation_class: combat
runtime_clip: current:enemy_feedback_guard:attack
...
output_image: renders/enemy_feedback_guard/attack_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `enemy_feedback_guard__attack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_feedback_guard/attack_4c_2r.png`
...
| Runtime intent | `current:enemy_feedback_guard:attack` |
...
Render job: enemy_feedback_guard__attack
