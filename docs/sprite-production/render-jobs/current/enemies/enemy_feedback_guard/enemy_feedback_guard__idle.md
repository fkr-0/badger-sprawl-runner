...
job_id: enemy_feedback_guard__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:enemy_feedback_guard:idle
...
output_image: renders/enemy_feedback_guard/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_feedback_guard__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_feedback_guard/idle_4c_1r.png`
...
| Runtime intent | `current:enemy_feedback_guard:idle` |
...
Render job: enemy_feedback_guard__idle
