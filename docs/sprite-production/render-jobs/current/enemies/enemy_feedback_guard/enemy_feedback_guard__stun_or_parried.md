...
scope: current
category: enemies
source_entry: enemy_feedback_guard
job_id: enemy_feedback_guard__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: current:enemy_feedback_guard:stun_or_parried
source_class: current_manifest
atlas_family: assets/sprites/enemies/feedback_guard.png
target_atlas: assets/sprites/enemies/feedback_guard.png
output_image: renders/enemy_feedback_guard/stun_or_parried_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
- 48
world: dub_colony
source_prompt_file: docs/sprite-production/prompts/current/enemies/enemy_feedback_guard.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `enemy_feedback_guard__stun_or_parried`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_feedback_guard/stun_or_parried_3c_1r.png`
...
| Runtime intent | `current:enemy_feedback_guard:stun_or_parried` |
| Atlas family | `assets/sprites/enemies/feedback_guard.png` |
...
Render job: enemy_feedback_guard__stun_or_parried
