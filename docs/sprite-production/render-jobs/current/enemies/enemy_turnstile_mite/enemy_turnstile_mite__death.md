...
job_id: enemy_turnstile_mite__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:enemy_turnstile_mite:death
...
output_image: renders/enemy_turnstile_mite/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_turnstile_mite__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_turnstile_mite/death_4c_2r.png`
...
| Runtime intent | `current:enemy_turnstile_mite:death` |
...
Render job: enemy_turnstile_mite__death
