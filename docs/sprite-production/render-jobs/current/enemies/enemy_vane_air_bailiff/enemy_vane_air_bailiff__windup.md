...
job_id: enemy_vane_air_bailiff__windup
animation_state: windup
animation_class: combat
runtime_clip: current:enemy_vane_air_bailiff:windup
...
output_image: renders/enemy_vane_air_bailiff/windup_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `enemy_vane_air_bailiff__windup`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_vane_air_bailiff/windup_3c_1r.png`
...
| Runtime intent | `current:enemy_vane_air_bailiff:windup` |
...
Render job: enemy_vane_air_bailiff__windup
