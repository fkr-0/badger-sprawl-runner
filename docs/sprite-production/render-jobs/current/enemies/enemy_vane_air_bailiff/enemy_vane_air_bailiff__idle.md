...
job_id: enemy_vane_air_bailiff__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:enemy_vane_air_bailiff:idle
...
output_image: renders/enemy_vane_air_bailiff/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_vane_air_bailiff__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_vane_air_bailiff/idle_4c_1r.png`
...
| Runtime intent | `current:enemy_vane_air_bailiff:idle` |
...
Render job: enemy_vane_air_bailiff__idle
