...
job_id: enemy_vane_air_bailiff__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:enemy_vane_air_bailiff:death
...
output_image: renders/enemy_vane_air_bailiff/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_vane_air_bailiff__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_vane_air_bailiff/death_4c_2r.png`
...
| Runtime intent | `current:enemy_vane_air_bailiff:death` |
...
Render job: enemy_vane_air_bailiff__death
