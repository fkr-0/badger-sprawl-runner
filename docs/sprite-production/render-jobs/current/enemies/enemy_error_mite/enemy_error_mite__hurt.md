...
job_id: enemy_error_mite__hurt
animation_state: hurt
animation_class: combat
runtime_clip: current:enemy_error_mite:hurt
...
output_image: renders/enemy_error_mite/hurt_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `enemy_error_mite__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_error_mite/hurt_2c_1r.png`
...
| Runtime intent | `current:enemy_error_mite:hurt` |
...
Render job: enemy_error_mite__hurt
