...
job_id: enemy_clinic_repo__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:enemy_clinic_repo:idle
...
output_image: renders/enemy_clinic_repo/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_clinic_repo__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_clinic_repo/idle_4c_1r.png`
...
| Runtime intent | `current:enemy_clinic_repo:idle` |
