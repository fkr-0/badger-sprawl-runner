...
job_id: enemy_clinic_repo__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:enemy_clinic_repo:death
...
output_image: renders/enemy_clinic_repo/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_clinic_repo__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_clinic_repo/death_4c_2r.png`
...
| Runtime intent | `current:enemy_clinic_repo:death` |
