...
job_id: enemy_mirror_sentinel__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:enemy_mirror_sentinel:death
...
output_image: renders/enemy_mirror_sentinel/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_mirror_sentinel__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_mirror_sentinel/death_4c_2r.png`
...
| Runtime intent | `current:enemy_mirror_sentinel:death` |
...
Render job: enemy_mirror_sentinel__death
