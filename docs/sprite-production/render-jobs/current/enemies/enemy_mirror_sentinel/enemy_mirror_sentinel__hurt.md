...
job_id: enemy_mirror_sentinel__hurt
animation_state: hurt
animation_class: combat
runtime_clip: current:enemy_mirror_sentinel:hurt
...
output_image: renders/enemy_mirror_sentinel/hurt_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `enemy_mirror_sentinel__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_mirror_sentinel/hurt_2c_1r.png`
...
| Runtime intent | `current:enemy_mirror_sentinel:hurt` |
...
Render job: enemy_mirror_sentinel__hurt
