...
job_id: enemy_customs_lancer__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: current:enemy_customs_lancer:stun_or_parried
...
output_image: renders/enemy_customs_lancer/stun_or_parried_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `enemy_customs_lancer__stun_or_parried`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_customs_lancer/stun_or_parried_3c_1r.png`
...
| Runtime intent | `current:enemy_customs_lancer:stun_or_parried` |
