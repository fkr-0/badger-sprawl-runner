...
scope: current
category: enemies
source_entry: enemy_knife_drone
job_id: enemy_knife_drone__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: current:enemy_knife_drone:stun_or_parried
source_class: current_manifest
atlas_family: assets/sprites/enemies/knife_drone.png
target_atlas: assets/sprites/enemies/knife_drone.png
output_image: renders/enemy_knife_drone/stun_or_parried_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
- 48
world: drainmarket
source_prompt_file: docs/sprite-production/prompts/current/enemies/enemy_knife_drone.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `enemy_knife_drone__stun_or_parried`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_knife_drone/stun_or_parried_3c_1r.png`
...
| Runtime intent | `current:enemy_knife_drone:stun_or_parried` |
| Atlas family | `assets/sprites/enemies/knife_drone.png` |
...
Render job: enemy_knife_drone__stun_or_parried
