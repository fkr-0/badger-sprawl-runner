...
job_id: enemy_knife_drone__hurt
animation_state: hurt
animation_class: combat
runtime_clip: current:enemy_knife_drone:hurt
...
output_image: renders/enemy_knife_drone/hurt_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `enemy_knife_drone__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_knife_drone/hurt_2c_1r.png`
...
| Runtime intent | `current:enemy_knife_drone:hurt` |
...
Render job: enemy_knife_drone__hurt
