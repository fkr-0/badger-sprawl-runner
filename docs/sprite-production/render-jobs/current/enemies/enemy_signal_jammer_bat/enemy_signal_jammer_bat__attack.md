...
job_id: enemy_signal_jammer_bat__attack
animation_state: attack
animation_class: combat
runtime_clip: current:enemy_signal_jammer_bat:attack
...
output_image: renders/enemy_signal_jammer_bat/attack_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `enemy_signal_jammer_bat__attack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_signal_jammer_bat/attack_4c_2r.png`
...
| Runtime intent | `current:enemy_signal_jammer_bat:attack` |
...
Render job: enemy_signal_jammer_bat__attack
