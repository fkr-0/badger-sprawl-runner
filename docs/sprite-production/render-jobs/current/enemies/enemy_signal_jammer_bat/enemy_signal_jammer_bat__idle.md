...
job_id: enemy_signal_jammer_bat__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:enemy_signal_jammer_bat:idle
...
output_image: renders/enemy_signal_jammer_bat/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_signal_jammer_bat__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_signal_jammer_bat/idle_4c_1r.png`
...
| Runtime intent | `current:enemy_signal_jammer_bat:idle` |
...
Render job: enemy_signal_jammer_bat__idle
