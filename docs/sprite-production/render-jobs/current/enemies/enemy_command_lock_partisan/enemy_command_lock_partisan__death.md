...
job_id: enemy_command_lock_partisan__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:enemy_command_lock_partisan:death
...
output_image: renders/enemy_command_lock_partisan/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_command_lock_partisan__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_command_lock_partisan/death_4c_2r.png`
...
| Runtime intent | `current:enemy_command_lock_partisan:death` |
...
Render job: enemy_command_lock_partisan__death
