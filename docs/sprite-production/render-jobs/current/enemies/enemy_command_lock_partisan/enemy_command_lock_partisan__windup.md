...
job_id: enemy_command_lock_partisan__windup
animation_state: windup
animation_class: combat
runtime_clip: current:enemy_command_lock_partisan:windup
...
output_image: renders/enemy_command_lock_partisan/windup_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `enemy_command_lock_partisan__windup`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_command_lock_partisan/windup_3c_1r.png`
...
| Runtime intent | `current:enemy_command_lock_partisan:windup` |
...
Render job: enemy_command_lock_partisan__windup
