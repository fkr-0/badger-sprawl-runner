...
job_id: enemy_manifest_monk__death
animation_state: death
animation_class: sprite_animation
runtime_clip: current:enemy_manifest_monk:death
...
output_image: renders/enemy_manifest_monk/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_manifest_monk__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_manifest_monk/death_4c_2r.png`
...
| Runtime intent | `current:enemy_manifest_monk:death` |
...
Render job: enemy_manifest_monk__death
