...
job_id: enemy_manifest_monk__patrol_or_move
animation_state: patrol_or_move
animation_class: locomotion
runtime_clip: current:enemy_manifest_monk:patrol_or_move
...
output_image: renders/enemy_manifest_monk/patrol_or_move_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_manifest_monk__patrol_or_move`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_manifest_monk/patrol_or_move_4c_2r.png`
...
| Runtime intent | `current:enemy_manifest_monk:patrol_or_move` |
...
Render job: enemy_manifest_monk__patrol_or_move
