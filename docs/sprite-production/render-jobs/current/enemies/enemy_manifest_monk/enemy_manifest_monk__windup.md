...
job_id: enemy_manifest_monk__windup
animation_state: windup
animation_class: combat
runtime_clip: current:enemy_manifest_monk:windup
...
output_image: renders/enemy_manifest_monk/windup_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `enemy_manifest_monk__windup`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_manifest_monk/windup_3c_1r.png`
...
| Runtime intent | `current:enemy_manifest_monk:windup` |
...
Render job: enemy_manifest_monk__windup
