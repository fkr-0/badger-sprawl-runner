...
job_id: enemy_manifest_monk__attack
animation_state: attack
animation_class: combat
runtime_clip: current:enemy_manifest_monk:attack
...
output_image: renders/enemy_manifest_monk/attack_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `enemy_manifest_monk__attack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_manifest_monk/attack_4c_2r.png`
...
| Runtime intent | `current:enemy_manifest_monk:attack` |
...
Render job: enemy_manifest_monk__attack
