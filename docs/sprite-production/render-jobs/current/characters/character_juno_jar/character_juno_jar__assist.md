...
scope: current
category: characters
source_entry: character_juno_jar
job_id: character_juno_jar__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_juno_jar:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/juno_jar.png
target_atlas: assets/sprites/characters/juno_jar.png
output_image: renders/character_juno_jar/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: lower_sprawl
source_prompt_file: docs/sprite-production/prompts/current/characters/character_juno_jar.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_juno_jar__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_juno_jar/assist_4c_2r.png`
...
| Runtime intent | `current:character_juno_jar:assist` |
| Atlas family | `assets/sprites/characters/juno_jar.png` |
...
Render job: character_juno_jar__assist
