...
job_id: character_king_feedback__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:character_king_feedback:idle
...
output_image: renders/character_king_feedback/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_king_feedback__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_king_feedback/idle_4c_1r.png`
...
| Runtime intent | `current:character_king_feedback:idle` |
...
Render job: character_king_feedback__idle
