...
scope: current
category: characters
source_entry: character_mara_modulo
job_id: character_mara_modulo__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_mara_modulo:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/mara_modulo.png
target_atlas: assets/sprites/characters/mara_modulo.png
output_image: renders/character_mara_modulo/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
source_prompt_file: docs/sprite-production/prompts/current/characters/character_mara_modulo.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_mara_modulo__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_mara_modulo/assist_4c_2r.png`
...
| Runtime intent | `current:character_mara_modulo:assist` |
| Atlas family | `assets/sprites/characters/mara_modulo.png` |
...
Render job: character_mara_modulo__assist
