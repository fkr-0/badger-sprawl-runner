...
job_id: character_madame_vitrine__talk
animation_state: talk
animation_class: presentation
runtime_clip: current:character_madame_vitrine:talk
...
output_image: renders/character_madame_vitrine/talk_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_madame_vitrine__talk`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_madame_vitrine/talk_4c_2r.png`
...
| Runtime intent | `current:character_madame_vitrine:talk` |
...
Render job: character_madame_vitrine__talk
