...
job_id: character_madame_vitrine__react
animation_state: react
animation_class: presentation
runtime_clip: current:character_madame_vitrine:react
...
output_image: renders/character_madame_vitrine/react_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_madame_vitrine__react`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_madame_vitrine/react_4c_1r.png`
...
| Runtime intent | `current:character_madame_vitrine:react` |
...
Render job: character_madame_vitrine__react
