...
job_id: character_sister_version__exit
animation_state: exit
animation_class: sprite_animation
runtime_clip: current:character_sister_version:exit
...
output_image: renders/character_sister_version/exit_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_sister_version__exit`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_sister_version/exit_4c_1r.png`
...
| Runtime intent | `current:character_sister_version:exit` |
...
Render job: character_sister_version__exit
