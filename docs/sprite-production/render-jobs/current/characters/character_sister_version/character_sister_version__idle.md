...
job_id: character_sister_version__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:character_sister_version:idle
...
output_image: renders/character_sister_version/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_sister_version__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_sister_version/idle_4c_1r.png`
...
| Runtime intent | `current:character_sister_version:idle` |
...
Render job: character_sister_version__idle
