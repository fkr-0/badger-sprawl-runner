...
job_id: character_little_ix__talk
animation_state: talk
animation_class: presentation
runtime_clip: current:character_little_ix:talk
...
output_image: renders/character_little_ix/talk_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_little_ix__talk`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_little_ix/talk_4c_2r.png`
...
| Runtime intent | `current:character_little_ix:talk` |
...
Render job: character_little_ix__talk
