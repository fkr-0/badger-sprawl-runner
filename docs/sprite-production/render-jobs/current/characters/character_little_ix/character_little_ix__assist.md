...
scope: current
category: characters
source_entry: character_little_ix
job_id: character_little_ix__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_little_ix:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/little_ix.png
target_atlas: assets/sprites/characters/little_ix.png
output_image: renders/character_little_ix/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: dub_colony
source_prompt_file: docs/sprite-production/prompts/current/characters/character_little_ix.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_little_ix__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_little_ix/assist_4c_2r.png`
...
| Runtime intent | `current:character_little_ix:assist` |
| Atlas family | `assets/sprites/characters/little_ix.png` |
...
Render job: character_little_ix__assist
