...
job_id: character_lio__talk
animation_state: talk
animation_class: presentation
runtime_clip: current:character_lio:talk
...
output_image: renders/character_lio/talk_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/character_lio/talk_4c_2r.png`
...
| Runtime intent | `current:character_lio:talk` |
...
Render job: character_lio__talk
