...
job_id: character_lio__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_lio:assist
...
output_image: renders/character_lio/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_lio__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_lio/assist_4c_2r.png`
...
| Runtime intent | `current:character_lio:assist` |
...
Render job: character_lio__assist
