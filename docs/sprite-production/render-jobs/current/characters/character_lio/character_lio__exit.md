...
job_id: character_lio__exit
animation_state: exit
animation_class: sprite_animation
runtime_clip: current:character_lio:exit
...
output_image: renders/character_lio/exit_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- Output image: `renders/character_lio/exit_4c_1r.png`
...
| Runtime intent | `current:character_lio:exit` |
...
Render job: character_lio__exit
