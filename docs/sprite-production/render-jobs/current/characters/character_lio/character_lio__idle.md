...
job_id: character_lio__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:character_lio:idle
...
output_image: renders/character_lio/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- Output image: `renders/character_lio/idle_4c_1r.png`
...
| Runtime intent | `current:character_lio:idle` |
...
Render job: character_lio__idle
