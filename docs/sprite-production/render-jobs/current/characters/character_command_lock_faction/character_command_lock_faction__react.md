...
job_id: character_command_lock_faction__react
animation_state: react
animation_class: presentation
runtime_clip: current:character_command_lock_faction:react
...
output_image: renders/character_command_lock_faction/react_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- Output image: `renders/character_command_lock_faction/react_4c_1r.png`
...
| Runtime intent | `current:character_command_lock_faction:react` |
...
Render job: character_command_lock_faction__react
