...
scope: current
category: characters
source_entry: character_command_lock_faction
job_id: character_command_lock_faction__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_command_lock_faction:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/command_lock_faction.png
target_atlas: assets/sprites/characters/command_lock_faction.png
output_image: renders/character_command_lock_faction/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
source_prompt_file: docs/sprite-production/prompts/current/characters/character_command_lock_faction.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_command_lock_faction__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_command_lock_faction/assist_4c_2r.png`
...
| Scope | `current` |
| Category | `characters` |
| Animation state | `assist` |
| Animation class | `interaction` |
| Runtime intent | `current:character_command_lock_faction:assist` |
| Atlas family | `assets/sprites/characters/command_lock_faction.png` |
...
Render job: character_command_lock_faction__assist
