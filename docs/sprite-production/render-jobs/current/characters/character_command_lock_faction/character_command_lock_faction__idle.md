...
job_id: character_command_lock_faction__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:character_command_lock_faction:idle
...
output_image: renders/character_command_lock_faction/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_command_lock_faction__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_command_lock_faction/idle_4c_1r.png`
...
| Runtime intent | `current:character_command_lock_faction:idle` |
...
Render job: character_command_lock_faction__idle
