...
job_id: character_command_lock_faction__talk
animation_state: talk
animation_class: presentation
runtime_clip: current:character_command_lock_faction:talk
...
output_image: renders/character_command_lock_faction/talk_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/character_command_lock_faction/talk_4c_2r.png`
...
| Runtime intent | `current:character_command_lock_faction:talk` |
...
Render job: character_command_lock_faction__talk
