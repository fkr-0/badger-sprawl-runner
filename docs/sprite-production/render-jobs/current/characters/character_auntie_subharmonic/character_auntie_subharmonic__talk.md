...
job_id: character_auntie_subharmonic__talk
animation_state: talk
animation_class: presentation
runtime_clip: current:character_auntie_subharmonic:talk
...
output_image: renders/character_auntie_subharmonic/talk_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_auntie_subharmonic__talk`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_auntie_subharmonic/talk_4c_2r.png`
...
| Runtime intent | `current:character_auntie_subharmonic:talk` |
...
Render job: character_auntie_subharmonic__talk
