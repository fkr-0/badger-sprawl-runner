...
scope: current
category: characters
source_entry: character_auntie_subharmonic
job_id: character_auntie_subharmonic__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_auntie_subharmonic:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/auntie_subharmonic.png
target_atlas: assets/sprites/characters/auntie_subharmonic.png
output_image: renders/character_auntie_subharmonic/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: lower_sprawl
source_prompt_file: docs/sprite-production/prompts/current/characters/character_auntie_subharmonic.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_auntie_subharmonic__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_auntie_subharmonic/assist_4c_2r.png`
...
| Runtime intent | `current:character_auntie_subharmonic:assist` |
| Atlas family | `assets/sprites/characters/auntie_subharmonic.png` |
...
Render job: character_auntie_subharmonic__assist
