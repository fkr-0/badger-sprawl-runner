...
job_id: character_cobalt_carmine__exit
animation_state: exit
animation_class: sprite_animation
runtime_clip: current:character_cobalt_carmine:exit
...
output_image: renders/character_cobalt_carmine/exit_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_cobalt_carmine__exit`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_cobalt_carmine/exit_4c_1r.png`
...
| Runtime intent | `current:character_cobalt_carmine:exit` |
...
Render job: character_cobalt_carmine__exit
