...
job_id: character_cobalt_carmine__talk
animation_state: talk
animation_class: presentation
runtime_clip: current:character_cobalt_carmine:talk
...
output_image: renders/character_cobalt_carmine/talk_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_cobalt_carmine__talk`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_cobalt_carmine/talk_4c_2r.png`
...
| Runtime intent | `current:character_cobalt_carmine:talk` |
...
Render job: character_cobalt_carmine__talk
