...
job_id: character_cobalt_carmine__react
animation_state: react
animation_class: presentation
runtime_clip: current:character_cobalt_carmine:react
...
output_image: renders/character_cobalt_carmine/react_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_cobalt_carmine__react`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_cobalt_carmine/react_4c_1r.png`
...
| Runtime intent | `current:character_cobalt_carmine:react` |
...
Render job: character_cobalt_carmine__react
