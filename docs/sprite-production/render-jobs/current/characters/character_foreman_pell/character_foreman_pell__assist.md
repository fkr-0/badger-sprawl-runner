...
scope: current
category: characters
source_entry: character_foreman_pell
job_id: character_foreman_pell__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_foreman_pell:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/foreman_pell.png
target_atlas: assets/sprites/characters/foreman_pell.png
output_image: renders/character_foreman_pell/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
source_prompt_file: docs/sprite-production/prompts/current/characters/character_foreman_pell.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_foreman_pell__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_foreman_pell/assist_4c_2r.png`
...
| Runtime intent | `current:character_foreman_pell:assist` |
| Atlas family | `assets/sprites/characters/foreman_pell.png` |
...
Render job: character_foreman_pell__assist
