...
scope: current
category: characters
source_entry: character_murr_murrby
job_id: character_murr_murrby__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_murr_murrby:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/murr_murrby.png
target_atlas: assets/sprites/characters/murr_murrby.png
output_image: renders/character_murr_murrby/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: orbital_lift
source_prompt_file: docs/sprite-production/prompts/current/characters/character_murr_murrby.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_murr_murrby__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_murr_murrby/assist_4c_2r.png`
...
| Runtime intent | `current:character_murr_murrby:assist` |
| Atlas family | `assets/sprites/characters/murr_murrby.png` |
...
Render job: character_murr_murrby__assist
