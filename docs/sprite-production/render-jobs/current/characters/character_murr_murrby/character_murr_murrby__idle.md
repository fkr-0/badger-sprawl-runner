...
job_id: character_murr_murrby__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:character_murr_murrby:idle
...
output_image: renders/character_murr_murrby/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_murr_murrby__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_murr_murrby/idle_4c_1r.png`
...
| Runtime intent | `current:character_murr_murrby:idle` |
...
Render job: character_murr_murrby__idle
