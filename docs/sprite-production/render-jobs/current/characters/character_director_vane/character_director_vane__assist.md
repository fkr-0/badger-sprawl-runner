...
scope: current
category: characters
source_entry: character_director_vane
job_id: character_director_vane__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_director_vane:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/director_vane.png
target_atlas: assets/sprites/characters/director_vane.png
output_image: renders/character_director_vane/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
source_prompt_file: docs/sprite-production/prompts/current/characters/character_director_vane.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_director_vane__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_director_vane/assist_4c_2r.png`
...
| Runtime intent | `current:character_director_vane:assist` |
| Atlas family | `assets/sprites/characters/director_vane.png` |
...
Render job: character_director_vane__assist
