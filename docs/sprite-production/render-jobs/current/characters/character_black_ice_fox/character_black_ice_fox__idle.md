...
job_id: character_black_ice_fox__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:character_black_ice_fox:idle
...
output_image: renders/character_black_ice_fox/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_black_ice_fox__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_black_ice_fox/idle_4c_1r.png`
...
| Runtime intent | `current:character_black_ice_fox:idle` |
