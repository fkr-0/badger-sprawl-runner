...
scope: current
category: characters
source_entry: character_black_ice_fox
job_id: character_black_ice_fox__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_black_ice_fox:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/black_ice_fox.png
target_atlas: assets/sprites/characters/black_ice_fox.png
output_image: renders/character_black_ice_fox/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
source_prompt_file: docs/sprite-production/prompts/current/characters/character_black_ice_fox.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_black_ice_fox__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_black_ice_fox/assist_4c_2r.png`
...
| Runtime intent | `current:character_black_ice_fox:assist` |
| Atlas family | `assets/sprites/characters/black_ice_fox.png` |
