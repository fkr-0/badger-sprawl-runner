...
job_id: character_reflection_judge__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:character_reflection_judge:idle
...
output_image: renders/character_reflection_judge/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_reflection_judge__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_reflection_judge/idle_4c_1r.png`
...
| Runtime intent | `current:character_reflection_judge:idle` |
...
Render job: character_reflection_judge__idle
