...
job_id: character_reflection_judge__talk
animation_state: talk
animation_class: presentation
runtime_clip: current:character_reflection_judge:talk
...
output_image: renders/character_reflection_judge/talk_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_reflection_judge__talk`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_reflection_judge/talk_4c_2r.png`
...
| Runtime intent | `current:character_reflection_judge:talk` |
...
Render job: character_reflection_judge__talk
