...
job_id: character_dr_mina_suture__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_dr_mina_suture:assist
...
output_image: renders/character_dr_mina_suture/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_dr_mina_suture__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_dr_mina_suture/assist_4c_2r.png`
...
| Runtime intent | `current:character_dr_mina_suture:assist` |
...
Render job: character_dr_mina_suture__assist
