...
job_id: character_dr_mina_suture__react
animation_state: react
animation_class: presentation
runtime_clip: current:character_dr_mina_suture:react
...
output_image: renders/character_dr_mina_suture/react_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_dr_mina_suture__react`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_dr_mina_suture/react_4c_1r.png`
...
| Runtime intent | `current:character_dr_mina_suture:react` |
