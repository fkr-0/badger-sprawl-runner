...
scope: current
category: characters
source_entry: character_rook_null
job_id: character_rook_null__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_rook_null:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/rook_null.png
target_atlas: assets/sprites/characters/rook_null.png
output_image: renders/character_rook_null/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: drainmarket
source_prompt_file: docs/sprite-production/prompts/current/characters/character_rook_null.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_rook_null__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_rook_null/assist_4c_2r.png`
...
| Runtime intent | `current:character_rook_null:assist` |
| Atlas family | `assets/sprites/characters/rook_null.png` |
...
Render job: character_rook_null__assist
