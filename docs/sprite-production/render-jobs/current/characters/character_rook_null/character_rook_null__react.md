...
job_id: character_rook_null__react
animation_state: react
animation_class: presentation
runtime_clip: current:character_rook_null:react
...
output_image: renders/character_rook_null/react_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_rook_null__react`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_rook_null/react_4c_1r.png`
...
| Runtime intent | `current:character_rook_null:react` |
...
Render job: character_rook_null__react
