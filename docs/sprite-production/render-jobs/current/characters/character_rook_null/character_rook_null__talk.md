...
job_id: character_rook_null__talk
animation_state: talk
animation_class: presentation
runtime_clip: current:character_rook_null:talk
...
output_image: renders/character_rook_null/talk_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_rook_null__talk`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_rook_null/talk_4c_2r.png`
...
| Runtime intent | `current:character_rook_null:talk` |
...
Render job: character_rook_null__talk
