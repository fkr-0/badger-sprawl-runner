...
scope: current
category: characters
source_entry: character_elevator_angel
job_id: character_elevator_angel__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_elevator_angel:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/elevator_angel.png
target_atlas: assets/sprites/characters/elevator_angel.png
output_image: renders/character_elevator_angel/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: orbital_lift
source_prompt_file: docs/sprite-production/prompts/current/characters/character_elevator_angel.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_elevator_angel__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_elevator_angel/assist_4c_2r.png`
...
| Runtime intent | `current:character_elevator_angel:assist` |
| Atlas family | `assets/sprites/characters/elevator_angel.png` |
...
Render job: character_elevator_angel__assist
