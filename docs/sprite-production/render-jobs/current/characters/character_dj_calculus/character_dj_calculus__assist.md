...
scope: current
category: characters
source_entry: character_dj_calculus
job_id: character_dj_calculus__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_dj_calculus:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/dj_calculus.png
target_atlas: assets/sprites/characters/dj_calculus.png
output_image: renders/character_dj_calculus/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: drainmarket
source_prompt_file: docs/sprite-production/prompts/current/characters/character_dj_calculus.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_dj_calculus__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_dj_calculus/assist_4c_2r.png`
...
| Runtime intent | `current:character_dj_calculus:assist` |
| Atlas family | `assets/sprites/characters/dj_calculus.png` |
...
Render job: character_dj_calculus__assist
