...
job_id: character_dj_calculus__react
animation_state: react
animation_class: presentation
runtime_clip: current:character_dj_calculus:react
...
output_image: renders/character_dj_calculus/react_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_dj_calculus__react`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_dj_calculus/react_4c_1r.png`
...
| Runtime intent | `current:character_dj_calculus:react` |
...
Render job: character_dj_calculus__react
