...
job_id: character_naya_root__idle
animation_state: idle
animation_class: presentation
runtime_clip: current:character_naya_root:idle
...
output_image: renders/character_naya_root/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_naya_root__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_naya_root/idle_4c_1r.png`
...
| Runtime intent | `current:character_naya_root:idle` |
...
Render job: character_naya_root__idle
