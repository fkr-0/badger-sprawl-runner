...
job_id: character_naya_root__react
animation_state: react
animation_class: presentation
runtime_clip: current:character_naya_root:react
...
output_image: renders/character_naya_root/react_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_naya_root__react`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_naya_root/react_4c_1r.png`
...
| Runtime intent | `current:character_naya_root:react` |
...
Render job: character_naya_root__react
