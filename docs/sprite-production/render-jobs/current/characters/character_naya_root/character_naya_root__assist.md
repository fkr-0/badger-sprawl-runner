...
scope: current
category: characters
source_entry: character_naya_root
job_id: character_naya_root__assist
animation_state: assist
animation_class: interaction
runtime_clip: current:character_naya_root:assist
source_class: current_manifest
atlas_family: assets/sprites/characters/naya_root.png
target_atlas: assets/sprites/characters/naya_root.png
output_image: renders/character_naya_root/assist_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: dub_colony
source_prompt_file: docs/sprite-production/prompts/current/characters/character_naya_root.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_naya_root__assist`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_naya_root/assist_4c_2r.png`
...
| Runtime intent | `current:character_naya_root:assist` |
| Atlas family | `assets/sprites/characters/naya_root.png` |
...
Render job: character_naya_root__assist
