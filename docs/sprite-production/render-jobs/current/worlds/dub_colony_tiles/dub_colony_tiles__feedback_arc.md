...
job_id: dub_colony_tiles__feedback_arc
animation_state: feedback_arc
animation_class: hazard_tile
runtime_clip: current:dub_colony_tiles:feedback_arc
...
output_image: renders/dub_colony_tiles/feedback_arc_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `dub_colony_tiles__feedback_arc`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_tiles/feedback_arc_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `feedback_arc` |
| Animation class | `hazard_tile` |
| Runtime intent | `current:dub_colony_tiles:feedback_arc` |
...
Render job: dub_colony_tiles__feedback_arc
...
Runtime tags: world:dub_colony, tile, hazard, animated_prop.
Frames: 4. 
