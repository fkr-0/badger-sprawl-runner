...
job_id: dub_colony_tiles__woofer_pulse
animation_state: woofer_pulse
animation_class: environment_tile
runtime_clip: current:dub_colony_tiles:woofer_pulse
...
output_image: renders/dub_colony_tiles/woofer_pulse_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `dub_colony_tiles__woofer_pulse`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_tiles/woofer_pulse_4c_1r.png`
...
| Runtime intent | `current:dub_colony_tiles:woofer_pulse` |
...
Render job: dub_colony_tiles__woofer_pulse
