...
job_id: dub_colony_tiles__speakerstone_paver
animation_state: speakerstone_paver
animation_class: environment_tile
runtime_clip: current:dub_colony_tiles:speakerstone_paver
...
output_image: renders/dub_colony_tiles/speakerstone_paver_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `dub_colony_tiles__speakerstone_paver`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_tiles/speakerstone_paver_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `speakerstone_paver` |
| Animation class | `environment_tile` |
| Runtime intent | `current:dub_colony_tiles:speakerstone_paver` |
...
Render job: dub_colony_tiles__speakerstone_paver
...
Tile or prop: Speakerstone Paver.
Existing visual cue: cyber-organic speakerstone, cable vines, solar cloth, studio machinery.
Runtime tags: world:dub_colony, tile, solid, collision_safe, material:rubberized_stone.
Frames: 1. 
