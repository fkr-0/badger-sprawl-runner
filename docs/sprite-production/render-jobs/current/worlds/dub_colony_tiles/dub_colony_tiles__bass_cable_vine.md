...
job_id: dub_colony_tiles__bass_cable_vine
animation_state: bass_cable_vine
animation_class: environment_tile
runtime_clip: current:dub_colony_tiles:bass_cable_vine
...
output_image: renders/dub_colony_tiles/bass_cable_vine_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `dub_colony_tiles__bass_cable_vine`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_tiles/bass_cable_vine_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `bass_cable_vine` |
| Animation class | `environment_tile` |
| Runtime intent | `current:dub_colony_tiles:bass_cable_vine` |
...
Render job: dub_colony_tiles__bass_cable_vine
