...
job_id: dub_colony_tiles__studio_rack
animation_state: studio_rack
animation_class: environment_tile
runtime_clip: current:dub_colony_tiles:studio_rack
...
output_image: renders/dub_colony_tiles/studio_rack_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `dub_colony_tiles__studio_rack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_tiles/studio_rack_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `studio_rack` |
| Animation class | `environment_tile` |
| Runtime intent | `current:dub_colony_tiles:studio_rack` |
...
Render job: dub_colony_tiles__studio_rack
