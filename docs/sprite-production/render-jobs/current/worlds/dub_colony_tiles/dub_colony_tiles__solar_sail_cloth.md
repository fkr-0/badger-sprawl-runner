...
job_id: dub_colony_tiles__solar_sail_cloth
animation_state: solar_sail_cloth
animation_class: environment_tile
runtime_clip: current:dub_colony_tiles:solar_sail_cloth
...
output_image: renders/dub_colony_tiles/solar_sail_cloth_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `dub_colony_tiles__solar_sail_cloth`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_tiles/solar_sail_cloth_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `solar_sail_cloth` |
| Animation class | `environment_tile` |
| Runtime intent | `current:dub_colony_tiles:solar_sail_cloth` |
...
Render job: dub_colony_tiles__solar_sail_cloth
...
Tile or prop: Solar Sail Cloth.
Existing visual cue: cyber-organic speakerstone, cable vines, solar cloth, studio machinery.
Runtime tags: world:dub_colony, tile, decorative, material:canvas.
Frames: 1. 
