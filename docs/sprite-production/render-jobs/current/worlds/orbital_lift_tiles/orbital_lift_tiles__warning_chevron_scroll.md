...
job_id: orbital_lift_tiles__warning_chevron_scroll
animation_state: warning_chevron_scroll
animation_class: environment_tile
runtime_clip: current:orbital_lift_tiles:warning_chevron_scroll
...
output_image: renders/orbital_lift_tiles/warning_chevron_scroll_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `orbital_lift_tiles__warning_chevron_scroll`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_tiles/warning_chevron_scroll_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `warning_chevron_scroll` |
| Animation class | `environment_tile` |
| Runtime intent | `current:orbital_lift_tiles:warning_chevron_scroll` |
...
Render job: orbital_lift_tiles__warning_chevron_scroll
...
Tile or prop: Warning Chevron Scroll.
Existing visual cue: industrial lift grating, cargo straps, vacuum doors, warning machinery.
Runtime tags: world:orbital_lift, tile, animated_prop, decorative.
Frames: 4. 
