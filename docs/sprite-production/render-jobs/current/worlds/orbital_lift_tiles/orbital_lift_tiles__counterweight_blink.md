...
job_id: orbital_lift_tiles__counterweight_blink
animation_state: counterweight_blink
animation_class: environment_tile
runtime_clip: current:orbital_lift_tiles:counterweight_blink
...
output_image: renders/orbital_lift_tiles/counterweight_blink_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `orbital_lift_tiles__counterweight_blink`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_tiles/counterweight_blink_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `counterweight_blink` |
| Animation class | `environment_tile` |
| Runtime intent | `current:orbital_lift_tiles:counterweight_blink` |
...
Render job: orbital_lift_tiles__counterweight_blink
...
Tile or prop: Counterweight Blink.
