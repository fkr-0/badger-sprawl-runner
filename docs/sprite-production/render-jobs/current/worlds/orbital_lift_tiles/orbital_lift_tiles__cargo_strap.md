...
job_id: orbital_lift_tiles__cargo_strap
animation_state: cargo_strap
animation_class: environment_tile
runtime_clip: current:orbital_lift_tiles:cargo_strap
...
output_image: renders/orbital_lift_tiles/cargo_strap_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `orbital_lift_tiles__cargo_strap`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_tiles/cargo_strap_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `cargo_strap` |
| Animation class | `environment_tile` |
| Runtime intent | `current:orbital_lift_tiles:cargo_strap` |
...
Render job: orbital_lift_tiles__cargo_strap
...
Tile or prop: Cargo Strap.
Existing visual cue: industrial lift grating, cargo straps, vacuum doors, warning machinery.
Runtime tags: world:orbital_lift, tile, solid, collision_safe, material:woven_nylon.
Frames: 1. 
