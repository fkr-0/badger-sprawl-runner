...
job_id: orbital_lift_tiles__vacuum_door
animation_state: vacuum_door
animation_class: environment_tile
runtime_clip: current:orbital_lift_tiles:vacuum_door
...
output_image: renders/orbital_lift_tiles/vacuum_door_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `orbital_lift_tiles__vacuum_door`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_tiles/vacuum_door_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `vacuum_door` |
| Animation class | `environment_tile` |
| Runtime intent | `current:orbital_lift_tiles:vacuum_door` |
...
Render job: orbital_lift_tiles__vacuum_door
...
Tile or prop: Vacuum Door.
Existing visual cue: industrial lift grating, cargo straps, vacuum doors, warning machinery.
Runtime tags: world:orbital_lift, tile, decorative, material:sealed_metal.
Frames: 1. 
