...
job_id: orbital_lift_tiles__vacuum_leak_jet
animation_state: vacuum_leak_jet
animation_class: hazard_tile
runtime_clip: current:orbital_lift_tiles:vacuum_leak_jet
...
output_image: renders/orbital_lift_tiles/vacuum_leak_jet_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `orbital_lift_tiles__vacuum_leak_jet`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_tiles/vacuum_leak_jet_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `vacuum_leak_jet` |
| Animation class | `hazard_tile` |
| Runtime intent | `current:orbital_lift_tiles:vacuum_leak_jet` |
...
Render job: orbital_lift_tiles__vacuum_leak_jet
