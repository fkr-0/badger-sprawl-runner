...
job_id: orbital_lift_tiles__lift_grating
animation_state: lift_grating
animation_class: environment_tile
runtime_clip: current:orbital_lift_tiles:lift_grating
...
output_image: renders/orbital_lift_tiles/lift_grating_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `orbital_lift_tiles__lift_grating`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_tiles/lift_grating_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `lift_grating` |
| Animation class | `environment_tile` |
| Runtime intent | `current:orbital_lift_tiles:lift_grating` |
...
Render job: orbital_lift_tiles__lift_grating
...
Tile or prop: Lift Grating.
Existing visual cue: industrial lift grating, cargo straps, vacuum doors, warning machinery.
Runtime tags: world:orbital_lift, tile, solid, collision_safe, material:industrial_alloy.
Frames: 1. 
