...
scope: current
category: worlds
source_entry: straylight_mirage_parallax
job_id: straylight_mirage_parallax__mid_plate
animation_state: mid_plate
animation_class: environment_plate
runtime_clip: current:straylight_mirage_parallax:mid_plate
source_class: current_manifest
atlas_family: assets/sprites/worlds/straylight_mirage_parallax.png
target_atlas: assets/sprites/worlds/straylight_mirage_parallax.png
output_image: renders/straylight_mirage_parallax/mid_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
source_prompt_file: docs/sprite-production/prompts/current/worlds/straylight_mirage_parallax.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `straylight_mirage_parallax__mid_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_parallax/mid_plate_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `mid_plate` |
| Animation class | `environment_plate` |
| Runtime intent | `current:straylight_mirage_parallax:mid_plate` |
| Atlas family | `assets/sprites/worlds/straylight_mirage_parallax.png` |
...
Render job: straylight_mirage_parallax__mid_plate
...
Layer: mid_plate; mid-distance architecture and landmarks, medium contrast.
Existing visual cue: ethereal mirror palace, deep purple cosmos, floating chandeliers.
