...
scope: current
category: worlds
source_entry: chrome_arcology_parallax
job_id: chrome_arcology_parallax__mid_plate
animation_state: mid_plate
animation_class: environment_plate
runtime_clip: current:chrome_arcology_parallax:mid_plate
source_class: current_manifest
atlas_family: assets/sprites/worlds/chrome_arcology_parallax.png
target_atlas: assets/sprites/worlds/chrome_arcology_parallax.png
output_image: renders/chrome_arcology_parallax/mid_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
source_prompt_file: docs/sprite-production/prompts/current/worlds/chrome_arcology_parallax.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `chrome_arcology_parallax__mid_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_parallax/mid_plate_1c_1r.png`
...
| Runtime intent | `current:chrome_arcology_parallax:mid_plate` |
| Atlas family | `assets/sprites/worlds/chrome_arcology_parallax.png` |
...
Render job: chrome_arcology_parallax__mid_plate
...
Existing visual cue: sterile luxury interior, glass ceiling, elevator shafts, chrome pillars.
