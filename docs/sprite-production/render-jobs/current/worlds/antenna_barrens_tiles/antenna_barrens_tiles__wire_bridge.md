...
job_id: antenna_barrens_tiles__wire_bridge
animation_state: wire_bridge
animation_class: environment_tile
runtime_clip: current:antenna_barrens_tiles:wire_bridge
...
output_image: renders/antenna_barrens_tiles/wire_bridge_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `antenna_barrens_tiles__wire_bridge`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/antenna_barrens_tiles/wire_bridge_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `wire_bridge` |
| Animation class | `environment_tile` |
| Runtime intent | `current:antenna_barrens_tiles:wire_bridge` |
...
Render job: antenna_barrens_tiles__wire_bridge
...
Runtime tags: world:antenna_barrens, tile, solid, collision_safe, material:steel_cable.
Frames: 1. 
