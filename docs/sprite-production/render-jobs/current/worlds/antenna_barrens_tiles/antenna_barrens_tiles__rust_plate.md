...
job_id: antenna_barrens_tiles__rust_plate
animation_state: rust_plate
animation_class: environment_plate
runtime_clip: current:antenna_barrens_tiles:rust_plate
...
output_image: renders/antenna_barrens_tiles/rust_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `antenna_barrens_tiles__rust_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/antenna_barrens_tiles/rust_plate_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `rust_plate` |
| Animation class | `environment_plate` |
| Runtime intent | `current:antenna_barrens_tiles:rust_plate` |
...
Render job: antenna_barrens_tiles__rust_plate
...
Tile or prop: Rust Plate.
Existing visual cue: Antenna Barrens Tiles.
Runtime tags: world:antenna_barrens, tile, solid, collision_safe, material:rusted_metal.
Frames: 1. 
