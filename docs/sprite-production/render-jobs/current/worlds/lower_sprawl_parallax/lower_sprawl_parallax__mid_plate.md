...
scope: current
category: worlds
source_entry: lower_sprawl_parallax
job_id: lower_sprawl_parallax__mid_plate
animation_state: mid_plate
animation_class: environment_plate
runtime_clip: current:lower_sprawl_parallax:mid_plate
source_class: current_manifest
atlas_family: assets/sprites/worlds/lower_sprawl_parallax.png
target_atlas: assets/sprites/worlds/lower_sprawl_parallax.png
output_image: renders/lower_sprawl_parallax/mid_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
- 180
world: lower_sprawl
source_prompt_file: docs/sprite-production/prompts/current/worlds/lower_sprawl_parallax.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `lower_sprawl_parallax__mid_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_parallax/mid_plate_1c_1r.png`
...
| Runtime intent | `current:lower_sprawl_parallax:mid_plate` |
| Atlas family | `assets/sprites/worlds/lower_sprawl_parallax.png` |
...
Render job: lower_sprawl_parallax__mid_plate
...
Existing visual cue: dusk urban skyline, deep indigo, neon light pollution, water towers.
