...
job_id: chrome_arcology_tiles__glass_lattice
animation_state: glass_lattice
animation_class: environment_tile
runtime_clip: current:chrome_arcology_tiles:glass_lattice
...
output_image: renders/chrome_arcology_tiles/glass_lattice_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `chrome_arcology_tiles__glass_lattice`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_tiles/glass_lattice_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `glass_lattice` |
| Animation class | `environment_tile` |
| Runtime intent | `current:chrome_arcology_tiles:glass_lattice` |
...
Render job: chrome_arcology_tiles__glass_lattice
