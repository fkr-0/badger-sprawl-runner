...
job_id: chrome_arcology_tiles__holo_ad_flicker
animation_state: holo_ad_flicker
animation_class: environment_tile
runtime_clip: current:chrome_arcology_tiles:holo_ad_flicker
...
output_image: renders/chrome_arcology_tiles/holo_ad_flicker_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `chrome_arcology_tiles__holo_ad_flicker`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_tiles/holo_ad_flicker_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `holo_ad_flicker` |
| Animation class | `environment_tile` |
| Runtime intent | `current:chrome_arcology_tiles:holo_ad_flicker` |
...
Render job: chrome_arcology_tiles__holo_ad_flicker
...
Tile or prop: Holo Ad Flicker.
Existing visual cue: polished chrome floors, glass lattice, elevator rails, luxury ad panels.
Runtime tags: world:chrome_arcology, tile, animated_prop, decorative.
Frames: 4. 
