...
job_id: chrome_arcology_tiles__security_gate
animation_state: security_gate
animation_class: interactive_tile
runtime_clip: current:chrome_arcology_tiles:security_gate
...
output_image: renders/chrome_arcology_tiles/security_gate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `chrome_arcology_tiles__security_gate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_tiles/security_gate_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `security_gate` |
| Animation class | `interactive_tile` |
| Runtime intent | `current:chrome_arcology_tiles:security_gate` |
...
Render job: chrome_arcology_tiles__security_gate
...
Tile or prop: Security Gate.
Existing visual cue: polished chrome floors, glass lattice, elevator rails, luxury ad panels.
Runtime tags: world:chrome_arcology, tile, decorative, material:laser_grid.
Frames: 1. 
