...
job_id: chrome_arcology_tiles__laser_floor_warning
animation_state: laser_floor_warning
animation_class: hazard_tile
runtime_clip: current:chrome_arcology_tiles:laser_floor_warning
...
output_image: renders/chrome_arcology_tiles/laser_floor_warning_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `chrome_arcology_tiles__laser_floor_warning`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_tiles/laser_floor_warning_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `laser_floor_warning` |
| Animation class | `hazard_tile` |
| Runtime intent | `current:chrome_arcology_tiles:laser_floor_warning` |
...
Render job: chrome_arcology_tiles__laser_floor_warning
...
Tile or prop: Laser Floor Warning.
Existing visual cue: polished chrome floors, glass lattice, elevator rails, luxury ad panels.
Runtime tags: world:chrome_arcology, tile, hazard, animated_prop.
Frames: 4. 
