...
job_id: chrome_arcology_tiles__chrome_floor
animation_state: chrome_floor
animation_class: environment_tile
runtime_clip: current:chrome_arcology_tiles:chrome_floor
...
output_image: renders/chrome_arcology_tiles/chrome_floor_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `chrome_arcology_tiles__chrome_floor`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_tiles/chrome_floor_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `chrome_floor` |
| Animation class | `environment_tile` |
| Runtime intent | `current:chrome_arcology_tiles:chrome_floor` |
...
Render job: chrome_arcology_tiles__chrome_floor
...
Tile or prop: Chrome Floor.
Existing visual cue: polished chrome floors, glass lattice, elevator rails, luxury ad panels.
Runtime tags: world:chrome_arcology, tile, solid, collision_safe, material:polished_chrome.
Frames: 1. 
