...
job_id: chrome_arcology_tiles__ad_panel_loop
animation_state: ad_panel_loop
animation_class: environment_tile
runtime_clip: current:chrome_arcology_tiles:ad_panel_loop
...
output_image: renders/chrome_arcology_tiles/ad_panel_loop_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `chrome_arcology_tiles__ad_panel_loop`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_tiles/ad_panel_loop_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `ad_panel_loop` |
| Animation class | `environment_tile` |
| Runtime intent | `current:chrome_arcology_tiles:ad_panel_loop` |
...
Render job: chrome_arcology_tiles__ad_panel_loop
