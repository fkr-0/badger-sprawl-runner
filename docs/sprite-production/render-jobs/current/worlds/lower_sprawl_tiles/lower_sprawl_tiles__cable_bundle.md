...
job_id: lower_sprawl_tiles__cable_bundle
animation_state: cable_bundle
animation_class: environment_tile
runtime_clip: current:lower_sprawl_tiles:cable_bundle
...
output_image: renders/lower_sprawl_tiles/cable_bundle_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `lower_sprawl_tiles__cable_bundle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_tiles/cable_bundle_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `cable_bundle` |
| Animation class | `environment_tile` |
| Runtime intent | `current:lower_sprawl_tiles:cable_bundle` |
...
Render job: lower_sprawl_tiles__cable_bundle
