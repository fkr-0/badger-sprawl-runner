...
job_id: lower_sprawl_tiles__brick_tile
animation_state: brick_tile
animation_class: environment_tile
runtime_clip: current:lower_sprawl_tiles:brick_tile
...
output_image: renders/lower_sprawl_tiles/brick_tile_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `lower_sprawl_tiles__brick_tile`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_tiles/brick_tile_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `brick_tile` |
| Animation class | `environment_tile` |
| Runtime intent | `current:lower_sprawl_tiles:brick_tile` |
...
Render job: lower_sprawl_tiles__brick_tile
...
Tile or prop: Brick Tile.
Existing visual cue: cyberpunk urban brick, wet asphalt, cables, awnings, neon street props.
Runtime tags: collision_safe, material:brick, solid, tile, world:lower_sprawl.
Frames: 1. 
