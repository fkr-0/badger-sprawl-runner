...
job_id: lower_sprawl_tiles__neon_sign
animation_state: neon_sign
animation_class: environment_tile
runtime_clip: current:lower_sprawl_tiles:neon_sign
...
output_image: renders/lower_sprawl_tiles/neon_sign_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `lower_sprawl_tiles__neon_sign`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_tiles/neon_sign_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `neon_sign` |
| Animation class | `environment_tile` |
| Runtime intent | `current:lower_sprawl_tiles:neon_sign` |
...
Render job: lower_sprawl_tiles__neon_sign
...
Tile or prop: Neon Sign.
Existing visual cue: cyberpunk urban brick, wet asphalt, cables, awnings, neon street props.
Runtime tags: animated_prop, decorative, material:neon, tile, world:lower_sprawl.
Frames: 4. 
