...
job_id: drainmarket_parallax__mid_plate
animation_state: mid_plate
animation_class: environment_plate
runtime_clip: current:drainmarket_parallax:mid_plate
...
output_image: renders/drainmarket_parallax/mid_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `drainmarket_parallax__mid_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_parallax/mid_plate_1c_1r.png`
...
| Runtime intent | `current:drainmarket_parallax:mid_plate` |
...
Render job: drainmarket_parallax__mid_plate
