...
job_id: straylight_mirage_tiles__mirror_floor
animation_state: mirror_floor
animation_class: environment_tile
runtime_clip: current:straylight_mirage_tiles:mirror_floor
...
output_image: renders/straylight_mirage_tiles/mirror_floor_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `straylight_mirage_tiles__mirror_floor`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_tiles/mirror_floor_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `mirror_floor` |
| Animation class | `environment_tile` |
| Runtime intent | `current:straylight_mirage_tiles:mirror_floor` |
...
Render job: straylight_mirage_tiles__mirror_floor
...
Tile or prop: Mirror Floor.
Existing visual cue: Straylight Mirage Tiles.
Runtime tags: world:straylight_mirage, tile, solid, collision_safe, material:hardlight_glass.
Frames: 1. 
