...
job_id: straylight_mirage_tiles__lightblade_tripline
animation_state: lightblade_tripline
animation_class: hazard_tile
runtime_clip: current:straylight_mirage_tiles:lightblade_tripline
...
output_image: renders/straylight_mirage_tiles/lightblade_tripline_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `straylight_mirage_tiles__lightblade_tripline`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_tiles/lightblade_tripline_4c_1r.png`
...
| Runtime intent | `current:straylight_mirage_tiles:lightblade_tripline` |
...
Render job: straylight_mirage_tiles__lightblade_tripline
...
Runtime tags: world:straylight_mirage, tile, hazard, animated_prop.
Frames: 4. 
