...
job_id: straylight_mirage_tiles__false_door_glitch
animation_state: false_door_glitch
animation_class: environment_tile
runtime_clip: current:straylight_mirage_tiles:false_door_glitch
...
output_image: renders/straylight_mirage_tiles/false_door_glitch_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `straylight_mirage_tiles__false_door_glitch`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_tiles/false_door_glitch_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `false_door_glitch` |
| Animation class | `environment_tile` |
| Runtime intent | `current:straylight_mirage_tiles:false_door_glitch` |
...
Render job: straylight_mirage_tiles__false_door_glitch
...
Tile or prop: False Door Glitch.
Existing visual cue: Straylight Mirage Tiles.
Runtime tags: world:straylight_mirage, tile, animated_prop, decorative.
Frames: 4. 
