...
job_id: straylight_mirage_tiles__mirror_shard
animation_state: mirror_shard
animation_class: environment_tile
runtime_clip: current:straylight_mirage_tiles:mirror_shard
...
output_image: renders/straylight_mirage_tiles/mirror_shard_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `straylight_mirage_tiles__mirror_shard`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_tiles/mirror_shard_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `mirror_shard` |
| Animation class | `environment_tile` |
| Runtime intent | `current:straylight_mirage_tiles:mirror_shard` |
...
Render job: straylight_mirage_tiles__mirror_shard
...
Tile or prop: Mirror Shard.
Existing visual cue: Straylight Mirage Tiles.
Runtime tags: world:straylight_mirage, tile, decorative, material:mirror_glass.
Frames: 1. 
