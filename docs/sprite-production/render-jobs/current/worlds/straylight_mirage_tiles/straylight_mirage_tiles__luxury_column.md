...
job_id: straylight_mirage_tiles__luxury_column
animation_state: luxury_column
animation_class: environment_tile
runtime_clip: current:straylight_mirage_tiles:luxury_column
...
output_image: renders/straylight_mirage_tiles/luxury_column_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `straylight_mirage_tiles__luxury_column`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_tiles/luxury_column_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `luxury_column` |
| Animation class | `environment_tile` |
| Runtime intent | `current:straylight_mirage_tiles:luxury_column` |
...
Render job: straylight_mirage_tiles__luxury_column
...
Tile or prop: Luxury Column.
Existing visual cue: Straylight Mirage Tiles.
Runtime tags: world:straylight_mirage, tile, solid, collision_safe, material:marble.
Frames: 1. 
