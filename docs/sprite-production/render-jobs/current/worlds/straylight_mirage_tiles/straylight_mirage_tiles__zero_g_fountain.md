...
job_id: straylight_mirage_tiles__zero_g_fountain
animation_state: zero_g_fountain
animation_class: environment_tile
runtime_clip: current:straylight_mirage_tiles:zero_g_fountain
...
output_image: renders/straylight_mirage_tiles/zero_g_fountain_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `straylight_mirage_tiles__zero_g_fountain`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_tiles/zero_g_fountain_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `zero_g_fountain` |
| Animation class | `environment_tile` |
| Runtime intent | `current:straylight_mirage_tiles:zero_g_fountain` |
...
Render job: straylight_mirage_tiles__zero_g_fountain
