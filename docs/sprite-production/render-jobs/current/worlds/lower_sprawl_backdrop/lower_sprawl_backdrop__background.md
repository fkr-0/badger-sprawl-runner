...
scope: current
category: worlds
source_entry: lower_sprawl_backdrop
job_id: lower_sprawl_backdrop__background
animation_state: background
animation_class: environment_plate
runtime_clip: current:lower_sprawl_backdrop:background
source_class: current_manifest
atlas_family: assets/sprites/worlds/lower_sprawl_backdrop.png
target_atlas: assets/sprites/worlds/lower_sprawl_backdrop.png
output_image: renders/lower_sprawl_backdrop/background_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
- 540
world: lower_sprawl
source_prompt_file: docs/sprite-production/prompts/current/worlds/lower_sprawl_backdrop.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `lower_sprawl_backdrop__background`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_backdrop/background_1c_1r.png`
- Grid: 1 columns × 1 rows
- Cell size: 960×540 pixels
- Output size: 960×540 pixels
- Occupied frames: 1
...
| Runtime intent | `current:lower_sprawl_backdrop:background` |
| Atlas family | `assets/sprites/worlds/lower_sprawl_backdrop.png` |
