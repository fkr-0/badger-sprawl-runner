...
job_id: drainmarket_tiles__sump_brick
animation_state: sump_brick
animation_class: environment_tile
runtime_clip: current:drainmarket_tiles:sump_brick
...
output_image: renders/drainmarket_tiles/sump_brick_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `drainmarket_tiles__sump_brick`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_tiles/sump_brick_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `sump_brick` |
| Animation class | `environment_tile` |
| Runtime intent | `current:drainmarket_tiles:sump_brick` |
...
Render job: drainmarket_tiles__sump_brick
...
Tile or prop: Sump Brick.
Existing visual cue: sump brick, clinic floor, rusted grates, medical tubing, leaking valves.
Runtime tags: collision_safe, material:sump_brick, solid, tile, world:drainmarket.
Frames: 1. 
