...
job_id: drainmarket_tiles__medicine_sign
animation_state: medicine_sign
animation_class: environment_tile
runtime_clip: current:drainmarket_tiles:medicine_sign
...
output_image: renders/drainmarket_tiles/medicine_sign_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `drainmarket_tiles__medicine_sign`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_tiles/medicine_sign_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `medicine_sign` |
| Animation class | `environment_tile` |
| Runtime intent | `current:drainmarket_tiles:medicine_sign` |
...
Render job: drainmarket_tiles__medicine_sign
...
Tile or prop: Medicine Sign.
Existing visual cue: sump brick, clinic floor, rusted grates, medical tubing, leaking valves.
Runtime tags: animated_prop, decorative, material:neon, tile, world:drainmarket.
Frames: 4. 
