...
job_id: drainmarket_tiles__hanging_tubes
animation_state: hanging_tubes
animation_class: environment_tile
runtime_clip: current:drainmarket_tiles:hanging_tubes
...
output_image: renders/drainmarket_tiles/hanging_tubes_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `drainmarket_tiles__hanging_tubes`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_tiles/hanging_tubes_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `hanging_tubes` |
| Animation class | `environment_tile` |
| Runtime intent | `current:drainmarket_tiles:hanging_tubes` |
...
Render job: drainmarket_tiles__hanging_tubes
...
Tile or prop: Hanging Tubes.
Existing visual cue: sump brick, clinic floor, rusted grates, medical tubing, leaking valves.
Runtime tags: decorative, material:medical_tubing, tile, world:drainmarket.
Frames: 1. 
