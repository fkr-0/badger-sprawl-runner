...
job_id: drainmarket_tiles__leaking_valve
animation_state: leaking_valve
animation_class: hazard_tile
runtime_clip: current:drainmarket_tiles:leaking_valve
...
output_image: renders/drainmarket_tiles/leaking_valve_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `drainmarket_tiles__leaking_valve`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_tiles/leaking_valve_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `leaking_valve` |
| Animation class | `hazard_tile` |
| Runtime intent | `current:drainmarket_tiles:leaking_valve` |
...
Render job: drainmarket_tiles__leaking_valve
...
Tile or prop: Leaking Valve.
Existing visual cue: sump brick, clinic floor, rusted grates, medical tubing, leaking valves.
Runtime tags: animated_prop, hazard, material:chemical_leak, tile, world:drainmarket.
Frames: 4. 
