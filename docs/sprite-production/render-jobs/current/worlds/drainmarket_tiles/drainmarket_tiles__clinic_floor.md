...
job_id: drainmarket_tiles__clinic_floor
animation_state: clinic_floor
animation_class: environment_tile
runtime_clip: current:drainmarket_tiles:clinic_floor
...
output_image: renders/drainmarket_tiles/clinic_floor_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `drainmarket_tiles__clinic_floor`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_tiles/clinic_floor_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `clinic_floor` |
| Animation class | `environment_tile` |
| Runtime intent | `current:drainmarket_tiles:clinic_floor` |
...
Render job: drainmarket_tiles__clinic_floor
...
Tile or prop: Clinic Floor.
Existing visual cue: sump brick, clinic floor, rusted grates, medical tubing, leaking valves.
Runtime tags: collision_safe, material:wet_clinic_tile, solid, tile, world:drainmarket.
Frames: 1. 
