...
job_id: asteroid_redoubt_parallax__back_plate
animation_state: back_plate
animation_class: environment_plate
runtime_clip: current:asteroid_redoubt_parallax:back_plate
...
output_image: renders/asteroid_redoubt_parallax/back_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `asteroid_redoubt_parallax__back_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_parallax/back_plate_1c_1r.png`
...
| Runtime intent | `current:asteroid_redoubt_parallax:back_plate` |
...
Render job: asteroid_redoubt_parallax__back_plate
