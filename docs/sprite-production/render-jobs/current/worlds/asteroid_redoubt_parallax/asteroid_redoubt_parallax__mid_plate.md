...
scope: current
category: worlds
source_entry: asteroid_redoubt_parallax
job_id: asteroid_redoubt_parallax__mid_plate
animation_state: mid_plate
animation_class: environment_plate
runtime_clip: current:asteroid_redoubt_parallax:mid_plate
source_class: current_manifest
atlas_family: assets/sprites/worlds/asteroid_redoubt_parallax.png
target_atlas: assets/sprites/worlds/asteroid_redoubt_parallax.png
output_image: renders/asteroid_redoubt_parallax/mid_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
source_prompt_file: docs/sprite-production/prompts/current/worlds/asteroid_redoubt_parallax.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `asteroid_redoubt_parallax__mid_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_parallax/mid_plate_1c_1r.png`
...
| Runtime intent | `current:asteroid_redoubt_parallax:mid_plate` |
| Atlas family | `assets/sprites/worlds/asteroid_redoubt_parallax.png` |
...
Render job: asteroid_redoubt_parallax__mid_plate
...
Existing visual cue: Rebel outpost on an asteroid.
