...
job_id: orbital_lift_parallax__front_plate
animation_state: front_plate
animation_class: environment_plate
runtime_clip: current:orbital_lift_parallax:front_plate
...
output_image: renders/orbital_lift_parallax/front_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `orbital_lift_parallax__front_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_parallax/front_plate_1c_1r.png`
...
| Runtime intent | `current:orbital_lift_parallax:front_plate` |
...
Render job: orbital_lift_parallax__front_plate
