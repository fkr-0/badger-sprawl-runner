...
scope: current
category: worlds
source_entry: antenna_barrens_parallax
job_id: antenna_barrens_parallax__mid_plate
animation_state: mid_plate
animation_class: environment_plate
runtime_clip: current:antenna_barrens_parallax:mid_plate
source_class: current_manifest
atlas_family: assets/sprites/worlds/antenna_barrens_parallax.png
target_atlas: assets/sprites/worlds/antenna_barrens_parallax.png
output_image: renders/antenna_barrens_parallax/mid_plate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
source_prompt_file: docs/sprite-production/prompts/current/worlds/antenna_barrens_parallax.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `antenna_barrens_parallax__mid_plate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/antenna_barrens_parallax/mid_plate_1c_1r.png`
...
| Runtime intent | `current:antenna_barrens_parallax:mid_plate` |
| Atlas family | `assets/sprites/worlds/antenna_barrens_parallax.png` |
...
Render job: antenna_barrens_parallax__mid_plate
...
Existing visual cue: Antenna Barrens Parallax.
