...
job_id: asteroid_redoubt_tiles__cargo_crate
animation_state: cargo_crate
animation_class: environment_tile
runtime_clip: current:asteroid_redoubt_tiles:cargo_crate
...
output_image: renders/asteroid_redoubt_tiles/cargo_crate_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `asteroid_redoubt_tiles__cargo_crate`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_tiles/cargo_crate_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `cargo_crate` |
| Animation class | `environment_tile` |
| Runtime intent | `current:asteroid_redoubt_tiles:cargo_crate` |
...
Render job: asteroid_redoubt_tiles__cargo_crate
...
Tile or prop: Cargo Crate.
Existing visual cue: Asteroid Redoubt Tiles.
Runtime tags: world:asteroid_redoubt, tile, solid, collision_safe, material:reinforced_plastic.
Frames: 1. 
