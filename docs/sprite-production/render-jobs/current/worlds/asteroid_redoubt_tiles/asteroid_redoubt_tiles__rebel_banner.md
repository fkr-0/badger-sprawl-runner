...
job_id: asteroid_redoubt_tiles__rebel_banner
animation_state: rebel_banner
animation_class: environment_tile
runtime_clip: current:asteroid_redoubt_tiles:rebel_banner
...
output_image: renders/asteroid_redoubt_tiles/rebel_banner_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `asteroid_redoubt_tiles__rebel_banner`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_tiles/rebel_banner_1c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `rebel_banner` |
| Animation class | `environment_tile` |
| Runtime intent | `current:asteroid_redoubt_tiles:rebel_banner` |
...
Render job: asteroid_redoubt_tiles__rebel_banner
...
Tile or prop: Rebel Banner.
Existing visual cue: Asteroid Redoubt Tiles.
Runtime tags: world:asteroid_redoubt, tile, decorative, material:cloth.
Frames: 1. 
