...
job_id: asteroid_redoubt_tiles__transmitter_dish_blink
animation_state: transmitter_dish_blink
animation_class: environment_tile
runtime_clip: current:asteroid_redoubt_tiles:transmitter_dish_blink
...
output_image: renders/asteroid_redoubt_tiles/transmitter_dish_blink_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `asteroid_redoubt_tiles__transmitter_dish_blink`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_tiles/transmitter_dish_blink_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `transmitter_dish_blink` |
| Animation class | `environment_tile` |
| Runtime intent | `current:asteroid_redoubt_tiles:transmitter_dish_blink` |
...
Render job: asteroid_redoubt_tiles__transmitter_dish_blink
...
Tile or prop: Transmitter Dish Blink.
