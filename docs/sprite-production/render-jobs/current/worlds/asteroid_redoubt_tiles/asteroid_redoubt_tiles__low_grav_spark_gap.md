...
job_id: asteroid_redoubt_tiles__low_grav_spark_gap
animation_state: low_grav_spark_gap
animation_class: environment_tile
runtime_clip: current:asteroid_redoubt_tiles:low_grav_spark_gap
...
output_image: renders/asteroid_redoubt_tiles/low_grav_spark_gap_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `asteroid_redoubt_tiles__low_grav_spark_gap`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_tiles/low_grav_spark_gap_4c_1r.png`
...
| Runtime intent | `current:asteroid_redoubt_tiles:low_grav_spark_gap` |
...
Render job: asteroid_redoubt_tiles__low_grav_spark_gap
...
Runtime tags: world:asteroid_redoubt, tile, hazard, animated_prop.
Frames: 4. 
