...
job_id: asteroid_redoubt_tiles__pirate_radio_shrine
animation_state: pirate_radio_shrine
animation_class: environment_tile
runtime_clip: current:asteroid_redoubt_tiles:pirate_radio_shrine
...
output_image: renders/asteroid_redoubt_tiles/pirate_radio_shrine_1c_1r.png
frames: 1
grid:
  columns: 1
  rows: 1
...
# `asteroid_redoubt_tiles__pirate_radio_shrine`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_tiles/pirate_radio_shrine_1c_1r.png`
...
| Runtime intent | `current:asteroid_redoubt_tiles:pirate_radio_shrine` |
...
Render job: asteroid_redoubt_tiles__pirate_radio_shrine
...
Runtime tags: world:asteroid_redoubt, tile, decorative.
Frames: 1. 
