...
job_id: asteroid_redoubt_tiles__transmitter_blink_loop
animation_state: transmitter_blink_loop
animation_class: environment_tile
runtime_clip: current:asteroid_redoubt_tiles:transmitter_blink_loop
...
output_image: renders/asteroid_redoubt_tiles/transmitter_blink_loop_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `asteroid_redoubt_tiles__transmitter_blink_loop`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_tiles/transmitter_blink_loop_4c_1r.png`
...
| Scope | `current` |
| Category | `worlds` |
| Animation state | `transmitter_blink_loop` |
| Animation class | `environment_tile` |
| Runtime intent | `current:asteroid_redoubt_tiles:transmitter_blink_loop` |
...
Render job: asteroid_redoubt_tiles__transmitter_blink_loop
...
Tile or prop: Transmitter Blink Loop.
Existing visual cue: Asteroid Redoubt Tiles.
Runtime tags: world:asteroid_redoubt, tile, animated_prop, decorative.
Frames: 4. 
