...
job_id: moss_remaining_animation_gaps__railgun_reload_failure
animation_state: railgun_reload_failure
animation_class: sprite_animation
runtime_clip: current:moss_remaining_animation_gaps:railgun_reload_failure
...
output_image: renders/moss_remaining_animation_gaps/railgun_reload_failure_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/current/misc/moss_remaining_animation_gaps.md
reference_images:
...
- Output image: `renders/moss_remaining_animation_gaps/railgun_reload_failure_4c_2r.png`
...
| Scope | `current` |
| Category | `misc` |
| Animation state | `railgun_reload_failure` |
| Animation class | `sprite_animation` |
| Runtime intent | `current:moss_remaining_animation_gaps:railgun_reload_failure` |
...
Asset identity: Moss Remaining Animation Gaps.
