...
job_id: moss_remaining_animation_gaps__railgun_charge
animation_state: railgun_charge
animation_class: sprite_animation
runtime_clip: current:moss_remaining_animation_gaps:railgun_charge
...
output_image: renders/moss_remaining_animation_gaps/railgun_charge_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__railgun_charge`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/railgun_charge_4c_2r.png`
...
| Scope | `current` |
| Category | `misc` |
| Animation state | `railgun_charge` |
| Animation class | `sprite_animation` |
| Runtime intent | `current:moss_remaining_animation_gaps:railgun_charge` |
