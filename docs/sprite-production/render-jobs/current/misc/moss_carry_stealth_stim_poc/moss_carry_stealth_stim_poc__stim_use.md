...
job_id: moss_carry_stealth_stim_poc__stim_use
animation_state: stim_use
animation_class: sprite_animation
runtime_clip: current:moss_carry_stealth_stim_poc:stim_use
...
output_image: renders/moss_carry_stealth_stim_poc/stim_use_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_carry_stealth_stim_poc__stim_use`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_carry_stealth_stim_poc/stim_use_4c_1r.png`
...
| Runtime intent | `current:moss_carry_stealth_stim_poc:stim_use` |
...
Render job: moss_carry_stealth_stim_poc__stim_use
