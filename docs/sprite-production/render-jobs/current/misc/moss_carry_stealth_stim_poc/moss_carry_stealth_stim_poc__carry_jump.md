...
job_id: moss_carry_stealth_stim_poc__carry_jump
animation_state: carry_jump
animation_class: locomotion
runtime_clip: current:moss_carry_stealth_stim_poc:carry_jump
...
output_image: renders/moss_carry_stealth_stim_poc/carry_jump_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_carry_stealth_stim_poc__carry_jump`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_carry_stealth_stim_poc/carry_jump_4c_1r.png`
...
| Runtime intent | `current:moss_carry_stealth_stim_poc:carry_jump` |
...
Render job: moss_carry_stealth_stim_poc__carry_jump
