...
job_id: moss_carry_stealth_stim_poc__stealth_enter
animation_state: stealth_enter
animation_class: sprite_animation
runtime_clip: current:moss_carry_stealth_stim_poc:stealth_enter
...
output_image: renders/moss_carry_stealth_stim_poc/stealth_enter_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_carry_stealth_stim_poc__stealth_enter`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_carry_stealth_stim_poc/stealth_enter_4c_1r.png`
...
| Runtime intent | `current:moss_carry_stealth_stim_poc:stealth_enter` |
...
Render job: moss_carry_stealth_stim_poc__stealth_enter
