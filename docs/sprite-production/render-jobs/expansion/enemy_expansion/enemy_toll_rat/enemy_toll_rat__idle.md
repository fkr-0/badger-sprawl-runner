...
job_id: enemy_toll_rat__idle
animation_state: idle
animation_class: presentation
runtime_clip: expansion:enemy_toll_rat:idle
...
output_image: renders/enemy_toll_rat/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_toll_rat__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_toll_rat/idle_4c_1r.png`
...
| Runtime intent | `expansion:enemy_toll_rat:idle` |
