...
job_id: enemy_angel_fragment__patrol_or_move
animation_state: patrol_or_move
animation_class: locomotion
runtime_clip: expansion:enemy_angel_fragment:patrol_or_move
...
output_image: renders/enemy_angel_fragment/patrol_or_move_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_angel_fragment__patrol_or_move`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_angel_fragment/patrol_or_move_4c_2r.png`
...
| Runtime intent | `expansion:enemy_angel_fragment:patrol_or_move` |
