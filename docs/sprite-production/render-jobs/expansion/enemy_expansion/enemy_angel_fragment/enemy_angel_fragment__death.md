...
job_id: enemy_angel_fragment__death
animation_state: death
animation_class: sprite_animation
runtime_clip: expansion:enemy_angel_fragment:death
...
output_image: renders/enemy_angel_fragment/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_angel_fragment__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_angel_fragment/death_4c_2r.png`
...
| Runtime intent | `expansion:enemy_angel_fragment:death` |
