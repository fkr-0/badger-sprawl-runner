...
job_id: enemy_debt_paladin__hurt
animation_state: hurt
animation_class: combat
runtime_clip: expansion:enemy_debt_paladin:hurt
...
output_image: renders/enemy_debt_paladin/hurt_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `enemy_debt_paladin__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_debt_paladin/hurt_2c_1r.png`
...
| Runtime intent | `expansion:enemy_debt_paladin:hurt` |
