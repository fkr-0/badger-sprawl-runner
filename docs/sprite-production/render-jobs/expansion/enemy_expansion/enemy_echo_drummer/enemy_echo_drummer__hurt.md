...
job_id: enemy_echo_drummer__hurt
animation_state: hurt
animation_class: combat
runtime_clip: expansion:enemy_echo_drummer:hurt
...
output_image: renders/enemy_echo_drummer/hurt_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `enemy_echo_drummer__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_echo_drummer/hurt_2c_1r.png`
...
| Runtime intent | `expansion:enemy_echo_drummer:hurt` |
