...
job_id: enemy_bailiff_scooter__idle
animation_state: idle
animation_class: presentation
runtime_clip: expansion:enemy_bailiff_scooter:idle
...
output_image: renders/enemy_bailiff_scooter/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_bailiff_scooter__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_bailiff_scooter/idle_4c_1r.png`
...
| Runtime intent | `expansion:enemy_bailiff_scooter:idle` |
