...
source_entry: enemy_bailiff_scooter
job_id: enemy_bailiff_scooter__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: expansion:enemy_bailiff_scooter:stun_or_parried
source_class: expansion_template
atlas_family: assets/sprites/enemies/bailiff_scooter.png
target_atlas: assets/sprites/enemies/bailiff_scooter.png
output_image: renders/enemy_bailiff_scooter/stun_or_parried_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
- 48
world: lower_sprawl
source_prompt_file: docs/sprite-production/prompts/expansion/enemies/lower_sprawl/enemy_bailiff_scooter.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `enemy_bailiff_scooter__stun_or_parried`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_bailiff_scooter/stun_or_parried_3c_1r.png`
...
| Runtime intent | `expansion:enemy_bailiff_scooter:stun_or_parried` |
| Atlas family | `assets/sprites/enemies/bailiff_scooter.png` |
