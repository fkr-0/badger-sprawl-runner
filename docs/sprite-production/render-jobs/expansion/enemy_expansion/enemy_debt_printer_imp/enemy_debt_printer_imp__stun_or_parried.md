...
source_entry: enemy_debt_printer_imp
job_id: enemy_debt_printer_imp__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: expansion:enemy_debt_printer_imp:stun_or_parried
source_class: expansion_template
atlas_family: assets/sprites/enemies/debt_printer_imp.png
target_atlas: assets/sprites/enemies/debt_printer_imp.png
output_image: renders/enemy_debt_printer_imp/stun_or_parried_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
- 48
world: lower_sprawl
source_prompt_file: docs/sprite-production/prompts/expansion/enemies/lower_sprawl/enemy_debt_printer_imp.md
reference_images:
...
- Output image: `renders/enemy_debt_printer_imp/stun_or_parried_3c_1r.png`
...
| Runtime intent | `expansion:enemy_debt_printer_imp:stun_or_parried` |
| Atlas family | `assets/sprites/enemies/debt_printer_imp.png` |
