...
job_id: enemy_prism_duelist__hurt
animation_state: hurt
animation_class: combat
runtime_clip: expansion:enemy_prism_duelist:hurt
...
output_image: renders/enemy_prism_duelist/hurt_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `enemy_prism_duelist__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_prism_duelist/hurt_2c_1r.png`
...
| Runtime intent | `expansion:enemy_prism_duelist:hurt` |
