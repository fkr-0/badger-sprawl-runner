...
job_id: enemy_prism_duelist__windup
animation_state: windup
animation_class: combat
runtime_clip: expansion:enemy_prism_duelist:windup
...
output_image: renders/enemy_prism_duelist/windup_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `enemy_prism_duelist__windup`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_prism_duelist/windup_3c_1r.png`
...
| Runtime intent | `expansion:enemy_prism_duelist:windup` |
