...
job_id: enemy_prism_duelist__idle
animation_state: idle
animation_class: presentation
runtime_clip: expansion:enemy_prism_duelist:idle
...
output_image: renders/enemy_prism_duelist/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_prism_duelist__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_prism_duelist/idle_4c_1r.png`
...
| Runtime intent | `expansion:enemy_prism_duelist:idle` |
