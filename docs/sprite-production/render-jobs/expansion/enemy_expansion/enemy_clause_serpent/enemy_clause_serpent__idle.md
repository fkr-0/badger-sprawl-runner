...
job_id: enemy_clause_serpent__idle
animation_state: idle
animation_class: presentation
runtime_clip: expansion:enemy_clause_serpent:idle
...
output_image: renders/enemy_clause_serpent/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_clause_serpent__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_clause_serpent/idle_4c_1r.png`
...
| Runtime intent | `expansion:enemy_clause_serpent:idle` |
