...
job_id: enemy_drone_wasp_queen__idle
animation_state: idle
animation_class: presentation
runtime_clip: expansion:enemy_drone_wasp_queen:idle
...
output_image: renders/enemy_drone_wasp_queen/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_drone_wasp_queen__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_drone_wasp_queen/idle_4c_1r.png`
...
| Runtime intent | `expansion:enemy_drone_wasp_queen:idle` |
