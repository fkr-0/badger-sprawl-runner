...
job_id: enemy_syringe_skater__death
animation_state: death
animation_class: sprite_animation
runtime_clip: expansion:enemy_syringe_skater:death
...
output_image: renders/enemy_syringe_skater/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_syringe_skater__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_syringe_skater/death_4c_2r.png`
...
| Runtime intent | `expansion:enemy_syringe_skater:death` |
