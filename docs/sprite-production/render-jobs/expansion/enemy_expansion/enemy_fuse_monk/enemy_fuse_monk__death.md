...
job_id: enemy_fuse_monk__death
animation_state: death
animation_class: sprite_animation
runtime_clip: expansion:enemy_fuse_monk:death
...
output_image: renders/enemy_fuse_monk/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_fuse_monk__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_fuse_monk/death_4c_2r.png`
...
| Runtime intent | `expansion:enemy_fuse_monk:death` |
