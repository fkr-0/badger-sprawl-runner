...
job_id: enemy_cable_crawler__patrol_or_move
animation_state: patrol_or_move
animation_class: locomotion
runtime_clip: expansion:enemy_cable_crawler:patrol_or_move
...
output_image: renders/enemy_cable_crawler/patrol_or_move_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/enemy_cable_crawler/patrol_or_move_4c_2r.png`
...
| Runtime intent | `expansion:enemy_cable_crawler:patrol_or_move` |
