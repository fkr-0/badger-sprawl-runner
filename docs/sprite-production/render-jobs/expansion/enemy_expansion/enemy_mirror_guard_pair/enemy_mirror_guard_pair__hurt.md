...
job_id: enemy_mirror_guard_pair__hurt
animation_state: hurt
animation_class: combat
runtime_clip: expansion:enemy_mirror_guard_pair:hurt
...
output_image: renders/enemy_mirror_guard_pair/hurt_2c_1r.png
frames: 2
grid:
  columns: 2
  rows: 1
...
# `enemy_mirror_guard_pair__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_mirror_guard_pair/hurt_2c_1r.png`
...
| Runtime intent | `expansion:enemy_mirror_guard_pair:hurt` |
