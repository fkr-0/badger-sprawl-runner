...
job_id: enemy_mirror_guard_pair__death
animation_state: death
animation_class: sprite_animation
runtime_clip: expansion:enemy_mirror_guard_pair:death
...
output_image: renders/enemy_mirror_guard_pair/death_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_mirror_guard_pair__death`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_mirror_guard_pair/death_4c_2r.png`
...
| Runtime intent | `expansion:enemy_mirror_guard_pair:death` |
