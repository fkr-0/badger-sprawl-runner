...
job_id: enemy_signboard_sniper__attack
animation_state: attack
animation_class: combat
runtime_clip: expansion:enemy_signboard_sniper:attack
...
output_image: renders/enemy_signboard_sniper/attack_4c_2r.png
frames: 5
grid:
  columns: 4
  rows: 2
...
# `enemy_signboard_sniper__attack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_signboard_sniper/attack_4c_2r.png`
...
| Runtime intent | `expansion:enemy_signboard_sniper:attack` |
