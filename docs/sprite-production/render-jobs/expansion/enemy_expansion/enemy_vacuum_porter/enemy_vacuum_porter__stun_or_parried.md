...
job_id: enemy_vacuum_porter__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: expansion:enemy_vacuum_porter:stun_or_parried
...
output_image: renders/enemy_vacuum_porter/stun_or_parried_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `enemy_vacuum_porter__stun_or_parried`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_vacuum_porter/stun_or_parried_3c_1r.png`
...
| Runtime intent | `expansion:enemy_vacuum_porter:stun_or_parried` |
