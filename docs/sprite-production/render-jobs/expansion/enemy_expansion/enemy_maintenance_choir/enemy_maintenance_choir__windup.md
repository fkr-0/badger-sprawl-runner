...
job_id: enemy_maintenance_choir__windup
animation_state: windup
animation_class: combat
runtime_clip: expansion:enemy_maintenance_choir:windup
...
output_image: renders/enemy_maintenance_choir/windup_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
# `enemy_maintenance_choir__windup`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_maintenance_choir/windup_3c_1r.png`
...
| Runtime intent | `expansion:enemy_maintenance_choir:windup` |
