...
job_id: enemy_gravity_customs__stun_or_parried
animation_state: stun_or_parried
animation_class: combat
runtime_clip: expansion:enemy_gravity_customs:stun_or_parried
...
output_image: renders/enemy_gravity_customs/stun_or_parried_3c_1r.png
frames: 3
grid:
  columns: 3
  rows: 1
...
- Output image: `renders/enemy_gravity_customs/stun_or_parried_3c_1r.png`
...
| Runtime intent | `expansion:enemy_gravity_customs:stun_or_parried` |
