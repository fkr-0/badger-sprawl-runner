...
job_id: enemy_feedback_cobra__idle
animation_state: idle
animation_class: presentation
runtime_clip: expansion:enemy_feedback_cobra:idle
...
output_image: renders/enemy_feedback_cobra/idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_feedback_cobra__idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_feedback_cobra/idle_4c_1r.png`
...
| Runtime intent | `expansion:enemy_feedback_cobra:idle` |
