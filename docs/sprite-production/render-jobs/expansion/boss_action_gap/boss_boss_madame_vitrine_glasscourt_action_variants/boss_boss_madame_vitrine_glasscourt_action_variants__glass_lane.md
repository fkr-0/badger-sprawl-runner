...
job_id: boss_boss_madame_vitrine_glasscourt_action_variants__glass_lane
animation_state: glass_lane
animation_class: boss_attack
runtime_clip: boss:glass_lane
...
output_image: renders/boss_boss_madame_vitrine_glasscourt_action_variants/glass_lane_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/boss_boss_madame_vitrine_glasscourt_action_variants/glass_lane_4c_2r.png`
...
| Runtime intent | `boss:glass_lane` |
...
Render job: boss_boss_madame_vitrine_glasscourt_action_variants__glass_lane
...
Specific missing-state design: glass armor refracts, arm traces a lane, mirrored blade wall releases, composed recovery.
Runtime intent: boss:glass_lane.
