...
job_id: boss_boss_knife_drone_nest_action_variants__blade_fan
animation_state: blade_fan
animation_class: boss_special
runtime_clip: boss:blade_fan
...
output_image: renders/boss_boss_knife_drone_nest_action_variants/blade_fan_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `boss_boss_knife_drone_nest_action_variants__blade_fan`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_knife_drone_nest_action_variants/blade_fan_4c_2r.png`
...
| Scope | `expansion` |
| Category | `boss_action_gap` |
| Animation state | `blade_fan` |
| Animation class | `boss_special` |
| Runtime intent | `boss:blade_fan` |
...
Render job: boss_boss_knife_drone_nest_action_variants__blade_fan
...
Specific missing-state design: fan blades unfold, rotational windup, broad blade fan release, spinning recovery.
Runtime intent: boss:blade_fan.
