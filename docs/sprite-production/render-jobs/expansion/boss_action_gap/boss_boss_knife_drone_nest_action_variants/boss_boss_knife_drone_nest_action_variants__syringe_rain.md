...
job_id: boss_boss_knife_drone_nest_action_variants__syringe_rain
animation_state: syringe_rain
animation_class: boss_special
runtime_clip: future:boss_syringe_rain
...
output_image: renders/boss_boss_knife_drone_nest_action_variants/syringe_rain_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `boss_boss_knife_drone_nest_action_variants__syringe_rain`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_knife_drone_nest_action_variants/syringe_rain_4c_2r.png`
...
| Scope | `expansion` |
| Category | `boss_action_gap` |
| Animation state | `syringe_rain` |
| Animation class | `boss_special` |
| Runtime intent | `future:boss_syringe_rain` |
...
Render job: boss_boss_knife_drone_nest_action_variants__syringe_rain
...
Specific missing-state design: clinic receipt vents open, syringes aim upward, launch volley, empty nest shudders and reloads.
Runtime intent: future:boss_syringe_rain.
