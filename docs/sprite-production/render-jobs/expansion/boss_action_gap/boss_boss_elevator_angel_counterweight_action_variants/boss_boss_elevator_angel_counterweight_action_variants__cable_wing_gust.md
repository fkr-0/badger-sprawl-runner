...
job_id: boss_boss_elevator_angel_counterweight_action_variants__cable_wing_gust
animation_state: cable_wing_gust
animation_class: boss_special
runtime_clip: future:boss_cable_wing_gust
...
output_image: renders/boss_boss_elevator_angel_counterweight_action_variants/cable_wing_gust_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/boss_boss_elevator_angel_counterweight_action_variants/cable_wing_gust_4c_2r.png`
...
| Scope | `expansion` |
| Category | `boss_action_gap` |
| Animation state | `cable_wing_gust` |
| Animation class | `boss_special` |
| Runtime intent | `future:boss_cable_wing_gust` |
...
Render job: boss_boss_elevator_angel_counterweight_action_variants__cable_wing_gust
...
Specific missing-state design: wings draw inward, cables whip outward, white-gold pressure gust, wing reset.
Runtime intent: future:boss_cable_wing_gust.
