...
job_id: boss_boss_elevator_angel_counterweight_action_variants__cargo_hook_sweep
animation_state: cargo_hook_sweep
animation_class: boss_attack
runtime_clip: future:boss_cargo_hook_sweep
...
output_image: renders/boss_boss_elevator_angel_counterweight_action_variants/cargo_hook_sweep_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `boss_boss_elevator_angel_counterweight_action_variants__cargo_hook_sweep`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_elevator_angel_counterweight_action_variants/cargo_hook_sweep_4c_2r.png`
...
| Scope | `expansion` |
| Category | `boss_action_gap` |
| Animation state | `cargo_hook_sweep` |
| Animation class | `boss_attack` |
| Runtime intent | `future:boss_cargo_hook_sweep` |
...
Render job: boss_boss_elevator_angel_counterweight_action_variants__cargo_hook_sweep
...
Specific missing-state design: hook hand retracts, cable tension builds, broad cargo-hook sweep, counterweight recoil.
Runtime intent: future:boss_cargo_hook_sweep.
