...
job_id: boss_boss_director_vane_skylock_action_variants__skylock_beam
animation_state: skylock_beam
animation_class: boss_special
runtime_clip: future:boss_skylock_beam
...
output_image: renders/boss_boss_director_vane_skylock_action_variants/skylock_beam_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `boss_boss_director_vane_skylock_action_variants__skylock_beam`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/boss_boss_director_vane_skylock_action_variants/skylock_beam_4c_2r.png`
...
| Scope | `expansion` |
| Category | `boss_action_gap` |
| Animation state | `skylock_beam` |
| Animation class | `boss_special` |
| Runtime intent | `future:boss_skylock_beam` |
...
Render job: boss_boss_director_vane_skylock_action_variants__skylock_beam
...
Specific missing-state design: air-lock halo targets, ledger spine charges, narrow skylock beam releases, executive recovery.
Runtime intent: future:boss_skylock_beam.
