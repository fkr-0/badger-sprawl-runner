...
job_id: moss_blade_styles__baton_blade_stun
animation_state: baton_blade_stun
animation_class: combat
runtime_clip: expansion:moss_blade_styles:baton_blade_stun
source_class: expansion_template
atlas_family: moss_blade_styles
target_atlas: null
output_image: renders/moss_blade_styles/baton_blade_stun_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_blade_styles__baton_blade_stun`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_blade_styles/baton_blade_stun_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `baton_blade_stun` |
| Animation class | `combat` |
| Runtime intent | `expansion:moss_blade_styles:baton_blade_stun` |
...
Render job: moss_blade_styles__baton_blade_stun
...
Specific move design: nonlethal guard strike and stun pulse.
```
