...
job_id: moss_blade_styles__katana_step_cut
animation_state: katana_step_cut
animation_class: combat
runtime_clip: expansion:moss_blade_styles:katana_step_cut
source_class: expansion_template
atlas_family: moss_blade_styles
target_atlas: null
output_image: renders/moss_blade_styles/katana_step_cut_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_blade_styles__katana_step_cut`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_blade_styles/katana_step_cut_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `katana_step_cut` |
| Animation class | `combat` |
| Runtime intent | `expansion:moss_blade_styles:katana_step_cut` |
...
Render job: moss_blade_styles__katana_step_cut
...
Specific move design: forward step, draw cut, clean recovery.
```
