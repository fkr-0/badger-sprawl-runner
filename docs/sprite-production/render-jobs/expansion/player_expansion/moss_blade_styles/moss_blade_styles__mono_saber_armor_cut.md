...
job_id: moss_blade_styles__mono_saber_armor_cut
animation_state: mono_saber_armor_cut
animation_class: sprite_animation
runtime_clip: expansion:moss_blade_styles:mono_saber_armor_cut
source_class: expansion_template
atlas_family: moss_blade_styles
target_atlas: null
output_image: renders/moss_blade_styles/mono_saber_armor_cut_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_blade_styles__mono_saber_armor_cut`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_blade_styles/mono_saber_armor_cut_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `mono_saber_armor_cut` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_blade_styles:mono_saber_armor_cut` |
...
Render job: moss_blade_styles__mono_saber_armor_cut
...
Animation: mono_saber_armor_cut.
Frame count: 8.
Frame order:
1. key pose
2. anticipation
...
Specific move design: hot anti-armor cut with heat buildup.
```
