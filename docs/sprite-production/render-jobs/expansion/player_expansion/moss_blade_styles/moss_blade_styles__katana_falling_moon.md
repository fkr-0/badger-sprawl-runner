...
source_entry: moss_blade_styles
job_id: moss_blade_styles__katana_falling_moon
animation_state: katana_falling_moon
animation_class: locomotion
runtime_clip: expansion:moss_blade_styles:katana_falling_moon
source_class: expansion_template
atlas_family: moss_blade_styles
target_atlas: null
output_image: renders/moss_blade_styles/katana_falling_moon_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/player/blade_styles.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `moss_blade_styles__katana_falling_moon`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_blade_styles/katana_falling_moon_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `katana_falling_moon` |
| Animation class | `locomotion` |
| Runtime intent | `expansion:moss_blade_styles:katana_falling_moon` |
| Atlas family | `moss_blade_styles` |
...
Render job: moss_blade_styles__katana_falling_moon
...
Specific move design: airborne turn into descending slash and landing.
```
