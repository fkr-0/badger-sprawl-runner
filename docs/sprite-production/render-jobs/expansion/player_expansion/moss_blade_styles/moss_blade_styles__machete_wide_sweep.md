...
job_id: moss_blade_styles__machete_wide_sweep
animation_state: machete_wide_sweep
animation_class: sprite_animation
runtime_clip: expansion:moss_blade_styles:machete_wide_sweep
source_class: expansion_template
atlas_family: moss_blade_styles
target_atlas: null
output_image: renders/moss_blade_styles/machete_wide_sweep_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_blade_styles__machete_wide_sweep`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_blade_styles/machete_wide_sweep_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `machete_wide_sweep` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_blade_styles:machete_wide_sweep` |
...
Render job: moss_blade_styles__machete_wide_sweep
...
Specific move design: heavy practical crowd-clearing arc.
```
