...
job_id: moss_blade_styles__hook_blade_pull
animation_state: hook_blade_pull
animation_class: sprite_animation
runtime_clip: expansion:moss_blade_styles:hook_blade_pull
source_class: expansion_template
atlas_family: moss_blade_styles
target_atlas: null
output_image: renders/moss_blade_styles/hook_blade_pull_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_blade_styles__hook_blade_pull`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_blade_styles/hook_blade_pull_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `hook_blade_pull` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_blade_styles:hook_blade_pull` |
...
Render job: moss_blade_styles__hook_blade_pull
...
Specific move design: cast hook, catch, pull target or Moss, recover.
```
