...
job_id: moss_claw_mastery__double_swipe
animation_state: double_swipe
animation_class: sprite_animation
runtime_clip: expansion:moss_claw_mastery:double_swipe
source_class: expansion_template
atlas_family: moss_claw_mastery
target_atlas: null
output_image: renders/moss_claw_mastery/double_swipe_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_claw_mastery__double_swipe`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_claw_mastery/double_swipe_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `double_swipe` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_claw_mastery:double_swipe` |
