...
source_entry: moss_claw_mastery
job_id: moss_claw_mastery__peoples_finisher
animation_state: peoples_finisher
animation_class: sprite_animation
runtime_clip: expansion:moss_claw_mastery:peoples_finisher
source_class: expansion_template
atlas_family: moss_claw_mastery
target_atlas: null
output_image: renders/moss_claw_mastery/peoples_finisher_4c_3r.png
frames: 12
grid:
  columns: 4
  rows: 3
...
- 144
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/player/claw_mastery.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `moss_claw_mastery__peoples_finisher`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_claw_mastery/peoples_finisher_4c_3r.png`
- Grid: 4 columns × 3 rows
- Cell size: 48×48 pixels
- Output size: 192×144 pixels
- Occupied frames: 12
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `peoples_finisher` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_claw_mastery:peoples_finisher` |
| Atlas family | `moss_claw_mastery` |
