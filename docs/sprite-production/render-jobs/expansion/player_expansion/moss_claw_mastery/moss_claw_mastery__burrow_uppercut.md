...
job_id: moss_claw_mastery__burrow_uppercut
animation_state: burrow_uppercut
animation_class: sprite_animation
runtime_clip: expansion:moss_claw_mastery:burrow_uppercut
source_class: expansion_template
atlas_family: moss_claw_mastery
target_atlas: null
output_image: renders/moss_claw_mastery/burrow_uppercut_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_claw_mastery__burrow_uppercut`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_claw_mastery/burrow_uppercut_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `burrow_uppercut` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_claw_mastery:burrow_uppercut` |
