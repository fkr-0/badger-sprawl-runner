...
job_id: moss_claw_mastery__falling_rake
animation_state: falling_rake
animation_class: locomotion
runtime_clip: expansion:moss_claw_mastery:falling_rake
source_class: expansion_template
atlas_family: moss_claw_mastery
target_atlas: null
output_image: renders/moss_claw_mastery/falling_rake_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_claw_mastery__falling_rake`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_claw_mastery/falling_rake_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `falling_rake` |
| Animation class | `locomotion` |
| Runtime intent | `expansion:moss_claw_mastery:falling_rake` |
