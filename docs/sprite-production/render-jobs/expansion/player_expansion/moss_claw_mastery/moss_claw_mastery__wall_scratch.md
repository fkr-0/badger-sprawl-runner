...
job_id: moss_claw_mastery__wall_scratch
animation_state: wall_scratch
animation_class: sprite_animation
runtime_clip: expansion:moss_claw_mastery:wall_scratch
source_class: expansion_template
atlas_family: moss_claw_mastery
target_atlas: null
output_image: renders/moss_claw_mastery/wall_scratch_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_claw_mastery__wall_scratch`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_claw_mastery/wall_scratch_4c_1r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `wall_scratch` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_claw_mastery:wall_scratch` |
