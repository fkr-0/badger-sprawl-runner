...
job_id: moss_hacking_and_interaction__remote_tap
animation_state: remote_tap
animation_class: sprite_animation
runtime_clip: expansion:moss_hacking_and_interaction:remote_tap
source_class: expansion_template
atlas_family: moss_hacking_and_interaction
target_atlas: null
output_image: renders/moss_hacking_and_interaction/remote_tap_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_hacking_and_interaction__remote_tap`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_hacking_and_interaction/remote_tap_4c_1r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `remote_tap` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_hacking_and_interaction:remote_tap` |
...
Render job: moss_hacking_and_interaction__remote_tap
...
Specific move design: one-handed remote hack gesture and confirmation.
```
