...
source_entry: moss_hacking_and_interaction
job_id: moss_hacking_and_interaction__terminal_stand_hack
animation_state: terminal_stand_hack
animation_class: interaction
runtime_clip: expansion:moss_hacking_and_interaction:terminal_stand_hack
source_class: expansion_template
atlas_family: moss_hacking_and_interaction
target_atlas: null
output_image: renders/moss_hacking_and_interaction/terminal_stand_hack_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/player/hacking_and_interaction.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `moss_hacking_and_interaction__terminal_stand_hack`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_hacking_and_interaction/terminal_stand_hack_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `terminal_stand_hack` |
| Animation class | `interaction` |
| Runtime intent | `expansion:moss_hacking_and_interaction:terminal_stand_hack` |
| Atlas family | `moss_hacking_and_interaction` |
...
Render job: moss_hacking_and_interaction__terminal_stand_hack
...
Specific move design: standing rapid input with whisker data pulse.
```
