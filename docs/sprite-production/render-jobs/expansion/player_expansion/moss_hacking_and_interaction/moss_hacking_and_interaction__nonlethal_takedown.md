...
job_id: moss_hacking_and_interaction__nonlethal_takedown
animation_state: nonlethal_takedown
animation_class: sprite_animation
runtime_clip: expansion:moss_hacking_and_interaction:nonlethal_takedown
source_class: expansion_template
atlas_family: moss_hacking_and_interaction
target_atlas: null
output_image: renders/moss_hacking_and_interaction/nonlethal_takedown_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_hacking_and_interaction__nonlethal_takedown`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_hacking_and_interaction/nonlethal_takedown_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `nonlethal_takedown` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_hacking_and_interaction:nonlethal_takedown` |
...
Render job: moss_hacking_and_interaction__nonlethal_takedown
...
Specific move design: controlled disarm and knockdown without gore.
```
