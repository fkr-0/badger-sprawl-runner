...
job_id: moss_hacking_and_interaction__trap_reverse
animation_state: trap_reverse
animation_class: sprite_animation
runtime_clip: expansion:moss_hacking_and_interaction:trap_reverse
source_class: expansion_template
atlas_family: moss_hacking_and_interaction
target_atlas: null
output_image: renders/moss_hacking_and_interaction/trap_reverse_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_hacking_and_interaction__trap_reverse`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_hacking_and_interaction/trap_reverse_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `trap_reverse` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_hacking_and_interaction:trap_reverse` |
...
Render job: moss_hacking_and_interaction__trap_reverse
...
Specific move design: point to hazard, retarget, confirm hacked ownership.
```
