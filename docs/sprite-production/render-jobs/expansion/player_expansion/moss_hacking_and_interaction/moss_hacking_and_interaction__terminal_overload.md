...
job_id: moss_hacking_and_interaction__terminal_overload
animation_state: terminal_overload
animation_class: sprite_animation
runtime_clip: expansion:moss_hacking_and_interaction:terminal_overload
source_class: expansion_template
atlas_family: moss_hacking_and_interaction
target_atlas: null
output_image: renders/moss_hacking_and_interaction/terminal_overload_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_hacking_and_interaction__terminal_overload`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_hacking_and_interaction/terminal_overload_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `terminal_overload` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_hacking_and_interaction:terminal_overload` |
...
Render job: moss_hacking_and_interaction__terminal_overload
...
Specific move design: route energy, brace, trigger overload, recoil.
```
