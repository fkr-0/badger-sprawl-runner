...
job_id: moss_hacking_and_interaction__companion_signal
animation_state: companion_signal
animation_class: sprite_animation
runtime_clip: expansion:moss_hacking_and_interaction:companion_signal
source_class: expansion_template
atlas_family: moss_hacking_and_interaction
target_atlas: null
output_image: renders/moss_hacking_and_interaction/companion_signal_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_hacking_and_interaction__companion_signal`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_hacking_and_interaction/companion_signal_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `companion_signal` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_hacking_and_interaction:companion_signal` |
...
Render job: moss_hacking_and_interaction__companion_signal
...
Specific move design: clear hand signal for ally assist.
```
