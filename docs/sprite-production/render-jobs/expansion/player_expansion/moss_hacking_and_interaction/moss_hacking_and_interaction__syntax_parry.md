...
job_id: moss_hacking_and_interaction__syntax_parry
animation_state: syntax_parry
animation_class: combat
runtime_clip: expansion:moss_hacking_and_interaction:syntax_parry
source_class: expansion_template
atlas_family: moss_hacking_and_interaction
target_atlas: null
output_image: renders/moss_hacking_and_interaction/syntax_parry_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_hacking_and_interaction__syntax_parry`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_hacking_and_interaction/syntax_parry_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `syntax_parry` |
| Animation class | `combat` |
| Runtime intent | `expansion:moss_hacking_and_interaction:syntax_parry` |
...
Render job: moss_hacking_and_interaction__syntax_parry
...
Specific move design: deflect coded attack and reveal valid token.
```
