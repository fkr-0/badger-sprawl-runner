...
job_id: moss_locomotion_and_stealth__slide
animation_state: slide
animation_class: locomotion
runtime_clip: expansion:moss_locomotion_and_stealth:slide
source_class: expansion_template
atlas_family: moss_locomotion_and_stealth
target_atlas: null
output_image: renders/moss_locomotion_and_stealth/slide_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_locomotion_and_stealth__slide`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_locomotion_and_stealth/slide_4c_2r.png`
...
| Runtime intent | `expansion:moss_locomotion_and_stealth:slide` |
...
Render job: moss_locomotion_and_stealth__slide
...
Specific move design: run-to-knee slide, sparks, low travel silhouette, recover to crouch.
```
