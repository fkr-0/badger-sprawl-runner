...
job_id: moss_locomotion_and_stealth__crouch_idle
animation_state: crouch_idle
animation_class: presentation
runtime_clip: expansion:moss_locomotion_and_stealth:crouch_idle
source_class: expansion_template
atlas_family: moss_locomotion_and_stealth
target_atlas: null
output_image: renders/moss_locomotion_and_stealth/crouch_idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- Output image: `renders/moss_locomotion_and_stealth/crouch_idle_4c_1r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `crouch_idle` |
| Animation class | `presentation` |
| Runtime intent | `expansion:moss_locomotion_and_stealth:crouch_idle` |
...
Render job: moss_locomotion_and_stealth__crouch_idle
...
Specific move design: low compact breathing pose, ears and coat kept below cover line.
```
