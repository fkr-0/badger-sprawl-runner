...
job_id: moss_locomotion_and_stealth__wall_climb
animation_state: wall_climb
animation_class: locomotion
runtime_clip: expansion:moss_locomotion_and_stealth:wall_climb
source_class: expansion_template
atlas_family: moss_locomotion_and_stealth
target_atlas: null
output_image: renders/moss_locomotion_and_stealth/wall_climb_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_locomotion_and_stealth__wall_climb`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_locomotion_and_stealth/wall_climb_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `wall_climb` |
| Animation class | `locomotion` |
| Runtime intent | `expansion:moss_locomotion_and_stealth:wall_climb` |
...
Render job: moss_locomotion_and_stealth__wall_climb
...
Specific move design: alternating claw pulls and boot pushes, stable wall contact.
```
