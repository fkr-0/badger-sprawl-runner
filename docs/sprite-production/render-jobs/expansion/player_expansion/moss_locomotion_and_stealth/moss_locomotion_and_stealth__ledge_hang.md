...
job_id: moss_locomotion_and_stealth__ledge_hang
animation_state: ledge_hang
animation_class: locomotion
runtime_clip: expansion:moss_locomotion_and_stealth:ledge_hang
source_class: expansion_template
atlas_family: moss_locomotion_and_stealth
target_atlas: null
output_image: renders/moss_locomotion_and_stealth/ledge_hang_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_locomotion_and_stealth__ledge_hang`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_locomotion_and_stealth/ledge_hang_4c_1r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `ledge_hang` |
| Animation class | `locomotion` |
| Runtime intent | `expansion:moss_locomotion_and_stealth:ledge_hang` |
...
Render job: moss_locomotion_and_stealth__ledge_hang
...
Specific move design: two-hand hang, one-hand strain, look up, stable grip.
```
