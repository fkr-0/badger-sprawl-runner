...
job_id: moss_locomotion_and_stealth__crouch_move
animation_state: crouch_move
animation_class: locomotion
runtime_clip: expansion:moss_locomotion_and_stealth:crouch_move
source_class: expansion_template
atlas_family: moss_locomotion_and_stealth
target_atlas: null
output_image: renders/moss_locomotion_and_stealth/crouch_move_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_locomotion_and_stealth__crouch_move`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_locomotion_and_stealth/crouch_move_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `crouch_move` |
| Animation class | `locomotion` |
| Runtime intent | `expansion:moss_locomotion_and_stealth:crouch_move` |
...
Render job: moss_locomotion_and_stealth__crouch_move
...
Specific move design: quiet heel-to-toe crouch walk with stable head height.
```
