...
job_id: moss_locomotion_and_stealth__dodge_roll
animation_state: dodge_roll
animation_class: locomotion
runtime_clip: expansion:moss_locomotion_and_stealth:dodge_roll
source_class: expansion_template
atlas_family: moss_locomotion_and_stealth
target_atlas: null
output_image: renders/moss_locomotion_and_stealth/dodge_roll_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/moss_locomotion_and_stealth/dodge_roll_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `dodge_roll` |
| Animation class | `locomotion` |
| Runtime intent | `expansion:moss_locomotion_and_stealth:dodge_roll` |
...
Render job: moss_locomotion_and_stealth__dodge_roll
...
Specific move design: anticipation, tucked roll, inverted midpoint, clean foot recovery.
```
