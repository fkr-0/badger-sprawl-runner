...
job_id: moss_locomotion_and_stealth__ledge_climb
animation_state: ledge_climb
animation_class: locomotion
runtime_clip: expansion:moss_locomotion_and_stealth:ledge_climb
source_class: expansion_template
atlas_family: moss_locomotion_and_stealth
target_atlas: null
output_image: renders/moss_locomotion_and_stealth/ledge_climb_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
- Output image: `renders/moss_locomotion_and_stealth/ledge_climb_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `ledge_climb` |
| Animation class | `locomotion` |
| Runtime intent | `expansion:moss_locomotion_and_stealth:ledge_climb` |
...
Render job: moss_locomotion_and_stealth__ledge_climb
...
Specific move design: pull chest to lip, knee plant, weight transfer, stand.
```
