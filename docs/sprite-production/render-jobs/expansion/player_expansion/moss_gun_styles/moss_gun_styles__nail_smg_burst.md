...
job_id: moss_gun_styles__nail_smg_burst
animation_state: nail_smg_burst
animation_class: sprite_animation
runtime_clip: expansion:moss_gun_styles:nail_smg_burst
source_class: expansion_template
atlas_family: moss_gun_styles
target_atlas: null
output_image: renders/moss_gun_styles/nail_smg_burst_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_gun_styles__nail_smg_burst`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_gun_styles/nail_smg_burst_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `nail_smg_burst` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_gun_styles:nail_smg_burst` |
...
Render job: moss_gun_styles__nail_smg_burst
...
Specific move design: controlled three-stage burst with rising recoil.
```
