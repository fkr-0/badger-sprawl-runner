...
job_id: moss_gun_styles__harpoon_line_fire
animation_state: harpoon_line_fire
animation_class: sprite_animation
runtime_clip: expansion:moss_gun_styles:harpoon_line_fire
source_class: expansion_template
atlas_family: moss_gun_styles
target_atlas: null
output_image: renders/moss_gun_styles/harpoon_line_fire_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_gun_styles__harpoon_line_fire`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_gun_styles/harpoon_line_fire_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `harpoon_line_fire` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_gun_styles:harpoon_line_fire` |
...
Render job: moss_gun_styles__harpoon_line_fire
...
Specific move design: aim, fire line, tension, pull, release.
```
