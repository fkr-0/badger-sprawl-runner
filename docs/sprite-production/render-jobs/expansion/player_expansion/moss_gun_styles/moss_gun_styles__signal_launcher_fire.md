...
job_id: moss_gun_styles__signal_launcher_fire
animation_state: signal_launcher_fire
animation_class: sprite_animation
runtime_clip: expansion:moss_gun_styles:signal_launcher_fire
source_class: expansion_template
atlas_family: moss_gun_styles
target_atlas: null
output_image: renders/moss_gun_styles/signal_launcher_fire_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_gun_styles__signal_launcher_fire`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_gun_styles/signal_launcher_fire_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `signal_launcher_fire` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_gun_styles:signal_launcher_fire` |
...
Render job: moss_gun_styles__signal_launcher_fire
...
Animation: signal_launcher_fire.
Frame count: 8.
Frame order:
1. key pose
2. anticipation
...
Specific move design: launch hack capsule, remote trigger gesture.
```
