...
job_id: moss_gun_styles__railgun_perfect_reload
animation_state: railgun_perfect_reload
animation_class: sprite_animation
runtime_clip: expansion:moss_gun_styles:railgun_perfect_reload
source_class: expansion_template
atlas_family: moss_gun_styles
target_atlas: null
output_image: renders/moss_gun_styles/railgun_perfect_reload_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_gun_styles__railgun_perfect_reload`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_gun_styles/railgun_perfect_reload_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_expansion` |
| Animation state | `railgun_perfect_reload` |
| Animation class | `sprite_animation` |
| Runtime intent | `expansion:moss_gun_styles:railgun_perfect_reload` |
...
Render job: moss_gun_styles__railgun_perfect_reload
...
Animation: railgun_perfect_reload.
Frame count: 8.
Frame order:
1. key pose
2. anticipation
...
Specific move design: open, eject, charge alignment, perfect sweet-spot lock.
```
