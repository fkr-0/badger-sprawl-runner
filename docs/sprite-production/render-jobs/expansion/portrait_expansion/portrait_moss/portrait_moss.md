...
source_entry: portrait_moss
job_id: portrait_moss
animation_state: portrait_moss
animation_class: portrait
runtime_clip: expansion:portrait_moss:portrait_moss
source_class: expansion_template
atlas_family: portrait_moss
target_atlas: null
output_image: renders/portraits/moss_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/moss.md
reference_images:
...
- Output image: `renders/portraits/moss_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_moss` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_moss:portrait_moss` |
| Atlas family | `portrait_moss` |
...
Character: Moss the badger; patched courier coat, chrome wetware whiskers, claw wraps, rain sheen.
