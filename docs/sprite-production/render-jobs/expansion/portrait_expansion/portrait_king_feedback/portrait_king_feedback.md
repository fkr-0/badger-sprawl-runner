...
source_entry: portrait_king_feedback
job_id: portrait_king_feedback
animation_state: portrait_king_feedback
animation_class: portrait
runtime_clip: expansion:portrait_king_feedback:portrait_king_feedback
source_class: expansion_template
atlas_family: portrait_king_feedback
target_atlas: null
output_image: renders/portraits/king_feedback_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/king_feedback.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `portrait_king_feedback`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/portraits/king_feedback_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_king_feedback` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_king_feedback:portrait_king_feedback` |
| Atlas family | `portrait_king_feedback` |
...
Render job: portrait_king_feedback
...
Character: rebel amp commander; speaker armor, cable crown, microphone mace.
