...
source_entry: portrait_dr_mina_suture
job_id: portrait_dr_mina_suture
animation_state: portrait_dr_mina_suture
animation_class: portrait
runtime_clip: expansion:portrait_dr_mina_suture:portrait_dr_mina_suture
source_class: expansion_template
atlas_family: portrait_dr_mina_suture
target_atlas: null
output_image: renders/portraits/dr_mina_suture_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/dr_mina_suture.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `portrait_dr_mina_suture`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/portraits/dr_mina_suture_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_dr_mina_suture` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_dr_mina_suture:portrait_dr_mina_suture` |
| Atlas family | `portrait_dr_mina_suture` |
...
Render job: portrait_dr_mina_suture
...
Character: mole medic; headlamp goggles, patched white coat, stim belt.
