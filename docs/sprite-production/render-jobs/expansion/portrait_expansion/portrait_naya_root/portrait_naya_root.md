...
source_entry: portrait_naya_root
job_id: portrait_naya_root
animation_state: portrait_naya_root
animation_class: portrait
runtime_clip: expansion:portrait_naya_root:portrait_naya_root
source_class: expansion_template
atlas_family: portrait_naya_root
target_atlas: null
output_image: renders/portraits/naya_root_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/naya_root.md
reference_images:
...
- Output image: `renders/portraits/naya_root_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_naya_root` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_naya_root:portrait_naya_root` |
| Atlas family | `portrait_naya_root` |
...
Character: raccoon shield fighter; leaf-pattern shield, seed pouch, work boots.
