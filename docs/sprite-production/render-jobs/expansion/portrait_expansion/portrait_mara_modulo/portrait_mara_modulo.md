...
source_entry: portrait_mara_modulo
job_id: portrait_mara_modulo
animation_state: portrait_mara_modulo
animation_class: portrait
runtime_clip: expansion:portrait_mara_modulo:portrait_mara_modulo
source_class: expansion_template
atlas_family: portrait_mara_modulo
target_atlas: null
output_image: renders/portraits/mara_modulo_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/mara_modulo.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `portrait_mara_modulo`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/portraits/mara_modulo_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_mara_modulo` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_mara_modulo:portrait_mara_modulo` |
| Atlas family | `portrait_mara_modulo` |
...
Render job: portrait_mara_modulo
...
Character: lizard squat hacker; sun-faded hoodie, chalkboard backpack, antenna piercings.
