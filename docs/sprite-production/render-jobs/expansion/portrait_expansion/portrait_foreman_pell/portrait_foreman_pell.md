...
source_entry: portrait_foreman_pell
job_id: portrait_foreman_pell
animation_state: portrait_foreman_pell
animation_class: portrait
runtime_clip: expansion:portrait_foreman_pell:portrait_foreman_pell
source_class: expansion_template
atlas_family: portrait_foreman_pell
target_atlas: null
output_image: renders/portraits/foreman_pell_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/foreman_pell.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `portrait_foreman_pell`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/portraits/foreman_pell_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_foreman_pell` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_foreman_pell:portrait_foreman_pell` |
| Atlas family | `portrait_foreman_pell` |
...
Render job: portrait_foreman_pell
...
Character: beaver maintenance foreman; greasy overalls, hidden union pin, tool harness.
