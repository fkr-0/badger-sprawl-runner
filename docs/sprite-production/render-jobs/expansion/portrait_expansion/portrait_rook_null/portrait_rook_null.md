...
source_entry: portrait_rook_null
job_id: portrait_rook_null
animation_state: portrait_rook_null
animation_class: portrait
runtime_clip: expansion:portrait_rook_null:portrait_rook_null
source_class: expansion_template
atlas_family: portrait_rook_null
target_atlas: null
output_image: renders/portraits/rook_null_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/rook_null.md
reference_images:
...
- Output image: `renders/portraits/rook_null_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_rook_null` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_rook_null:portrait_rook_null` |
| Atlas family | `portrait_rook_null` |
...
Character: raven radio hologram; CRT scanlines, waveform feathers, geometric eyes.
