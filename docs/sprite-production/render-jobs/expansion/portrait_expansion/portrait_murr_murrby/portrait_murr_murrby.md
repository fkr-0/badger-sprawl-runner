...
source_entry: portrait_murr_murrby
job_id: portrait_murr_murrby
animation_state: portrait_murr_murrby
animation_class: portrait
runtime_clip: expansion:portrait_murr_murrby:portrait_murr_murrby
source_class: expansion_template
atlas_family: portrait_murr_murrby
target_atlas: null
output_image: renders/portraits/murr_murrby_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/murr_murrby.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `portrait_murr_murrby`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/portraits/murr_murrby_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_murr_murrby` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_murr_murrby:portrait_murr_murrby` |
| Atlas family | `portrait_murr_murrby` |
...
Render job: portrait_murr_murrby
...
Character: black void-cat merchant; vacuum vest, folding crate shop, charming smile.
