...
source_entry: portrait_lio
job_id: portrait_lio
animation_state: portrait_lio
animation_class: portrait
runtime_clip: expansion:portrait_lio:portrait_lio
source_class: expansion_template
atlas_family: portrait_lio
target_atlas: null
output_image: renders/portraits/lio_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/lio.md
reference_images:
...
- Output image: `renders/portraits/lio_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_lio` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_lio:portrait_lio` |
| Atlas family | `portrait_lio` |
...
Character: fox courier in banquet mask; scarf hiding debt collar, formal jacket over torn courier gear.
