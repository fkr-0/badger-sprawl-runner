...
source_entry: portrait_dj_calculus
job_id: portrait_dj_calculus
animation_state: portrait_dj_calculus
animation_class: portrait
runtime_clip: expansion:portrait_dj_calculus:portrait_dj_calculus
source_class: expansion_template
atlas_family: portrait_dj_calculus
target_atlas: null
output_image: renders/portraits/dj_calculus_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/dj_calculus.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `portrait_dj_calculus`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/portraits/dj_calculus_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_dj_calculus` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_dj_calculus:portrait_dj_calculus` |
| Atlas family | `portrait_dj_calculus` |
...
Render job: portrait_dj_calculus
...
Character: hedgehog DJ; thick glasses, sampler pads, chalk equations on jacket.
