...
source_entry: portrait_juno_jar
job_id: portrait_juno_jar
animation_state: portrait_juno_jar
animation_class: portrait
runtime_clip: expansion:portrait_juno_jar:portrait_juno_jar
source_class: expansion_template
atlas_family: portrait_juno_jar
target_atlas: null
output_image: renders/portraits/juno_jar_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
- 96
world: null
source_prompt_file: docs/sprite-production/prompts/expansion/portraits/juno_jar.md
reference_images:
...
- Output image: `renders/portraits/juno_jar_4c_1r.png`
...
| Scope | `expansion` |
| Category | `portrait_expansion` |
| Animation state | `portrait_juno_jar` |
| Animation class | `portrait` |
| Runtime intent | `expansion:portrait_juno_jar:portrait_juno_jar` |
| Atlas family | `portrait_juno_jar` |
...
Character: rat child map-runner; oversized rain poncho, chalk tube, muddy boots.
