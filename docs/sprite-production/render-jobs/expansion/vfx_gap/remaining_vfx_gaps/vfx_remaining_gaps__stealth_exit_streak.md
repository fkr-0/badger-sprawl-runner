...
job_id: vfx_remaining_gaps__stealth_exit_streak
animation_state: stealth_exit_streak
animation_class: stealth_vfx
runtime_clip: future:vfx_stealth_exit
...
output_image: renders/vfx-remaining-gaps/stealth_exit_streak_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__stealth_exit_streak`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/stealth_exit_streak_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `stealth_exit_streak` |
