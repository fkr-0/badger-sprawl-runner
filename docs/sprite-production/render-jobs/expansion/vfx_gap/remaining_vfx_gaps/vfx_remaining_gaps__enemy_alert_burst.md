...
job_id: vfx_remaining_gaps__enemy_alert_burst
animation_state: enemy_alert_burst
animation_class: enemy_vfx
runtime_clip: future:vfx_enemy_alert
...
output_image: renders/vfx-remaining-gaps/enemy_alert_burst_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `vfx_remaining_gaps__enemy_alert_burst`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/enemy_alert_burst_4c_1r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `enemy_alert_burst` |
