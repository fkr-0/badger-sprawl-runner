...
job_id: vfx_remaining_gaps__feedback_security_pulse
animation_state: feedback_security_pulse
animation_class: boss_vfx
runtime_clip: boss:vfx_security_pulse
...
output_image: renders/vfx-remaining-gaps/feedback_security_pulse_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__feedback_security_pulse`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/feedback_security_pulse_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `feedback_security_pulse` |
