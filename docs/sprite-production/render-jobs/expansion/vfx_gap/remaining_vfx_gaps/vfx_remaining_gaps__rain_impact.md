...
job_id: vfx_remaining_gaps__rain_impact
animation_state: rain_impact
animation_class: environment_vfx
runtime_clip: future:vfx_rain_impact
...
output_image: renders/vfx-remaining-gaps/rain_impact_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `vfx_remaining_gaps__rain_impact`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/rain_impact_4c_1r.png`
