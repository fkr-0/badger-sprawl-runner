...
job_id: vfx_remaining_gaps__enemy_parry_stun
animation_state: enemy_parry_stun
animation_class: enemy_vfx
runtime_clip: future:vfx_enemy_stun
...
output_image: renders/vfx-remaining-gaps/enemy_parry_stun_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__enemy_parry_stun`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/enemy_parry_stun_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `enemy_parry_stun` |
