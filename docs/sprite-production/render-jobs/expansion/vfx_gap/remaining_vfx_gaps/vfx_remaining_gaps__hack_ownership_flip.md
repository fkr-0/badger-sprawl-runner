...
job_id: vfx_remaining_gaps__hack_ownership_flip
animation_state: hack_ownership_flip
animation_class: hack_vfx
runtime_clip: future:vfx_ownership_flip
...
output_image: renders/vfx-remaining-gaps/hack_ownership_flip_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__hack_ownership_flip`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/hack_ownership_flip_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `hack_ownership_flip` |
