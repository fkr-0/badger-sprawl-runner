...
job_id: vfx_remaining_gaps__perfect_reload_ring
animation_state: perfect_reload_ring
animation_class: cue_vfx
runtime_clip: future:vfx_perfect_reload
...
output_image: renders/vfx-remaining-gaps/perfect_reload_ring_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__perfect_reload_ring`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/perfect_reload_ring_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `perfect_reload_ring` |
