...
job_id: vfx_remaining_gaps__skylock_beam
animation_state: skylock_beam
animation_class: boss_vfx
runtime_clip: future:vfx_skylock_beam
...
output_image: renders/vfx-remaining-gaps/skylock_beam_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__skylock_beam`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/skylock_beam_4c_2r.png`
