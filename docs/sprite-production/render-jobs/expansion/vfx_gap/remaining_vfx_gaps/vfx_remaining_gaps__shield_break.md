...
job_id: vfx_remaining_gaps__shield_break
animation_state: shield_break
animation_class: enemy_vfx
runtime_clip: future:vfx_shield_break
...
output_image: renders/vfx-remaining-gaps/shield_break_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__shield_break`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/shield_break_4c_2r.png`
