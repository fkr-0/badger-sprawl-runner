...
job_id: vfx_remaining_gaps__rocket_air_brake_burst
animation_state: rocket_air_brake_burst
animation_class: traversal_vfx
runtime_clip: future:vfx_air_brake
...
output_image: renders/vfx-remaining-gaps/rocket_air_brake_burst_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__rocket_air_brake_burst`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/rocket_air_brake_burst_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `rocket_air_brake_burst` |
