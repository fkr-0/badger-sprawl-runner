...
job_id: vfx_remaining_gaps__glass_lane_rise
animation_state: glass_lane_rise
animation_class: boss_vfx
runtime_clip: boss:vfx_glass_lane
...
output_image: renders/vfx-remaining-gaps/glass_lane_rise_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__glass_lane_rise`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/glass_lane_rise_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `glass_lane_rise` |
