...
job_id: vfx_remaining_gaps__swarm_scatter
animation_state: swarm_scatter
animation_class: enemy_vfx
runtime_clip: future:vfx_swarm_scatter
...
output_image: renders/vfx-remaining-gaps/swarm_scatter_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__swarm_scatter`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/swarm_scatter_4c_2r.png`
