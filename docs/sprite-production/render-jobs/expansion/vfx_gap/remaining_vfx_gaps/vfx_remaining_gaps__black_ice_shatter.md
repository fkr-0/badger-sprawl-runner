...
job_id: vfx_remaining_gaps__black_ice_shatter
animation_state: black_ice_shatter
animation_class: boss_vfx
runtime_clip: future:vfx_black_ice
...
output_image: renders/vfx-remaining-gaps/black_ice_shatter_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__black_ice_shatter`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/black_ice_shatter_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `black_ice_shatter` |
