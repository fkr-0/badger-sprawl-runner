...
job_id: vfx_remaining_gaps__invoice_splitter_impact
animation_state: invoice_splitter_impact
animation_class: combat_vfx
runtime_clip: skill:vfx_invoice_splitter
...
output_image: renders/vfx-remaining-gaps/invoice_splitter_impact_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__invoice_splitter_impact`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/invoice_splitter_impact_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `invoice_splitter_impact` |
