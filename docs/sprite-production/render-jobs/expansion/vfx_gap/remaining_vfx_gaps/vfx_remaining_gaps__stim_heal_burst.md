...
job_id: vfx_remaining_gaps__stim_heal_burst
animation_state: stim_heal_burst
animation_class: item_vfx
runtime_clip: future:vfx_stim
...
output_image: renders/vfx-remaining-gaps/stim_heal_burst_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__stim_heal_burst`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/stim_heal_burst_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `stim_heal_burst` |
