...
job_id: vfx_remaining_gaps__receipt_paper_burst
animation_state: receipt_paper_burst
animation_class: boss_vfx
runtime_clip: boss:vfx_receipt_burst
...
output_image: renders/vfx-remaining-gaps/receipt_paper_burst_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__receipt_paper_burst`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/receipt_paper_burst_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `receipt_paper_burst` |
