...
job_id: vfx_remaining_gaps__blade_fan_wave
animation_state: blade_fan_wave
animation_class: boss_vfx
runtime_clip: boss:vfx_blade_fan
...
output_image: renders/vfx-remaining-gaps/blade_fan_wave_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__blade_fan_wave`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/blade_fan_wave_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `blade_fan_wave` |
