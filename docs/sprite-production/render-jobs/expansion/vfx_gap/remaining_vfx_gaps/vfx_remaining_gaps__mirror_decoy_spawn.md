...
job_id: vfx_remaining_gaps__mirror_decoy_spawn
animation_state: mirror_decoy_spawn
animation_class: item_vfx
runtime_clip: item:vfx_decoy
...
output_image: renders/vfx-remaining-gaps/mirror_decoy_spawn_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__mirror_decoy_spawn`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/mirror_decoy_spawn_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `mirror_decoy_spawn` |
