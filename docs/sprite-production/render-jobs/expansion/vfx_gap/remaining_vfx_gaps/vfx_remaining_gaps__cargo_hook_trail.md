...
job_id: vfx_remaining_gaps__cargo_hook_trail
animation_state: cargo_hook_trail
animation_class: boss_vfx
runtime_clip: future:vfx_cargo_hook
...
output_image: renders/vfx-remaining-gaps/cargo_hook_trail_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__cargo_hook_trail`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/cargo_hook_trail_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `cargo_hook_trail` |
