...
job_id: vfx_remaining_gaps__peoples_finisher_emp
animation_state: peoples_finisher_emp
animation_class: combat_vfx
runtime_clip: skill:vfx_peoples_finisher
...
output_image: renders/vfx-remaining-gaps/peoples_finisher_emp_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__peoples_finisher_emp`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/peoples_finisher_emp_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `peoples_finisher_emp` |
