...
job_id: vfx_remaining_gaps__rail_charge_orbit
animation_state: rail_charge_orbit
animation_class: weapon_vfx
runtime_clip: future:vfx_rail_charge
...
output_image: renders/vfx-remaining-gaps/rail_charge_orbit_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__rail_charge_orbit`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/rail_charge_orbit_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `rail_charge_orbit` |
