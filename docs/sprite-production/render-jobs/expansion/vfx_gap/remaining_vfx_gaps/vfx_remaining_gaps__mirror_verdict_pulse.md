...
job_id: vfx_remaining_gaps__mirror_verdict_pulse
animation_state: mirror_verdict_pulse
animation_class: boss_vfx
runtime_clip: boss:vfx_mirror_verdict
...
output_image: renders/vfx-remaining-gaps/mirror_verdict_pulse_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__mirror_verdict_pulse`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/mirror_verdict_pulse_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `mirror_verdict_pulse` |
