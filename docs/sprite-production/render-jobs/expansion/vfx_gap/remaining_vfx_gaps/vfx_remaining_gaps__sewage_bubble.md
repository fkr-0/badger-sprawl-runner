...
job_id: vfx_remaining_gaps__sewage_bubble
animation_state: sewage_bubble
animation_class: environment_vfx
runtime_clip: future:vfx_sewage_bubble
...
output_image: renders/vfx-remaining-gaps/sewage_bubble_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__sewage_bubble`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/sewage_bubble_4c_2r.png`
