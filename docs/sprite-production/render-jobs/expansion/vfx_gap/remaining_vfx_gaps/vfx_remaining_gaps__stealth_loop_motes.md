...
job_id: vfx_remaining_gaps__stealth_loop_motes
animation_state: stealth_loop_motes
animation_class: stealth_vfx
runtime_clip: future:vfx_stealth_loop
...
output_image: renders/vfx-remaining-gaps/stealth_loop_motes_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `vfx_remaining_gaps__stealth_loop_motes`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/stealth_loop_motes_4c_1r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `stealth_loop_motes` |
