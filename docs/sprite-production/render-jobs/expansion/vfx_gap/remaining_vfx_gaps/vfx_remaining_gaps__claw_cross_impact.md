...
job_id: vfx_remaining_gaps__claw_cross_impact
animation_state: claw_cross_impact
animation_class: combat_vfx
runtime_clip: skill:vfx_claw_cross
...
output_image: renders/vfx-remaining-gaps/claw_cross_impact_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__claw_cross_impact`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/claw_cross_impact_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `claw_cross_impact` |
