...
job_id: vfx_remaining_gaps__stealth_enter_poof
animation_state: stealth_enter_poof
animation_class: stealth_vfx
runtime_clip: future:vfx_stealth_enter
...
output_image: renders/vfx-remaining-gaps/stealth_enter_poof_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__stealth_enter_poof`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/stealth_enter_poof_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `stealth_enter_poof` |
