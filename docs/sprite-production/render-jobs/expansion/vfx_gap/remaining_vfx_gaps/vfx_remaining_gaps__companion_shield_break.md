...
job_id: vfx_remaining_gaps__companion_shield_break
animation_state: companion_shield_break
animation_class: companion_vfx
runtime_clip: future:vfx_companion_shield
...
output_image: renders/vfx-remaining-gaps/companion_shield_break_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__companion_shield_break`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/companion_shield_break_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `companion_shield_break` |
