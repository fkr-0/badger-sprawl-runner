...
job_id: vfx_remaining_gaps__turret_tracer
animation_state: turret_tracer
animation_class: enemy_vfx
runtime_clip: future:vfx_turret_tracer
...
output_image: renders/vfx-remaining-gaps/turret_tracer_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__turret_tracer`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/turret_tracer_4c_2r.png`
