...
job_id: vfx_remaining_gaps__fast_fall_streak
animation_state: fast_fall_streak
animation_class: player_vfx
runtime_clip: future:vfx_fast_fall
...
output_image: renders/vfx-remaining-gaps/fast_fall_streak_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `vfx_remaining_gaps__fast_fall_streak`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/fast_fall_streak_4c_1r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `fast_fall_streak` |
