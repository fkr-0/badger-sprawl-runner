...
job_id: vfx_remaining_gaps__dodge_poof
animation_state: dodge_poof
animation_class: player_vfx
runtime_clip: future:vfx_dodge
...
output_image: renders/vfx-remaining-gaps/dodge_poof_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__dodge_poof`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/dodge_poof_4c_2r.png`
