...
job_id: vfx_remaining_gaps__boss_phase_transition
animation_state: boss_phase_transition
animation_class: boss_vfx
runtime_clip: future:vfx_boss_phase
...
output_image: renders/vfx-remaining-gaps/boss_phase_transition_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `vfx_remaining_gaps__boss_phase_transition`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/vfx-remaining-gaps/boss_phase_transition_4c_2r.png`
...
| Scope | `expansion` |
| Category | `vfx_gap` |
| Animation state | `boss_phase_transition` |
