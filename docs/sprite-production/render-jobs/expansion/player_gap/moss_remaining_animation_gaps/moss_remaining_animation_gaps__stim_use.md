...
job_id: moss_remaining_animation_gaps__stim_use
animation_state: stim_use
animation_class: item_use
runtime_clip: future:stim_use
...
output_image: renders/moss_remaining_animation_gaps/stim_use_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__stim_use`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/stim_use_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_gap` |
| Animation state | `stim_use` |
| Animation class | `item_use` |
