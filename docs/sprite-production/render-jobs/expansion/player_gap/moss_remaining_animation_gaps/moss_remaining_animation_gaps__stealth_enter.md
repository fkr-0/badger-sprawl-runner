...
job_id: moss_remaining_animation_gaps__stealth_enter
animation_state: stealth_enter
animation_class: stealth
runtime_clip: future:stealth_enter
...
output_image: renders/moss_remaining_animation_gaps/stealth_enter_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__stealth_enter`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/stealth_enter_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_gap` |
| Animation state | `stealth_enter` |
| Animation class | `stealth` |
