...
job_id: moss_remaining_animation_gaps__fast_fall
animation_state: fast_fall
animation_class: locomotion
runtime_clip: future:fast_fall
...
output_image: renders/moss_remaining_animation_gaps/fast_fall_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_remaining_animation_gaps__fast_fall`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/fast_fall_4c_1r.png`
