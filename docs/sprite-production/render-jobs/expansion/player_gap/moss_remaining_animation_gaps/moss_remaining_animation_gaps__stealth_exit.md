...
job_id: moss_remaining_animation_gaps__stealth_exit
animation_state: stealth_exit
animation_class: stealth
runtime_clip: future:stealth_exit
...
output_image: renders/moss_remaining_animation_gaps/stealth_exit_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__stealth_exit`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/stealth_exit_4c_2r.png`
