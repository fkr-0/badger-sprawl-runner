...
job_id: moss_remaining_animation_gaps__checkpoint_respawn
animation_state: checkpoint_respawn
animation_class: recovery
runtime_clip: future:checkpoint_respawn
...
output_image: renders/moss_remaining_animation_gaps/checkpoint_respawn_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__checkpoint_respawn`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/checkpoint_respawn_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_gap` |
| Animation state | `checkpoint_respawn` |
