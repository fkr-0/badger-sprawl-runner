...
job_id: moss_remaining_animation_gaps__air_dodge
animation_state: air_dodge
animation_class: evasion
runtime_clip: future:air_dodge
...
output_image: renders/moss_remaining_animation_gaps/air_dodge_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__air_dodge`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/air_dodge_4c_2r.png`
