...
job_id: moss_remaining_animation_gaps__katana_parry
animation_state: katana_parry
animation_class: weapon_defense
runtime_clip: future:katana_parry
...
output_image: renders/moss_remaining_animation_gaps/katana_parry_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__katana_parry`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/katana_parry_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_gap` |
| Animation state | `katana_parry` |
| Animation class | `weapon_defense` |
