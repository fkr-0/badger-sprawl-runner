...
job_id: moss_remaining_animation_gaps__invoice_splitter
animation_state: invoice_splitter
animation_class: melee_skill
runtime_clip: skill:invoice_splitter
...
output_image: renders/moss_remaining_animation_gaps/invoice_splitter_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__invoice_splitter`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/invoice_splitter_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_gap` |
| Animation state | `invoice_splitter` |
| Animation class | `melee_skill` |
