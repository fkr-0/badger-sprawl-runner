...
job_id: moss_remaining_animation_gaps__rocket_air_brake
animation_state: rocket_air_brake
animation_class: traversal
runtime_clip: future:rocket_air_brake
...
output_image: renders/moss_remaining_animation_gaps/rocket_air_brake_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__rocket_air_brake`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/rocket_air_brake_4c_2r.png`
...
| Scope | `expansion` |
| Category | `player_gap` |
| Animation state | `rocket_air_brake` |
| Animation class | `traversal` |
