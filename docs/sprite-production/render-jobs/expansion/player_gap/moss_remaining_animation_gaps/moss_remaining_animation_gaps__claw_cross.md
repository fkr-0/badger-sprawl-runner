...
job_id: moss_remaining_animation_gaps__claw_cross
animation_state: claw_cross
animation_class: melee_skill
runtime_clip: skill:claw_cross
...
output_image: renders/moss_remaining_animation_gaps/claw_cross_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__claw_cross`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/claw_cross_4c_2r.png`
