...
job_id: moss_remaining_animation_gaps__ledge_drop
animation_state: ledge_drop
animation_class: traversal
runtime_clip: future:ledge_drop
...
output_image: renders/moss_remaining_animation_gaps/ledge_drop_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_remaining_animation_gaps__ledge_drop`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/ledge_drop_4c_1r.png`
