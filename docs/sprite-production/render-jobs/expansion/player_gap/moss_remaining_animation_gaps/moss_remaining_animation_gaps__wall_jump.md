...
job_id: moss_remaining_animation_gaps__wall_jump
animation_state: wall_jump
animation_class: traversal
runtime_clip: future:wall_jump
...
output_image: renders/moss_remaining_animation_gaps/wall_jump_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__wall_jump`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/wall_jump_4c_2r.png`
