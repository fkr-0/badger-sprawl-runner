...
job_id: moss_remaining_animation_gaps__stealth_loop
animation_state: stealth_loop
animation_class: stealth
runtime_clip: future:stealth_loop
...
output_image: renders/moss_remaining_animation_gaps/stealth_loop_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `moss_remaining_animation_gaps__stealth_loop`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/stealth_loop_4c_2r.png`
