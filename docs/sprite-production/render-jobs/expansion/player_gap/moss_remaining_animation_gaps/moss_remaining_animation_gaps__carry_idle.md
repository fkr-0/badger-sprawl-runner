...
job_id: moss_remaining_animation_gaps__carry_idle
animation_state: carry_idle
animation_class: carry
runtime_clip: future:carry_idle
...
output_image: renders/moss_remaining_animation_gaps/carry_idle_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `moss_remaining_animation_gaps__carry_idle`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/moss_remaining_animation_gaps/carry_idle_4c_1r.png`
