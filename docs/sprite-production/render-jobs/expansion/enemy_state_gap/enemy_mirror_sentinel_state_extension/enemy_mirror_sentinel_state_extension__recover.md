...
job_id: enemy_mirror_sentinel_state_extension__recover
...
output_image: renders/enemy_mirror_sentinel_state_extension/recover_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_mirror_sentinel_state_extension__recover`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_mirror_sentinel_state_extension/recover_4c_1r.png`
...
Render job: enemy_mirror_sentinel_state_extension__recover
