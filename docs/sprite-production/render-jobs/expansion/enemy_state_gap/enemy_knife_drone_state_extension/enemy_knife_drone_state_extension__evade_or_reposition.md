...
source_entry: enemy_knife_drone_state_extension
job_id: enemy_knife_drone_state_extension__evade_or_reposition
...
atlas_family: assets/sprites/enemies/expansion/enemy_knife_drone_state_extension.png
target_atlas: assets/sprites/enemies/expansion/enemy_knife_drone_state_extension.png
output_image: renders/enemy_knife_drone_state_extension/evade_or_reposition_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: drainmarket
source_prompt_file: docs/sprite-production/prompts/expansion/gaps/enemies/enemy_knife_drone_state_extension.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `enemy_knife_drone_state_extension__evade_or_reposition`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_knife_drone_state_extension/evade_or_reposition_4c_2r.png`
...
| Atlas family | `assets/sprites/enemies/expansion/enemy_knife_drone_state_extension.png` |
...
Render job: enemy_knife_drone_state_extension__evade_or_reposition
...
Asset identity: knife drone; insect drone with scalpel wings and red clinic light.
