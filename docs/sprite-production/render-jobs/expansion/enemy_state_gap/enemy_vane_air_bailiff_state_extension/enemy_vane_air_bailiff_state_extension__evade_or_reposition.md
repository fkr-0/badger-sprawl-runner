...
source_entry: enemy_vane_air_bailiff_state_extension
job_id: enemy_vane_air_bailiff_state_extension__evade_or_reposition
animation_state: evade_or_reposition
animation_class: evasion
runtime_clip: future:enemy_evade
source_class: remaining_gap_catalog
atlas_family: assets/sprites/enemies/expansion/enemy_vane_air_bailiff_state_extension.png
target_atlas: assets/sprites/enemies/expansion/enemy_vane_air_bailiff_state_extension.png
output_image: renders/enemy_vane_air_bailiff_state_extension/evade_or_reposition_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
source_prompt_file: docs/sprite-production/prompts/expansion/gaps/enemies/enemy_vane_air_bailiff_state_extension.md
reference_images:
...
- Output image: `renders/enemy_vane_air_bailiff_state_extension/evade_or_reposition_4c_2r.png`
...
| Scope | `expansion` |
| Category | `enemy_state_gap` |
| Animation state | `evade_or_reposition` |
| Animation class | `evasion` |
| Runtime intent | `future:enemy_evade` |
| Atlas family | `assets/sprites/enemies/expansion/enemy_vane_air_bailiff_state_extension.png` |
...
Render job: enemy_vane_air_bailiff_state_extension__evade_or_reposition
...
Asset identity: air bailiff enemy; jackal officer with oxygen meter staff and gold ledger mask.
