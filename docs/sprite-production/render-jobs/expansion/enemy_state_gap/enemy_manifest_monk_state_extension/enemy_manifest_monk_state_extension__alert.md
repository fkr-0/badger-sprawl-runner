...
job_id: enemy_manifest_monk_state_extension__alert
...
output_image: renders/enemy_manifest_monk_state_extension/alert_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_manifest_monk_state_extension__alert`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_manifest_monk_state_extension/alert_4c_1r.png`
...
Render job: enemy_manifest_monk_state_extension__alert
