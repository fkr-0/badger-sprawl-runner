...
job_id: enemy_manifest_monk_state_extension__turn_or_reorient
...
output_image: renders/enemy_manifest_monk_state_extension/turn_or_reorient_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_manifest_monk_state_extension__turn_or_reorient`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_manifest_monk_state_extension/turn_or_reorient_4c_1r.png`
...
Render job: enemy_manifest_monk_state_extension__turn_or_reorient
