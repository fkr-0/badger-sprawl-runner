...
job_id: enemy_signal_jammer_bat_state_extension__recover
animation_state: recover
animation_class: recovery
runtime_clip: future:enemy_recover
...
output_image: renders/enemy_signal_jammer_bat_state_extension/recover_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_signal_jammer_bat_state_extension__recover`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_signal_jammer_bat_state_extension/recover_4c_1r.png`
...
| Scope | `expansion` |
| Category | `enemy_state_gap` |
| Animation state | `recover` |
| Animation class | `recovery` |
...
Render job: enemy_signal_jammer_bat_state_extension__recover
