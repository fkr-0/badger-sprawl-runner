...
job_id: enemy_signal_jammer_bat_state_extension__alert
animation_state: alert
animation_class: awareness
runtime_clip: future:enemy_alert
...
output_image: renders/enemy_signal_jammer_bat_state_extension/alert_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `enemy_signal_jammer_bat_state_extension__alert`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_signal_jammer_bat_state_extension/alert_4c_1r.png`
...
| Scope | `expansion` |
| Category | `enemy_state_gap` |
| Animation state | `alert` |
| Animation class | `awareness` |
...
Render job: enemy_signal_jammer_bat_state_extension__alert
