...
job_id: enemy_command_lock_partisan_state_extension__evade_or_reposition
...
output_image: renders/enemy_command_lock_partisan_state_extension/evade_or_reposition_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `enemy_command_lock_partisan_state_extension__evade_or_reposition`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/enemy_command_lock_partisan_state_extension/evade_or_reposition_4c_2r.png`
...
Render job: enemy_command_lock_partisan_state_extension__evade_or_reposition
