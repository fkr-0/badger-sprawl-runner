...
job_id: dub_colony__interactives
animation_state: dub_colony__interactives
animation_class: environment_tile
runtime_clip: expansion:dub_colony_full_tiles:dub_colony__interactives
source_class: expansion_template
atlas_family: dub_colony_full_tiles
target_atlas: null
output_image: renders/world-expansion/dub_colony/interactives_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `dub_colony__interactives`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/dub_colony/interactives_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `dub_colony__interactives` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:dub_colony_full_tiles:dub_colony__interactives` |
...
Render job: dub_colony__interactives
