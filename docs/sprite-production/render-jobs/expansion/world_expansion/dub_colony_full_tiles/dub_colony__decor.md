...
job_id: dub_colony__decor
animation_state: dub_colony__decor
animation_class: environment_tile
runtime_clip: expansion:dub_colony_full_tiles:dub_colony__decor
source_class: expansion_template
atlas_family: dub_colony_full_tiles
target_atlas: null
output_image: renders/world-expansion/dub_colony/decor_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
- Output image: `renders/world-expansion/dub_colony/decor_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `dub_colony__decor` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:dub_colony_full_tiles:dub_colony__decor` |
