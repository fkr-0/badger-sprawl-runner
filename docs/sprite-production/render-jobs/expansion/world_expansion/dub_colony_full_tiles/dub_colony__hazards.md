...
source_entry: dub_colony_full_tiles
job_id: dub_colony__hazards
animation_state: dub_colony__hazards
animation_class: hazard_tile
runtime_clip: expansion:dub_colony_full_tiles:dub_colony__hazards
source_class: expansion_template
atlas_family: dub_colony_full_tiles
target_atlas: null
output_image: renders/world-expansion/dub_colony/hazards_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
- 128
world: dub_colony
source_prompt_file: docs/sprite-production/prompts/expansion/worlds/dub_colony_full_tiles.md
reference_images:
...
- Output image: `renders/world-expansion/dub_colony/hazards_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `dub_colony__hazards` |
| Animation class | `hazard_tile` |
| Runtime intent | `expansion:dub_colony_full_tiles:dub_colony__hazards` |
| Atlas family | `dub_colony_full_tiles` |
...
Render job: dub_colony__hazards
