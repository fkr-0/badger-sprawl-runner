...
job_id: asteroid_redoubt__decor
animation_state: asteroid_redoubt__decor
animation_class: environment_tile
runtime_clip: expansion:asteroid_redoubt_full_tiles:asteroid_redoubt__decor
source_class: expansion_template
atlas_family: asteroid_redoubt_full_tiles
target_atlas: null
output_image: renders/world-expansion/asteroid_redoubt/decor_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `asteroid_redoubt__decor`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/asteroid_redoubt/decor_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `asteroid_redoubt__decor` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:asteroid_redoubt_full_tiles:asteroid_redoubt__decor` |
...
Render job: asteroid_redoubt__decor
