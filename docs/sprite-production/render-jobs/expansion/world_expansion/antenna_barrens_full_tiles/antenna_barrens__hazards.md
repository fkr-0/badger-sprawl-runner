...
job_id: antenna_barrens__hazards
animation_state: antenna_barrens__hazards
animation_class: hazard_tile
runtime_clip: expansion:antenna_barrens_full_tiles:antenna_barrens__hazards
source_class: expansion_template
atlas_family: antenna_barrens_full_tiles
target_atlas: null
output_image: renders/world-expansion/antenna_barrens/hazards_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `antenna_barrens__hazards`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/antenna_barrens/hazards_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `antenna_barrens__hazards` |
| Animation class | `hazard_tile` |
| Runtime intent | `expansion:antenna_barrens_full_tiles:antenna_barrens__hazards` |
...
Render job: antenna_barrens__hazards
