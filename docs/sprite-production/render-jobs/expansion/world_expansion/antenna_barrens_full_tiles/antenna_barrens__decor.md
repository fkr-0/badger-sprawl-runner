...
job_id: antenna_barrens__decor
animation_state: antenna_barrens__decor
animation_class: environment_tile
runtime_clip: expansion:antenna_barrens_full_tiles:antenna_barrens__decor
source_class: expansion_template
atlas_family: antenna_barrens_full_tiles
target_atlas: null
output_image: renders/world-expansion/antenna_barrens/decor_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `antenna_barrens__decor`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/antenna_barrens/decor_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `antenna_barrens__decor` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:antenna_barrens_full_tiles:antenna_barrens__decor` |
...
Render job: antenna_barrens__decor
