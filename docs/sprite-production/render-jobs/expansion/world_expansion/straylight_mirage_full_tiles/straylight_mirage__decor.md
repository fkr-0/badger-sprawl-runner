...
job_id: straylight_mirage__decor
animation_state: straylight_mirage__decor
animation_class: environment_tile
runtime_clip: expansion:straylight_mirage_full_tiles:straylight_mirage__decor
source_class: expansion_template
atlas_family: straylight_mirage_full_tiles
target_atlas: null
output_image: renders/world-expansion/straylight_mirage/decor_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `straylight_mirage__decor`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/straylight_mirage/decor_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `straylight_mirage__decor` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:straylight_mirage_full_tiles:straylight_mirage__decor` |
...
Render job: straylight_mirage__decor
