...
job_id: straylight_mirage__hazards
animation_state: straylight_mirage__hazards
animation_class: hazard_tile
runtime_clip: expansion:straylight_mirage_full_tiles:straylight_mirage__hazards
source_class: expansion_template
atlas_family: straylight_mirage_full_tiles
target_atlas: null
output_image: renders/world-expansion/straylight_mirage/hazards_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `straylight_mirage__hazards`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/straylight_mirage/hazards_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `straylight_mirage__hazards` |
| Animation class | `hazard_tile` |
| Runtime intent | `expansion:straylight_mirage_full_tiles:straylight_mirage__hazards` |
...
Render job: straylight_mirage__hazards
