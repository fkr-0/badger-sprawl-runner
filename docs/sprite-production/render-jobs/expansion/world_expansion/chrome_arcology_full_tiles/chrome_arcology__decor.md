...
job_id: chrome_arcology__decor
animation_state: chrome_arcology__decor
animation_class: hazard_tile
runtime_clip: expansion:chrome_arcology_full_tiles:chrome_arcology__decor
source_class: expansion_template
atlas_family: chrome_arcology_full_tiles
target_atlas: null
output_image: renders/world-expansion/chrome_arcology/decor_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `chrome_arcology__decor`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/chrome_arcology/decor_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `chrome_arcology__decor` |
| Animation class | `hazard_tile` |
| Runtime intent | `expansion:chrome_arcology_full_tiles:chrome_arcology__decor` |
...
Render job: chrome_arcology__decor
