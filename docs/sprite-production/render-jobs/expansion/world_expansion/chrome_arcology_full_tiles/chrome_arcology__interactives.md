...
job_id: chrome_arcology__interactives
animation_state: chrome_arcology__interactives
animation_class: hazard_tile
runtime_clip: expansion:chrome_arcology_full_tiles:chrome_arcology__interactives
source_class: expansion_template
atlas_family: chrome_arcology_full_tiles
target_atlas: null
output_image: renders/world-expansion/chrome_arcology/interactives_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `chrome_arcology__interactives`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/chrome_arcology/interactives_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `chrome_arcology__interactives` |
| Animation class | `hazard_tile` |
| Runtime intent | `expansion:chrome_arcology_full_tiles:chrome_arcology__interactives` |
...
Render job: chrome_arcology__interactives
