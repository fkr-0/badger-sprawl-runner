...
job_id: lower_sprawl__decor
animation_state: lower_sprawl__decor
animation_class: environment_tile
runtime_clip: expansion:lower_sprawl_full_tiles:lower_sprawl__decor
source_class: expansion_template
atlas_family: lower_sprawl_full_tiles
target_atlas: null
output_image: renders/world-expansion/lower_sprawl/decor_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
- Output image: `renders/world-expansion/lower_sprawl/decor_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `lower_sprawl__decor` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:lower_sprawl_full_tiles:lower_sprawl__decor` |
...
Render job: lower_sprawl__decor
