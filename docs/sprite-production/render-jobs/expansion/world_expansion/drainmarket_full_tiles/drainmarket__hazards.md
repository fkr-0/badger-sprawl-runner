...
job_id: drainmarket__hazards
animation_state: drainmarket__hazards
animation_class: hazard_tile
runtime_clip: expansion:drainmarket_full_tiles:drainmarket__hazards
source_class: expansion_template
atlas_family: drainmarket_full_tiles
target_atlas: null
output_image: renders/world-expansion/drainmarket/hazards_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `drainmarket__hazards`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/drainmarket/hazards_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `drainmarket__hazards` |
| Animation class | `hazard_tile` |
| Runtime intent | `expansion:drainmarket_full_tiles:drainmarket__hazards` |
...
Render job: drainmarket__hazards
