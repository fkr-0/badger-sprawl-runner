...
job_id: drainmarket__interactives
animation_state: drainmarket__interactives
animation_class: environment_tile
runtime_clip: expansion:drainmarket_full_tiles:drainmarket__interactives
source_class: expansion_template
atlas_family: drainmarket_full_tiles
target_atlas: null
output_image: renders/world-expansion/drainmarket/interactives_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `drainmarket__interactives`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/drainmarket/interactives_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `drainmarket__interactives` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:drainmarket_full_tiles:drainmarket__interactives` |
...
Render job: drainmarket__interactives
