...
job_id: orbital_lift__decor
animation_state: orbital_lift__decor
animation_class: environment_tile
runtime_clip: expansion:orbital_lift_full_tiles:orbital_lift__decor
source_class: expansion_template
atlas_family: orbital_lift_full_tiles
target_atlas: null
output_image: renders/world-expansion/orbital_lift/decor_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
- Output image: `renders/world-expansion/orbital_lift/decor_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `orbital_lift__decor` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:orbital_lift_full_tiles:orbital_lift__decor` |
...
Render job: orbital_lift__decor
