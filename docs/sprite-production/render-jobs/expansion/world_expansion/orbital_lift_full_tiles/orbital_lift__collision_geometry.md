...
job_id: orbital_lift__collision_geometry
animation_state: orbital_lift__collision_geometry
animation_class: environment_tile
runtime_clip: expansion:orbital_lift_full_tiles:orbital_lift__collision_geometry
source_class: expansion_template
atlas_family: orbital_lift_full_tiles
target_atlas: null
output_image: renders/world-expansion/orbital_lift/collision_geometry_4c_4r.png
frames: 16
grid:
  columns: 4
  rows: 4
...
# `orbital_lift__collision_geometry`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/world-expansion/orbital_lift/collision_geometry_4c_4r.png`
...
| Scope | `expansion` |
| Category | `world_expansion` |
| Animation state | `orbital_lift__collision_geometry` |
| Animation class | `environment_tile` |
| Runtime intent | `expansion:orbital_lift_full_tiles:orbital_lift__collision_geometry` |
...
Render job: orbital_lift__collision_geometry
