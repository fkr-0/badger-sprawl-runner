...
job_id: antenna_barrens_gameplay_tiles__lightning_pylon
animation_state: lightning_pylon
animation_class: hazard_tile
runtime_clip: future:antenna_lightning_pylon
...
output_image: renders/antenna_barrens_gameplay_tiles/lightning_pylon_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `antenna_barrens_gameplay_tiles__lightning_pylon`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/antenna_barrens_gameplay_tiles/lightning_pylon_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `lightning_pylon` |
