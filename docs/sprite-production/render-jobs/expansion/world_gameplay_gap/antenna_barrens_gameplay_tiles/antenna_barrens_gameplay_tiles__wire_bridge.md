...
job_id: antenna_barrens_gameplay_tiles__wire_bridge
animation_state: wire_bridge
animation_class: moving_tile
runtime_clip: future:antenna_wire_bridge
...
output_image: renders/antenna_barrens_gameplay_tiles/wire_bridge_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `antenna_barrens_gameplay_tiles__wire_bridge`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/antenna_barrens_gameplay_tiles/wire_bridge_4c_1r.png`
