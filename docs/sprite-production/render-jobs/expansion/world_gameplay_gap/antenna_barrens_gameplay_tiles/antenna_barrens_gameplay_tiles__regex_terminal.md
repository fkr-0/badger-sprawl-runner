...
job_id: antenna_barrens_gameplay_tiles__regex_terminal
animation_state: regex_terminal
animation_class: interactive_tile
runtime_clip: future:antenna_regex_terminal
...
output_image: renders/antenna_barrens_gameplay_tiles/regex_terminal_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `antenna_barrens_gameplay_tiles__regex_terminal`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/antenna_barrens_gameplay_tiles/regex_terminal_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `regex_terminal` |
