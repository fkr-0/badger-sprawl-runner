...
job_id: antenna_barrens_gameplay_tiles__signal_snow
animation_state: signal_snow
animation_class: environment_tile
runtime_clip: future:antenna_signal_snow
...
output_image: renders/antenna_barrens_gameplay_tiles/signal_snow_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `antenna_barrens_gameplay_tiles__signal_snow`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/antenna_barrens_gameplay_tiles/signal_snow_4c_2r.png`
