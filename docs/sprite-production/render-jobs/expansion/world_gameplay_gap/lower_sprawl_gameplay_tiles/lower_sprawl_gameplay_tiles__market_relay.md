...
job_id: lower_sprawl_gameplay_tiles__market_relay
animation_state: market_relay
animation_class: checkpoint_tile
runtime_clip: future:lower_sprawl_market_relay
...
output_image: renders/lower_sprawl_gameplay_tiles/market_relay_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `lower_sprawl_gameplay_tiles__market_relay`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_gameplay_tiles/market_relay_4c_1r.png`
