...
job_id: lower_sprawl_gameplay_tiles__wet_electric_rail
animation_state: wet_electric_rail
animation_class: hazard_tile
runtime_clip: future:lower_sprawl_electric_rail
...
output_image: renders/lower_sprawl_gameplay_tiles/wet_electric_rail_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `lower_sprawl_gameplay_tiles__wet_electric_rail`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_gameplay_tiles/wet_electric_rail_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `wet_electric_rail` |
