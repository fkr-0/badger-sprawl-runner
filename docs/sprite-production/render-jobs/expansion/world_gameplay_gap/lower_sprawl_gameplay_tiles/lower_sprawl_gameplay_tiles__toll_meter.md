...
job_id: lower_sprawl_gameplay_tiles__toll_meter
animation_state: toll_meter
animation_class: interactive_tile
runtime_clip: future:lower_sprawl_toll_meter
...
output_image: renders/lower_sprawl_gameplay_tiles/toll_meter_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `lower_sprawl_gameplay_tiles__toll_meter`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_gameplay_tiles/toll_meter_4c_1r.png`
