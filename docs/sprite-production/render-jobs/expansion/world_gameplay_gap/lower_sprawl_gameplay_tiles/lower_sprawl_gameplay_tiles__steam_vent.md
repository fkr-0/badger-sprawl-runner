...
job_id: lower_sprawl_gameplay_tiles__steam_vent
animation_state: steam_vent
animation_class: hazard_tile
runtime_clip: stage:steam_vent
...
output_image: renders/lower_sprawl_gameplay_tiles/steam_vent_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `lower_sprawl_gameplay_tiles__steam_vent`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_gameplay_tiles/steam_vent_4c_2r.png`
