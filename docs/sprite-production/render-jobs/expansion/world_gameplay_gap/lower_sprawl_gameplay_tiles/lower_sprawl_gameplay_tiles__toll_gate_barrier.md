...
job_id: lower_sprawl_gameplay_tiles__toll_gate_barrier
animation_state: toll_gate_barrier
animation_class: interactive_tile
runtime_clip: future:lower_sprawl_toll_gate
...
output_image: renders/lower_sprawl_gameplay_tiles/toll_gate_barrier_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `lower_sprawl_gameplay_tiles__toll_gate_barrier`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/lower_sprawl_gameplay_tiles/toll_gate_barrier_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `toll_gate_barrier` |
