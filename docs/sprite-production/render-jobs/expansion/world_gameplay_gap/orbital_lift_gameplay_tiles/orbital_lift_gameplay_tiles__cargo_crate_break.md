...
job_id: orbital_lift_gameplay_tiles__cargo_crate_break
animation_state: cargo_crate_break
animation_class: breakable_tile
runtime_clip: future:orbital_crate_break
...
output_image: renders/orbital_lift_gameplay_tiles/cargo_crate_break_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `orbital_lift_gameplay_tiles__cargo_crate_break`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_gameplay_tiles/cargo_crate_break_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `cargo_crate_break` |
