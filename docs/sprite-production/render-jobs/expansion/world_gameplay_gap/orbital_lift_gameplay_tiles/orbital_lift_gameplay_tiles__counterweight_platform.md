...
job_id: orbital_lift_gameplay_tiles__counterweight_platform
animation_state: counterweight_platform
animation_class: moving_tile
runtime_clip: future:orbital_counterweight
...
output_image: renders/orbital_lift_gameplay_tiles/counterweight_platform_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `orbital_lift_gameplay_tiles__counterweight_platform`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_gameplay_tiles/counterweight_platform_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `counterweight_platform` |
| Animation class | `moving_tile` |
