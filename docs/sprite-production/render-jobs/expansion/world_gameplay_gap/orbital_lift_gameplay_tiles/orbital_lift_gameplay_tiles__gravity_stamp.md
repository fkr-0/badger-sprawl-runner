...
job_id: orbital_lift_gameplay_tiles__gravity_stamp
animation_state: gravity_stamp
animation_class: puzzle_tile
runtime_clip: future:orbital_gravity_stamp
...
output_image: renders/orbital_lift_gameplay_tiles/gravity_stamp_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `orbital_lift_gameplay_tiles__gravity_stamp`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_gameplay_tiles/gravity_stamp_4c_2r.png`
