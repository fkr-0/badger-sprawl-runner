...
job_id: orbital_lift_gameplay_tiles__vacuum_leak
animation_state: vacuum_leak
animation_class: hazard_tile
runtime_clip: future:orbital_vacuum_leak
...
output_image: renders/orbital_lift_gameplay_tiles/vacuum_leak_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `orbital_lift_gameplay_tiles__vacuum_leak`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/orbital_lift_gameplay_tiles/vacuum_leak_4c_2r.png`
