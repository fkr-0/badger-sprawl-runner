...
job_id: drainmarket_gameplay_tiles__triage_scanner
animation_state: triage_scanner
animation_class: interactive_tile
runtime_clip: future:drainmarket_triage_scanner
...
output_image: renders/drainmarket_gameplay_tiles/triage_scanner_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `drainmarket_gameplay_tiles__triage_scanner`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_gameplay_tiles/triage_scanner_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `triage_scanner` |
