...
job_id: drainmarket_gameplay_tiles__sump_grate_break
animation_state: sump_grate_break
animation_class: breakable_tile
runtime_clip: future:drainmarket_grate_break
...
output_image: renders/drainmarket_gameplay_tiles/sump_grate_break_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `drainmarket_gameplay_tiles__sump_grate_break`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_gameplay_tiles/sump_grate_break_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `sump_grate_break` |
