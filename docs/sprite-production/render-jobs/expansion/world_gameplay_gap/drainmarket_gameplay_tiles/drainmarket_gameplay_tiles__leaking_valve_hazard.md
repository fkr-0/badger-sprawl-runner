...
job_id: drainmarket_gameplay_tiles__leaking_valve_hazard
animation_state: leaking_valve_hazard
animation_class: hazard_tile
runtime_clip: future:drainmarket_valve
...
output_image: renders/drainmarket_gameplay_tiles/leaking_valve_hazard_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `drainmarket_gameplay_tiles__leaking_valve_hazard`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_gameplay_tiles/leaking_valve_hazard_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `leaking_valve_hazard` |
