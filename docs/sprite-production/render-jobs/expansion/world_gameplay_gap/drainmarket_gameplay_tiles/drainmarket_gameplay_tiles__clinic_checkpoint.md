...
job_id: drainmarket_gameplay_tiles__clinic_checkpoint
animation_state: clinic_checkpoint
animation_class: checkpoint_tile
runtime_clip: future:drainmarket_checkpoint
...
output_image: renders/drainmarket_gameplay_tiles/clinic_checkpoint_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `drainmarket_gameplay_tiles__clinic_checkpoint`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_gameplay_tiles/clinic_checkpoint_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `clinic_checkpoint` |
