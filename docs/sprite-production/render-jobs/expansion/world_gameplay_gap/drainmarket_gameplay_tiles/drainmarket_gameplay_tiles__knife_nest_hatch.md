...
job_id: drainmarket_gameplay_tiles__knife_nest_hatch
animation_state: knife_nest_hatch
animation_class: hazard_tile
runtime_clip: future:drainmarket_nest_hatch
...
output_image: renders/drainmarket_gameplay_tiles/knife_nest_hatch_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `drainmarket_gameplay_tiles__knife_nest_hatch`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/drainmarket_gameplay_tiles/knife_nest_hatch_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `knife_nest_hatch` |
