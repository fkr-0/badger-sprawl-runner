...
job_id: dub_colony_gameplay_tiles__reactor_valve
animation_state: reactor_valve
animation_class: interactive_tile
runtime_clip: future:dub_reactor_valve
...
output_image: renders/dub_colony_gameplay_tiles/reactor_valve_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `dub_colony_gameplay_tiles__reactor_valve`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_gameplay_tiles/reactor_valve_4c_2r.png`
