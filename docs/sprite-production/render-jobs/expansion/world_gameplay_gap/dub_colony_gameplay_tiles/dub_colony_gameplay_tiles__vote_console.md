...
job_id: dub_colony_gameplay_tiles__vote_console
animation_state: vote_console
animation_class: interactive_tile
runtime_clip: future:dub_vote_console
...
output_image: renders/dub_colony_gameplay_tiles/vote_console_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `dub_colony_gameplay_tiles__vote_console`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_gameplay_tiles/vote_console_4c_1r.png`
