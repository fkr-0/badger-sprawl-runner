...
job_id: dub_colony_gameplay_tiles__feedback_arc
animation_state: feedback_arc
animation_class: hazard_tile
runtime_clip: future:dub_feedback_arc
...
output_image: renders/dub_colony_gameplay_tiles/feedback_arc_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `dub_colony_gameplay_tiles__feedback_arc`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_gameplay_tiles/feedback_arc_4c_2r.png`
