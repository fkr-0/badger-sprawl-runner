...
job_id: dub_colony_gameplay_tiles__greenhouse_lift
animation_state: greenhouse_lift
animation_class: moving_tile
runtime_clip: future:dub_greenhouse_lift
...
output_image: renders/dub_colony_gameplay_tiles/greenhouse_lift_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `dub_colony_gameplay_tiles__greenhouse_lift`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/dub_colony_gameplay_tiles/greenhouse_lift_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `greenhouse_lift` |
