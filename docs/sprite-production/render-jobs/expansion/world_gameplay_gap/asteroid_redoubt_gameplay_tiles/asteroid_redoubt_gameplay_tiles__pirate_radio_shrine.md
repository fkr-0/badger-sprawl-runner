...
source_entry: asteroid_redoubt_gameplay_tiles
job_id: asteroid_redoubt_gameplay_tiles__pirate_radio_shrine
animation_state: pirate_radio_shrine
animation_class: checkpoint_tile
runtime_clip: future:asteroid_radio_shrine
source_class: remaining_gap_catalog
atlas_family: assets/sprites/worlds/expansion/asteroid_redoubt_gameplay_tiles.png
target_atlas: assets/sprites/worlds/expansion/asteroid_redoubt_gameplay_tiles.png
output_image: renders/asteroid_redoubt_gameplay_tiles/pirate_radio_shrine_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
source_prompt_file: docs/sprite-production/prompts/expansion/gaps/worlds/asteroid_redoubt_gameplay_tiles.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `asteroid_redoubt_gameplay_tiles__pirate_radio_shrine`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_gameplay_tiles/pirate_radio_shrine_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `pirate_radio_shrine` |
| Animation class | `checkpoint_tile` |
| Runtime intent | `future:asteroid_radio_shrine` |
| Atlas family | `assets/sprites/worlds/expansion/asteroid_redoubt_gameplay_tiles.png` |
