...
job_id: asteroid_redoubt_gameplay_tiles__transmitter_root
animation_state: transmitter_root
animation_class: interactive_tile
runtime_clip: future:asteroid_transmitter_root
...
output_image: renders/asteroid_redoubt_gameplay_tiles/transmitter_root_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `asteroid_redoubt_gameplay_tiles__transmitter_root`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_gameplay_tiles/transmitter_root_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `transmitter_root` |
