...
job_id: asteroid_redoubt_gameplay_tiles__low_grav_spark_gap
animation_state: low_grav_spark_gap
animation_class: hazard_tile
runtime_clip: future:asteroid_spark_gap
...
output_image: renders/asteroid_redoubt_gameplay_tiles/low_grav_spark_gap_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `asteroid_redoubt_gameplay_tiles__low_grav_spark_gap`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_gameplay_tiles/low_grav_spark_gap_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `low_grav_spark_gap` |
