...
job_id: asteroid_redoubt_gameplay_tiles__airlock
animation_state: airlock
animation_class: interactive_tile
runtime_clip: future:asteroid_airlock
...
output_image: renders/asteroid_redoubt_gameplay_tiles/airlock_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `asteroid_redoubt_gameplay_tiles__airlock`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_gameplay_tiles/airlock_4c_2r.png`
