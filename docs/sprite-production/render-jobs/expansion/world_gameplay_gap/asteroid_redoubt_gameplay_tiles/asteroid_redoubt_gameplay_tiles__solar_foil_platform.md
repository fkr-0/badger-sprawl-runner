...
job_id: asteroid_redoubt_gameplay_tiles__solar_foil_platform
animation_state: solar_foil_platform
animation_class: environment_tile
runtime_clip: future:asteroid_solar_foil
...
output_image: renders/asteroid_redoubt_gameplay_tiles/solar_foil_platform_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `asteroid_redoubt_gameplay_tiles__solar_foil_platform`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_gameplay_tiles/solar_foil_platform_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `solar_foil_platform` |
