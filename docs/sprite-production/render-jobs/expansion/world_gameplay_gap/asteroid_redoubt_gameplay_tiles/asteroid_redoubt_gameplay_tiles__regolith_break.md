...
job_id: asteroid_redoubt_gameplay_tiles__regolith_break
animation_state: regolith_break
animation_class: breakable_tile
runtime_clip: future:asteroid_regolith_break
...
output_image: renders/asteroid_redoubt_gameplay_tiles/regolith_break_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `asteroid_redoubt_gameplay_tiles__regolith_break`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/asteroid_redoubt_gameplay_tiles/regolith_break_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `regolith_break` |
