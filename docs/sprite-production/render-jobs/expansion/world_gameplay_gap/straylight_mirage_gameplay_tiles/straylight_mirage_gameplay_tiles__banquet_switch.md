...
job_id: straylight_mirage_gameplay_tiles__banquet_switch
animation_state: banquet_switch
animation_class: interactive_tile
runtime_clip: future:mirage_banquet_switch
...
output_image: renders/straylight_mirage_gameplay_tiles/banquet_switch_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `straylight_mirage_gameplay_tiles__banquet_switch`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_gameplay_tiles/banquet_switch_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `banquet_switch` |
