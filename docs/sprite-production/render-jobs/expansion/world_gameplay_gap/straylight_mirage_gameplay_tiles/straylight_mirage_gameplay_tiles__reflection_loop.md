...
job_id: straylight_mirage_gameplay_tiles__reflection_loop
animation_state: reflection_loop
animation_class: puzzle_tile
runtime_clip: future:mirage_reflection_loop
...
output_image: renders/straylight_mirage_gameplay_tiles/reflection_loop_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `straylight_mirage_gameplay_tiles__reflection_loop`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_gameplay_tiles/reflection_loop_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `reflection_loop` |
| Animation class | `puzzle_tile` |
