...
job_id: straylight_mirage_gameplay_tiles__mirror_floor_break
animation_state: mirror_floor_break
animation_class: breakable_tile
runtime_clip: future:mirage_floor_break
...
output_image: renders/straylight_mirage_gameplay_tiles/mirror_floor_break_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `straylight_mirage_gameplay_tiles__mirror_floor_break`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_gameplay_tiles/mirror_floor_break_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `mirror_floor_break` |
