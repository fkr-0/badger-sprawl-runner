...
job_id: straylight_mirage_gameplay_tiles__false_door
animation_state: false_door
animation_class: interactive_tile
runtime_clip: future:mirage_false_door
...
output_image: renders/straylight_mirage_gameplay_tiles/false_door_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `straylight_mirage_gameplay_tiles__false_door`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_gameplay_tiles/false_door_4c_2r.png`
