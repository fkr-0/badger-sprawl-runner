...
job_id: straylight_mirage_gameplay_tiles__zero_g_fountain
animation_state: zero_g_fountain
animation_class: environment_tile
runtime_clip: future:mirage_zero_g_fountain
...
output_image: renders/straylight_mirage_gameplay_tiles/zero_g_fountain_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `straylight_mirage_gameplay_tiles__zero_g_fountain`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/straylight_mirage_gameplay_tiles/zero_g_fountain_4c_2r.png`
