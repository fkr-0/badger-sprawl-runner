...
job_id: chrome_arcology_gameplay_tiles__cargo_lift_platform
animation_state: cargo_lift_platform
animation_class: moving_tile
runtime_clip: future:chrome_cargo_lift
...
output_image: renders/chrome_arcology_gameplay_tiles/cargo_lift_platform_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `chrome_arcology_gameplay_tiles__cargo_lift_platform`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_gameplay_tiles/cargo_lift_platform_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `cargo_lift_platform` |
