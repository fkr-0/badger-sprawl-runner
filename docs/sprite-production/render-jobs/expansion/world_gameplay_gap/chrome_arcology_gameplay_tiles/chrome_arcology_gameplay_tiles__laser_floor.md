...
job_id: chrome_arcology_gameplay_tiles__laser_floor
animation_state: laser_floor
animation_class: hazard_tile
runtime_clip: future:chrome_laser_floor
...
output_image: renders/chrome_arcology_gameplay_tiles/laser_floor_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `chrome_arcology_gameplay_tiles__laser_floor`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_gameplay_tiles/laser_floor_4c_2r.png`
