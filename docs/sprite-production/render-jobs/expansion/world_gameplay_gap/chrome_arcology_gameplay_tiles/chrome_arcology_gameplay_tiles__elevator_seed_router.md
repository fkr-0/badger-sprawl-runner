...
job_id: chrome_arcology_gameplay_tiles__elevator_seed_router
animation_state: elevator_seed_router
animation_class: interactive_tile
runtime_clip: future:chrome_seed_router
...
output_image: renders/chrome_arcology_gameplay_tiles/elevator_seed_router_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `chrome_arcology_gameplay_tiles__elevator_seed_router`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_gameplay_tiles/elevator_seed_router_4c_2r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `elevator_seed_router` |
