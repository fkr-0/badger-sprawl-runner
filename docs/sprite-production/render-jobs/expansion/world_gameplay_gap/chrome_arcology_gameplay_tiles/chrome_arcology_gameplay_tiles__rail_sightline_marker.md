...
job_id: chrome_arcology_gameplay_tiles__rail_sightline_marker
animation_state: rail_sightline_marker
animation_class: cue_tile
runtime_clip: future:chrome_sightline
...
output_image: renders/chrome_arcology_gameplay_tiles/rail_sightline_marker_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `chrome_arcology_gameplay_tiles__rail_sightline_marker`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/chrome_arcology_gameplay_tiles/rail_sightline_marker_4c_1r.png`
...
| Scope | `expansion` |
| Category | `world_gameplay_gap` |
| Animation state | `rail_sightline_marker` |
