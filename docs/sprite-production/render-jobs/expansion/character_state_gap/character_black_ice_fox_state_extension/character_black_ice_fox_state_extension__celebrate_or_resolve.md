...
job_id: character_black_ice_fox_state_extension__celebrate_or_resolve
...
output_image: renders/character_black_ice_fox_state_extension/celebrate_or_resolve_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
# `character_black_ice_fox_state_extension__celebrate_or_resolve`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_black_ice_fox_state_extension/celebrate_or_resolve_4c_2r.png`
...
Render job: character_black_ice_fox_state_extension__celebrate_or_resolve
