...
job_id: character_auntie_subharmonic_state_extension__walk
...
output_image: renders/character_auntie_subharmonic_state_extension/walk_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `character_auntie_subharmonic_state_extension__walk`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_auntie_subharmonic_state_extension/walk_4c_2r.png`
...
Render job: character_auntie_subharmonic_state_extension__walk
