...
source_entry: character_auntie_subharmonic_state_extension
job_id: character_auntie_subharmonic_state_extension__celebrate_or_resolve
...
atlas_family: assets/sprites/characters/expansion/character_auntie_subharmonic_state_extension.png
target_atlas: assets/sprites/characters/expansion/character_auntie_subharmonic_state_extension.png
output_image: renders/character_auntie_subharmonic_state_extension/celebrate_or_resolve_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: lower_sprawl
source_prompt_file: docs/sprite-production/prompts/expansion/gaps/characters/character_auntie_subharmonic_state_extension.md
reference_images:
...
- Output image: `renders/character_auntie_subharmonic_state_extension/celebrate_or_resolve_4c_2r.png`
...
| Atlas family | `assets/sprites/characters/expansion/character_auntie_subharmonic_state_extension.png` |
...
Render job: character_auntie_subharmonic_state_extension__celebrate_or_resolve
...
Asset identity: Auntie Subharmonic: elder possum merchant; record-shop shawl, cassette charms, portable turntable, gold tooth.
