...
job_id: character_mara_modulo_state_extension__hurt
...
output_image: renders/character_mara_modulo_state_extension/hurt_4c_1r.png
frames: 4
grid:
  columns: 4
  rows: 1
...
# `character_mara_modulo_state_extension__hurt`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_mara_modulo_state_extension/hurt_4c_1r.png`
...
Render job: character_mara_modulo_state_extension__hurt
