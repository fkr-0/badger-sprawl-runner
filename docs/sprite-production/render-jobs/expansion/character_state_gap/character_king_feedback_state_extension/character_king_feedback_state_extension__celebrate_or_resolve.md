...
source_entry: character_king_feedback_state_extension
job_id: character_king_feedback_state_extension__celebrate_or_resolve
...
atlas_family: assets/sprites/characters/expansion/character_king_feedback_state_extension.png
target_atlas: assets/sprites/characters/expansion/character_king_feedback_state_extension.png
output_image: renders/character_king_feedback_state_extension/celebrate_or_resolve_4c_2r.png
frames: 6
grid:
  columns: 4
  rows: 2
...
- 96
world: dub_colony
source_prompt_file: docs/sprite-production/prompts/expansion/gaps/characters/character_king_feedback_state_extension.md
reference_images:
- assets/sprites/moss_badger_production.png
- generated/sprite-visual-review/badger-sprite-contact-sheet.png
---

# `character_king_feedback_state_extension__celebrate_or_resolve`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_king_feedback_state_extension/celebrate_or_resolve_4c_2r.png`
...
| Atlas family | `assets/sprites/characters/expansion/character_king_feedback_state_extension.png` |
...
Render job: character_king_feedback_state_extension__celebrate_or_resolve
...
Asset identity: King Feedback: rebel amp commander; speaker armor, cable crown, microphone mace.
