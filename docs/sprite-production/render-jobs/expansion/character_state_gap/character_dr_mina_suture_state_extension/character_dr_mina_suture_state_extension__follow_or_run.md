...
job_id: character_dr_mina_suture_state_extension__follow_or_run
...
output_image: renders/character_dr_mina_suture_state_extension/follow_or_run_4c_2r.png
frames: 8
grid:
  columns: 4
  rows: 2
...
# `character_dr_mina_suture_state_extension__follow_or_run`

This file is one complete Badger Sprawl Runner sprite render job. Copy only the **Prompt** block into the image renderer.

## Render target

- Output image: `renders/character_dr_mina_suture_state_extension/follow_or_run_4c_2r.png`
...
Render job: character_dr_mina_suture_state_extension__follow_or_run
